...
- [Using withObservationTracking to monitor changes in @Observable properties outside SwiftUI views](https://www.polpiella.dev/observable-outside-of-a-view)
...
- [How to change your app's business model from paid to freemium using StoreKit](https://www.polpiella.dev/paid-app-to-freemium)
...
- [How to create and upload high-quality App Store assets with RocketSim and Helm](https://www.polpiella.dev/creating-and-uploading-app-store-assets)
...
- [Automate GitHub Tasks with GitHub CLI in Actions Workflows: A Step-by-Step Guide](https://www.polpiella.dev/how-to-use-the-github-cli-from-github-actions-workflows)
...
- [Automate Apple app code signing using fastlane match](https://www.polpiella.dev/automate-code-signing-with-fastlane-match)
...
- [How to automatically update build and version numbers in your app using Fastlane](https://www.polpiella.dev/bump-numbers-ci-cd)
...
- [How to install the same version of Ruby and Fastlane locally and on CI/CD](https://www.polpiella.dev/install-ruby-and-gems-on-ci-cd)
...
- [How to listen for property changes in an @Observable class using AsyncStreams](https://www.polpiella.dev/observable-property-changes)
  ...
  **Topics:** Concurrency · Macros & Metaprogramming · Observation & State Management
...
- [How to run Swift Data and Core Data operations in the background and share models across concurrency contexts](https://www.polpiella.dev/core-data-swift-data-concurrency)
...
- [How to pass Bindings to views in SwiftUI's NavigationDestination modifier](https://www.polpiella.dev/binding-navigation)
...
- [How to make ZStack content fully scrollable in a SwiftUI ScrollView](https://www.polpiella.dev/scrollable-zstack)
...
- [How to programmatically parse the contents of an XCResult bundle](https://www.polpiella.dev/parse-contents-of-xcresult-files)
...
- [How to get the checksum of a file in Swift](https://www.polpiella.dev/get-checksum)
...
- [How to use recursive functions in Swift](https://www.polpiella.dev/how-to-use-recursive-functions-in-swift)
  **Published:** `2024-07-19T00:00:00.000Z`
  **Topics:** Swift
...
- [Check if your app has a newer version on the App Store using Swift](https://www.polpiella.dev/newer-version-lookup)
...
- [Getting started with Swift Testing](https://www.polpiella.dev/swift-testing)
  ...
  **Topics:** Macros & Metaprogramming · Swift · Testing · Xcode
...
- [How to create a SwiftUI floating window in macOS 15](https://www.polpiella.dev/creating-a-floating-window-using-swiftui-in-macos-15)
...
- [Removing components from a Date in Swift](https://www.polpiella.dev/removing-information-from-a-date-in-swift)
...
- [Building a Swift package using the Swift 6 language mode](https://www.polpiella.dev/swift-6-language-mode)
...
- [How to profile your app's performance and Main Thread usage with Instruments and os_signposts](https://www.polpiella.dev/time-profiler-instruments)
...
- [Creating an App Store Connect-like picker for macOS with SwiftUI](https://www.polpiella.dev/app-store-connect-like-picker-with-swiftui)
...
- [Use Swift to recursively search for content in a directory's files with Glob patterns and Regular Expressions](https://www.polpiella.dev/recursive-search-glob-and-regex)
...
- [Master the reduce operator in Swift and make your code more performant](https://www.polpiella.dev/mastering-the-reduce-operator-in-swift)
...
- [Multi-platform Swift Package releases with GitHub Actions](https://www.polpiella.dev/multi-platform-swift-package-releases-with-github-actions)
...
- [Core Data staged migrations](https://www.polpiella.dev/staged-migrations)
...
- [How to generate Swift interfaces from Pkl configuration files using SPM plugins](https://www.polpiella.dev/how-to-generate-swift-interfaces-from-pkl-files-with-spm-plugins)
...
- [Validate your XCTest utilities and extensions with unit tests](https://www.polpiella.dev/validate-your-xctest-utilities-with-unit-tests)
...
- [Custom Core Data migrations](https://www.polpiella.dev/custom-core-data-migrations)
...
- [Automating app releases for multiple platforms with Xcode Cloud](https://www.polpiella.dev/cross-platform-app-releases-with-xcode-cloud)
...
- [Setting up SharePlay on an iOS app](https://www.polpiella.dev/setting-up-shareplay-on-an-ios-app-from-scratch)
...
- [Generating beautiful open-graph images dynamically](https://www.polpiella.dev/generating-beautiful-open-graph-images-dynamically)
...
- [Image to image local Stable Diffusion pipelines with ControlNet in Swift](https://www.polpiella.dev/image-to-image-local-stable-diffusion-pipelines-with-controlnet-and-core-ml)
...
- [How to get the most played Apple Music songs and albums using Swift](https://www.polpiella.dev/most-played-apple-music)
...
- [Enable upcoming Swift features](https://www.polpiella.dev/enable-upcoming-swift-features-in-spm)
...
- [Distributing a Swift Macro using CocoaPods](https://www.polpiella.dev/cocoapods-swift-macros)
...
- [How to import Swift macros without using Swift Package Manager](https://www.polpiella.dev/binary-swift-macros)
  ...
  **Topics:** Macros & Metaprogramming · Swift · Swift Package Manager · Xcode
...
- [Using Swift SDKs to cross-compile Swift packages to Linux](https://www.polpiella.dev/swift-sdks)
...
- [Building and testing Swift packages on Windows using GitHub Actions](https://www.polpiella.dev/running-swift-on-widnows-with-gha)
...
- [Launching a SwiftUI view from the terminal](https://www.polpiella.dev/launching-a-swiftui-view-from-the-terminal)
...
- [Adding an Info.plist file to a Swift executable](https://www.polpiella.dev/info-plist-swift-cli)
...
- [Swift on Linux CI/CD using swiftly](https://www.polpiella.dev/setting-up-swift-on-linux-ci-cd-using-swiftly)
...
- [Building a searchable map with SwiftUI and MapKit](https://www.polpiella.dev/mapkit-and-swiftui-searchable-map)
...
- [Scheduled Swift AWS lambdas](https://www.polpiella.dev/scheduled-swift-aws-lambdas)
...
- [How to show the app icon and version in a SwiftUI view](https://www.polpiella.dev/show-app-icon-and-version-in-a-swiftui-view)
...
- [Load custom fonts into your app using Swift Package Plugins](https://www.polpiella.dev/load-custom-fonts-with-no-code-using-swift-package-plugins)
...
- [Configuring SwiftData in a SwiftUI app](https://www.polpiella.dev/configuring-swiftdata-in-a-swiftui-app)
...
- [Version-specific Package.swift files](https://www.polpiella.dev/version-specific-package-manifests)
...
- [Xcode Cloud: Generating and translating TestFlight test notes automatically](https://www.polpiella.dev/setting-testflight-test-notes-for-xcode-cloud-builds)
...
- [Automatic deployment of Swift AWS lambdas on CI/CD](https://www.polpiella.dev/automatic-deployment-of-swift-aws-lambdas-on-ci-cd)
...
- [Private Swift packages on CI/CD](https://www.polpiella.dev/private-swift-packages-on-ci-cd)
...
- [How to avoid a big refactor with the @_exported attribute](https://www.polpiella.dev/how-we-avoided-a-big-refactor-with-the-exported-attribute)
...
- [How to launch a macOS SwiftUI app from a Safari extension](https://www.polpiella.dev/how-to-launch-an-app-from-a-safari-extension)
...
- [Export SwiftUI views as images in macOS](https://www.polpiella.dev/how-to-save-swiftui-views-as-images-in-macos)
...
- [GitHub Actions workflows side effects](https://www.polpiella.dev/github-action-workflows-side-effects)
...
- [Deploying beta versions of your app to TestFlight and AppCenter using Xcode Cloud](https://www.polpiella.dev/how-to-deploy-beta-versions-of-your-app-to-testflight-and-appcenter-with-xcode-cloud)
...
- [Automating Swift command line tool releases with GitHub Actions](https://www.polpiella.dev/automating-swift-package-releases-with-github-actions)
...
- [Managing multiple Xcode versions on CI using Fastlane](https://www.polpiella.dev/managing-xcode-installs-using-fastlane)
...
- [Coming in Swift 5.9: Network requests in Swift package plugins](https://www.polpiella.dev/network-requests-in-swift-package-plugins)
...
- [Using App Store Connect API to trigger Xcode Cloud workflows](https://www.polpiella.dev/using-app-store-connect-api-to-trigger-xcode-cloud-workflows)
...
- [Scheduling tweets with GitHub Actions and Swift](https://www.polpiella.dev/scheduling-tweets-with-github-actions-and-swift)
...
- [Making a serverless Swift function with Fastly and Upstash](https://www.polpiella.dev/making-a-serverless-swift-function-with-fastly-and-upstash)
  **Published:** `2023-01-18T00:00:00.000Z`
  **Topics:** Persistence & Synchronisation · Swift · Swift Package Manager
...
- [Fastlane and App Store Connect API keys](https://www.polpiella.dev/fastlane-appstore-connect-api-and-github-actions)
  **Published:** `2023-01-11T00:00:00.000Z`
  **Topics:** App Distribution & Store Operations · CI/CD & Automation
...
- [Collecting GitHub Action workflow metrics using Swift](https://www.polpiella.dev/collecting-gihub-actions-workflow-metrics-with-swift)
  **Published:** `2022-11-30T00:00:00.000Z`
  **Topics:** Concurrency · Swift · Swift Package Manager · Testing
...
- [Testing your release pipeline using Fastlane](https://www.polpiella.dev/testing-your-release-pipeline-using-fastlane)
...
- [Handling multiple git SSH keys](https://www.polpiella.dev/handling-multiple-git-ssh-keys)
...
- [My new Swift Package: ReadingTime](https://www.polpiella.dev/my-new-swift-package-reading-time)
...
- [Localising a modularised application](https://www.polpiella.dev/modularised-app-localisation)
...
- [Code generation using Swift Package Plugins](https://www.polpiella.dev/code-generation-using-swift-package-plugins)
...
- [Asserting errors from throwing functions](https://www.polpiella.dev/asserting-errors-from-throwing-functions)
...
- [Cancelling unnecessary GitHub actions automatically](https://www.polpiella.dev/cancelling-unnecessary-github-actions-automatically)
...
- [Custom key decoding strategies in Swift](https://www.polpiella.dev/custom-key-decoding-strategies-in-swift)
...
- [Using Property Wrappers to avoid code repetition](https://www.polpiella.dev/avoiding-code-repetition-with-property-wrappers)
...
- [Hiding implementation details using the adapter pattern in Swift](https://www.polpiella.dev/hide-implementation-details-using-the-adapter-pattern)
...
- [Testing dates consistently](https://www.polpiella.dev/testing-dates-consistently)
...
- [Clean Architecture: A Feature Flag Manager](https://www.polpiella.dev/clean-architecture-a-feature-flag-provider)
...
- [Using .switchToLatest()](https://www.polpiella.dev/the-power-of-the-switchtolatest-operator)
