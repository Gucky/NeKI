...
- [Tracking renamed files in Git – Ole Begemann](https://oleb.net/2025/git-file-renaming)
...
- [Building with nightly Swift toolchains on macOS – Ole Begemann](https://oleb.net/2024/swift-toolchains)
...
- [How the Swift compiler knows that DispatchQueue.main implies @MainActor – Ole Begemann](https://oleb.net/2024/dispatchqueue-mainactor)
...
- [How the relative size modifier interacts with stack views – Ole Begemann](https://oleb.net/2023/swiftui-relative-size-in-stacks)
...
- [Working with percentages in SwiftUI layout – Ole Begemann](https://oleb.net/2023/swiftui-relative-size)
...
- [Keyboard shortcuts for Export Unmodified Original in Photos for Mac – Ole Begemann](https://oleb.net/2023/photos-keyboard-shortcuts)
...
- [Swift Evolution proposals in Alfred – Ole Begemann](https://oleb.net/2023/alfred-swift-evolution)
...
- [Pattern matching on error codes – Ole Begemann](https://oleb.net/2023/catch-error-code)
...
- [Understanding SwiftUI view lifecycles – Ole Begemann](https://oleb.net/2022/swiftui-view-lifecycle)
...
- [clipped() doesn’t affect hit testing – Ole Begemann](https://oleb.net/2022/clipped-hit-testing)
...
- [When .animation animates more (or less) than it’s supposed to – Ole Begemann](https://oleb.net/2022/animation-modifier-position)
...
- [Xcode 14.0 generates wrong concurrency code for macOS targets – Ole Begemann](https://oleb.net/2022/xcode-14-mac-concurrency-bugs)
...
- [Where View.task gets its main-actor isolation from – Ole Begemann](https://oleb.net/2022/swiftui-task-mainactor)
...
- [Experimenting with Live Activities – Ole Begemann](https://oleb.net/2022/live-activity)
...
- [How @MainActor works – Ole Begemann](https://oleb.net/2022/how-mainactor-works)
...
- [A heterogeneous dictionary with strong types in Swift – Ole Begemann](https://oleb.net/2022/heterogeneous-dictionary)
...
- [Advanced Swift, fifth edition – Ole Begemann](https://oleb.net/2022/advanced-swift-5)
...
- [Synchronous functions can support cancellation too – Ole Begemann](https://oleb.net/2022/sync-functions-cancellation)
...
- [Cancellation can come in many forms – Ole Begemann](https://oleb.net/2022/cancellation-forms)
...
- [What is structured concurrency? – Ole Begemann](https://oleb.net/2021/structured-concurrency)
...
- [How Swift runs an async executable – Ole Begemann](https://oleb.net/2021/async-program-launch-sequence)
...
- [Swift needs a better language reference – Ole Begemann](https://oleb.net/2021/swift-language-reference)
  **Published:** `2021-06-03T15:29:29Z`
  **Topics:** Swift
...
- [How OrderedSet works – Ole Begemann](https://oleb.net/2021/ordered-set)
  **Published:** `2021-04-30T15:34:50Z`
  **Topics:** Swift
...
- [Thinking in SwiftUI – Ole Begemann](https://oleb.net/2020/thinking-in-swiftui)
  **Published:** `2020-12-19T15:33:44Z`
  **Topics:** Swift · SwiftUI
...
- [Where is end-to-end encryption for iCloud? – Ole Begemann](https://oleb.net/2020/icloud-end-to-end-encryption)
  **Published:** `2020-12-10T16:17:45Z`
  **Topics:** Persistence & Synchronisation · Security & Privacy
...
- [as, as?, and as! – Ole Begemann](https://oleb.net/2020/as)
  **Published:** `2020-06-29T18:11:04Z`
  **Topics:** Swift
...
- [Sanitizing GPX files for public sharing – Ole Begemann](https://oleb.net/2020/sanitizing-gpx)
  **Published:** `2020-06-22T14:01:32Z`
  **Topics:** Foundation & Data Formats · Maps & Location · Security & Privacy
...
- [Linking to text fragments in web pages – Ole Begemann](https://oleb.net/2020/text-fragments)
...
- [Testing UIKit accessibility in unit tests – Ole Begemann](https://oleb.net/2020/accessibility-unit-tests)
  **Published:** `2020-04-30T16:29:29Z`
  **Topics:** Accessibility · Testing · UIKit
...
- [Testing Swift packages on Linux using Docker – Ole Begemann](https://oleb.net/2020/swift-docker-linux)
  **Published:** `2020-02-02T18:44:07Z`
  **Topics:** Swift · Swift Package Manager · Testing
...
- [Automatic test discovery in Swift on Linux – Ole Begemann](https://oleb.net/2020/swift-test-discovery)
...
- [Sheets don’t inherit the environment – Ole Begemann](https://oleb.net/2020/sheet-environment)
  **Published:** `2020-01-23T17:36:51Z`
  **Topics:** Swift · SwiftUI
...
- [Enumerating elements in ForEach – Ole Begemann](https://oleb.net/2020/foreach-enumerated)
  **Published:** `2020-01-17T16:45:16Z`
  **Topics:** Swift · SwiftUI
...
- [TopLevelEncoder and TopLevelDecoder in Combine – Ole Begemann](https://oleb.net/2020/topleveldecoder)
...
- [URLSession.DataTaskPublisher’s failure type – Ole Begemann](https://oleb.net/2020/urlsession-publisher)
...
- [Chris Lattner on the origins of Swift – Ole Begemann](https://oleb.net/2019/chris-lattner-swift-origins)
  **Published:** `2019-02-18T16:13:45Z`
  **Topics:** Swift
...
- [Splitting a Swift Sequence into head and tail – Ole Begemann](https://oleb.net/2018/sequence-head-tail)
  **Published:** `2018-11-29T22:57:46Z`
  **Topics:** Swift
...
- [Roy Fielding’s REST dissertation – Ole Begemann](https://oleb.net/2018/rest)
...
- [It’s wrappers all the way down – Ole Begemann](https://oleb.net/2018/lastindex-reversed)
  **Published:** `2018-09-25T18:09:06Z`
  **Topics:** Swift
...
- [The 2018 Macbook Pro – Ole Begemann](https://oleb.net/2018/macbook-pro)
...
- [Why you’re not supposed to call description – Ole Begemann](https://oleb.net/2018/dont-call-description)
...
- [An iOS alert view with a text field and a “smart” OK button – Ole Begemann](https://oleb.net/2018/uialertcontroller-textfield)
  **Published:** `2018-08-13T17:33:36Z`
  **Topics:** Architecture · Developer Career & Practice · UIKit
...
- [Migrating an Objective-C class to Swift using subclassing – Ole Begemann](https://oleb.net/2018/objc-swift-subclassing)
  **Published:** `2018-08-09T21:08:35Z`
  **Topics:** Swift
...
- [Migrating an Objective-C class to Swift: a piecemeal approach – Ole Begemann](https://oleb.net/2018/objc-swift-transition)
  **Published:** `2018-07-31T21:55:16Z`
  **Topics:** Swift
...
- [Nullability warnings with libextobjc’s @keypath macro – Ole Begemann](https://oleb.net/2018/@keypath)
  **Published:** `2018-07-27T21:31:14Z`
  **Topics:** Macros & Metaprogramming · Performance · Xcode
...
- [Thoughts on @dynamicMemberLookup – Ole Begemann](https://oleb.net/blog/2018/06/dynamic-member-lookup)
  **Published:** `2018-06-22T21:59:59Z`
  **Topics:** Swift
...
- [Enumerating enum cases in Swift – Ole Begemann](https://oleb.net/blog/2018/06/enumerating-enum-cases)
  **Published:** `2018-06-09T18:35:36Z`
  **Topics:** Swift
...
- [Random numbers in Swift – Ole Begemann](https://oleb.net/blog/2018/06/random-numbers-in-swift)
  **Published:** `2018-06-07T16:59:09Z`
  **Topics:** Swift
...
- [Playground: What’s new in Swift 4.2 – Ole Begemann](https://oleb.net/blog/2018/06/whats-new-in-swift-4-2-playground)
  **Published:** `2018-06-06T20:44:30Z`
  **Topics:** Swift
...
- [How I do analytics – Ole Begemann](https://oleb.net/blog/2018/05/how-i-do-analytics)
...
- [App Architecture book – Ole Begemann](https://oleb.net/blog/2018/05/app-architecture-book)
...
- [Swift 4.1 – Ole Begemann](https://oleb.net/blog/2018/04/swift-4-1)
  **Published:** `2018-04-30T21:36:00Z`
  **Topics:** Swift
...
- [Making illegal states unrepresentable – Ole Begemann](https://oleb.net/blog/2018/03/making-illegal-states-unrepresentable)
...
- [How to make a copy of a Core Data SQLite database – Ole Begemann](https://oleb.net/blog/2018/03/core-data-sqlite-backup)
...
- [A helper for working with temporary files in Swift – Ole Begemann](https://oleb.net/blog/2018/03/temp-file-helper)
  **Published:** `2018-03-22T16:39:00Z`
  **Topics:** Swift
...
- [XCTKVOExpectation for native Swift key paths – Ole Begemann](https://oleb.net/blog/2018/02/xctkvoexpectation-swift-keypaths)
...
- [A better NSManagedObjectContext.performAndWait – Ole Begemann](https://oleb.net/blog/2018/02/performandwait)
...
- [A script to save the last backup date in SuperDuper – Ole Begemann](https://oleb.net/blog/2018/01/superduper-last-backup-timestamp)
...
- [Do you have to manually unregister block-based NotificationCenter observers? – Ole Begemann](https://oleb.net/blog/2018/01/notificationcenter-removeobserver)
...
- [Swift imports fixed-size C arrays as tuples – Ole Begemann](https://oleb.net/blog/2017/12/swift-imports-fixed-size-c-arrays-as-tuples)
  **Published:** `2017-12-29T19:05:00Z`
  **Topics:** Swift
...
- [A hack for fixed-size arrays in Swift – Ole Begemann](https://oleb.net/blog/2017/12/fixed-size-arrays)
  **Published:** `2017-12-28T19:01:00Z`
  **Topics:** Swift
...
- [How to import a C library in Swift using the Swift Package Manager – Ole Begemann](https://oleb.net/blog/2017/12/importing-c-library-into-swift)
...
- [Why Dictionary sometimes encodes itself as an array – Ole Begemann](https://oleb.net/blog/2017/12/dictionary-codable-array)
  **Published:** `2017-12-05T20:31:00Z`
  **Topics:** Swift
...
- [Strings in Swift 4 – Ole Begemann](https://oleb.net/blog/2017/11/swift-4-strings)
  **Published:** `2017-11-27T15:48:00Z`
  **Topics:** Swift
...
- [Advanced Swift, third edition – Ole Begemann](https://oleb.net/blog/2017/11/advanced-swift-3)
...
- [Injecting side effects into chained Sequence operations – Ole Begemann](https://oleb.net/blog/2017/10/chained-foreach)
...
- [Mental models in API design – Ole Begemann](https://oleb.net/blog/2017/07/mental-models-in-api-design)
...
- [Chris Lattner on the Realm WWDC 2017 Swift panel – Ole Begemann](https://oleb.net/blog/2017/06/chris-lattner-wwdc-swift-panel)
...
- [Optimizing Collections – Ole Begemann](https://oleb.net/blog/2017/06/optimizing-collections-book)
  **Published:** `2017-06-12T18:37:00Z`
  **Topics:** Swift
...
- [Playground: What’s new in Swift 4 – Ole Begemann](https://oleb.net/blog/2017/05/whats-new-in-swift-4-playground)
  **Published:** `2017-05-18T18:32:00Z`
  **Topics:** Swift
...
- [Swift Package Manager macOS deployment target override – Ole Begemann](https://oleb.net/blog/2017/04/swift-3-1-package-manager-deployment-target)
...
- [How to test a Swift package on Linux using Docker – Ole Begemann](https://oleb.net/blog/2017/03/testing-swift-packages-on-linux)
...
- [Keeping XCTest in sync on Linux – Ole Begemann](https://oleb.net/blog/2017/03/keeping-xctest-in-sync)
...
- [Swift releases have themes – Ole Begemann](https://oleb.net/blog/2017/03/swift-themed-releases)
  **Published:** `2017-03-20T19:25:08Z`
  **Topics:** Swift
...
- [Safeguarding Equatable implementations – Ole Begemann](https://oleb.net/blog/2017/03/dump-as-equatable-safeguard)
  **Published:** `2017-03-08T18:27:49Z`
  **Topics:** Swift
...
- [Enums, Equatable, and exhaustiveness – Ole Begemann](https://oleb.net/blog/2017/03/enums-equatable-exhaustiveness)
...
- [A Sorted Array Implementation in Swift – Ole Begemann](https://oleb.net/blog/2017/02/sorted-array)
...
- [Why String.CharacterView is not a MutableCollection – Ole Begemann](https://oleb.net/blog/2017/02/why-is-string-characterview-not-a-mutablecollection)
...
- [Being a Mutable Collection is not Sufficient to be a MutableCollection – Ole Begemann](https://oleb.net/blog/2017/02/why-is-dictionary-not-a-mutablecollection)
  **Published:** `2017-02-06T21:44:01Z`
  **Topics:** Swift
...
- [Fun with String Interpolation – Ole Begemann](https://oleb.net/blog/2017/01/fun-with-string-interpolation)
  **Published:** `2017-01-25T21:31:08Z`
  **Topics:** Swift
...
- [Working with Asynchronous Objective-C APIs in Swift – Ole Begemann](https://oleb.net/blog/2017/01/result-init-helper)
...
- [Accessing Dictionaries with Key Paths – Ole Begemann](https://oleb.net/blog/2017/01/dictionary-key-paths)
  **Published:** `2017-01-09T15:39:00Z`
  **Topics:** Swift
...
- [Protocols are more than Bags of Syntax – Ole Begemann](https://oleb.net/blog/2016/12/protocols-have-semantics)
  **Published:** `2016-12-30T21:12:55Z`
  **Topics:** Swift
...
- [Emoji 4.0 – Ole Begemann](https://oleb.net/blog/2016/12/emoji-4-0)
  **Published:** `2016-12-19T20:53:04Z`
  **Topics:** Swift
...
- [Optionals and String Interpolation – Ole Begemann](https://oleb.net/blog/2016/12/optionals-string-interpolation)
...
- [The RawRepresentable Protocol in Swift – Ole Begemann](https://oleb.net/blog/2016/11/rawrepresentable)
  **Published:** `2016-11-23T18:19:09Z`
  **Topics:** Swift
...
- [How to Read the Swift Standard Library Source – Ole Begemann](https://oleb.net/blog/2016/10/swift-stdlib-source)
  **Published:** `2016-10-28T20:13:25Z`
  **Topics:** Swift
...
- [Passing an Array of Strings from Swift to C – Ole Begemann](https://oleb.net/blog/2016/10/swift-array-of-c-strings)
  **Published:** `2016-10-27T15:12:40Z`
  **Topics:** Swift
...
- [Generic Range Algorithms – Ole Begemann](https://oleb.net/blog/2016/10/generic-range-algorithms)
...
- [Optional Non-Escaping Closures – Ole Begemann](https://oleb.net/blog/2016/10/optional-non-escaping-closures)
  **Published:** `2016-10-10T21:28:37Z`
  **Topics:** Swift
...
- [_playgroundPrintHook – Ole Begemann](https://oleb.net/blog/2016/09/playground-print-hook)
...
- [Option Sets in Swift – Ole Begemann](https://oleb.net/blog/2016/09/swift-option-sets)
  **Published:** `2016-09-28T15:51:00Z`
  **Topics:** Swift
...
- [What’s in a Collection? – Ole Begemann](https://oleb.net/blog/2016/09/collection-associated-types)
  **Published:** `2016-09-22T21:23:00Z`
  **Topics:** Swift
...
- [Ranges in Swift 3 – Ole Begemann](https://oleb.net/blog/2016/09/swift-3-ranges)
  **Published:** `2016-09-14T16:51:00Z`
  **Topics:** Swift
...
- [Strings in Swift 3 – Ole Begemann](https://oleb.net/blog/2016/08/swift-3-strings)
  **Published:** `2016-08-31T17:20:00Z`
  **Topics:** Swift
...
- [Measurements and Units with Phantom Types – Ole Begemann](https://oleb.net/blog/2016/08/measurements-and-units-with-phantom-types)
...
- [Measurements and Units, Part 3 – Ole Begemann](https://oleb.net/blog/2016/07/unitsquare)
  **Published:** `2016-07-29T17:30:00Z`
  **Topics:** Swift
...
- [Method Dispatch in Protocol Extensions – Ole Begemann](https://oleb.net/blog/2016/06/lily-ballard-swift-dispatch)
  **Published:** `2016-06-05T16:24:00Z`
  **Topics:** Swift
...
- [Protocol-Oriented Logging, or: Default Arguments in Swift Protocols – Ole Begemann](https://oleb.net/blog/2016/05/default-arguments-in-protocols)
  **Published:** `2016-05-01T20:03:00Z`
  **Topics:** Swift
...
- [Camera.app Pauses Audio Playback – Ole Begemann](https://oleb.net/blog/2016/03/ios-camera-app-pauses-audio-playback)
...
- [ICU Text Transforms in Foundation – Ole Begemann](https://oleb.net/blog/2016/01/icu-text-transforms)
...
- [Lazy Properties in Structs – Ole Begemann](https://oleb.net/blog/2015/12/lazy-properties-in-structs-swift)
...
- [More Pattern Matching Examples – Ole Begemann](https://oleb.net/blog/2015/09/more-pattern-matching-examples)
...
- [Ranges and Intervals in Swift – Ole Begemann](https://oleb.net/blog/2015/09/swift-ranges-and-intervals)
  **Published:** `2015-09-24T21:51:00Z`
  **Topics:** Swift
...
- [Pattern Matching in Swift – Ole Begemann](https://oleb.net/blog/2015/09/swift-pattern-matching)
  **Published:** `2015-09-18T21:15:00Z`
  **Topics:** Swift
...
- [Is it Immoral to not Block Ads? – Ole Begemann](https://oleb.net/blog/2015/08/is-it-immoral-to-not-block-ads)
...
- [Swift’s Type System – Ole Begemann](https://oleb.net/blog/2015/07/swift-type-system)
  **Published:** `2015-07-21T00:01:00Z`
  **Topics:** Swift
...
- [WWDC 2015 – Ole Begemann](https://oleb.net/blog/2015/06/wwdc-2015)
  **Published:** `2015-06-12T18:33:00Z`
  **Topics:** Swift
...
- [Accessibility at the Apple Design Awards – Ole Begemann](https://oleb.net/blog/2015/06/workflow-accessibility-apple-design-awards)
...
- [Swift Standard Library.playground – Ole Begemann](https://oleb.net/blog/2015/06/swift-standard-library-playground)
...
- [Truncated Text in Mobile UIs – Ole Begemann](https://oleb.net/blog/2015/02/truncated-text)
...
- [The Minus Sign – Ole Begemann](https://oleb.net/blog/2015/02/minus-sign)
...
- [Code vs. Poetry – Ole Begemann](https://oleb.net/blog/2015/01/code-vs-poetry)
...
- [iPhone 6 Plus Pixel Peeping Follow-Up – Ole Begemann](https://oleb.net/blog/2014/12/pixel-peeping-followup)
...
- [Dan Grossman’s Programming Languages Course – Ole Begemann](https://oleb.net/blog/2014/12/programming-languages-mooc)
...
- [Work Habits at Apple – Ole Begemann](https://oleb.net/blog/2014/09/work-habits-at-apple)
...
- [iPhone 6 Plus First Impressions – Ole Begemann](https://oleb.net/blog/2014/09/iphone-6-plus-first-impressions)
...
- [Replacing Launch Images With Storyboards – Ole Begemann](https://oleb.net/blog/2014/08/replacing-launch-images-with-storyboards)
...
- [Instance Methods are “Curried” Functions in Swift – Ole Begemann](https://oleb.net/blog/2014/07/swift-instance-methods-curried-functions)
  **Published:** `2014-07-28T16:27:00Z`
  **Topics:** Swift
...
- [Strings in Swift Updated – Ole Begemann](https://oleb.net/blog/2014/07/swift-strings-updated)
...
- [Strings in Swift 1 – Ole Begemann](https://oleb.net/blog/2014/07/swift-strings)
  **Published:** `2014-07-03T16:05:00Z`
  **Topics:** Swift
...
- [One for the Unicode Nerds – Ole Begemann](https://oleb.net/blog/2014/06/one-for-the-unicode-nerds)
...
- [Apple’s Take on App Architecture – Ole Begemann](https://oleb.net/blog/2014/06/apples-take-on-app-architecture)
...
- [Core Data Concurrency Debugging – Ole Begemann](https://oleb.net/blog/2014/06/core-data-concurrency-debugging)
...
- [How Dropbox Uses C++ for Cross-Platform iOS and Android Development – Ole Begemann](https://oleb.net/blog/2014/05/how-dropbox-uses-cplusplus-cross-platform-development)
  **Published:** `2014-05-23T20:17:00Z`
  **Topics:** Architecture · Concurrency · Core Data · Persistence & Synchronisation
...
- [Parallax Scrolling – Ole Begemann](https://oleb.net/blog/2014/05/parallax-scrolling-collectionview)
...
- [How I Learned to Stop Worrying and Love Cocoa Auto Layout – Ole Begemann](https://oleb.net/blog/2014/03/how-i-learned-to-stop-worrying-and-love-auto-layout)
...
- [Handling Default Values With NSUserDefaults – Ole Begemann](https://oleb.net/blog/2014/02/nsuserdefaults-handling-default-values)
...
- [A Geocoding Service for OS X – Ole Begemann](https://oleb.net/blog/2014/01/geocoding-automator-service)
...
- [Parallelize Your for Loops With GCD – Ole Begemann](https://oleb.net/blog/2013/07/parallelize-for-loops-gcd-dispatch_apply)
...
- [NSArray Binary Search – Ole Begemann](https://oleb.net/blog/2013/07/nsarray-binary-search)
...
- [On NSURLConnection API Design – Ole Begemann](https://oleb.net/blog/2013/07/nsurlconnection-api-design)
  **Published:** `2013-07-08T21:48:00Z`
  **Topics:** Code Quality · Networking · Product Design
...
- [Starting With Bluetooth Low Energy Development on iOS – Ole Begemann](https://oleb.net/blog/2013/04/starting-bluetooth-low-energy-development-ios)
...
- [Compiler Warnings for Objective-C Developers – Ole Begemann](https://oleb.net/blog/2013/04/compiler-warnings-for-objective-c-developers)
...
- [10 Things You Need to Know About Cocoa Auto Layout – Ole Begemann](https://oleb.net/blog/2013/03/things-you-need-to-know-about-cocoa-autolayout)
...
- [There is a Bug in the NSFetchedResultsControllerDelegate Documentation – Ole Begemann](https://oleb.net/blog/2013/02/nsfetchedresultscontroller-documentation-bug)
  **Published:** `2013-02-27T16:24:00Z`
  **Topics:** Foundation & Data Formats · UIKit
...
- [Building a Blocks-Based Object System in (Objective-)C – Ole Begemann](https://oleb.net/blog/2013/02/building-blocks-based-object-system-in-objective-c)
...
- [iOS Apps: Disable the Sleep Timer for Long-Running Tasks – Ole Begemann](https://oleb.net/blog/2013/02/ios-apps-disable-sleep-timer-long-running-tasks)
...
- [Mac Sandboxing: Location Services Access Requires Outgoing Connections – Ole Begemann](https://oleb.net/blog/2013/01/mac-sandboxing-location-services-outgoing-connections)
  **Published:** `2013-01-17T17:00:00Z`
  **Topics:** Maps & Location · Security & Privacy · Xcode
...
- [Accessing and Pretty-Printing the Elements of a CGPath – Ole Begemann](https://oleb.net/blog/2012/12/accessing-pretty-printing-cgpath-elements)
...
- [Prevent Layers From Snapping Back to Original Values When Using Explicit CAAnimations – Ole Begemann](https://oleb.net/blog/2012/11/prevent-caanimation-snap-back)
...
- [UTF-8 – Ole Begemann](https://oleb.net/blog/2012/09/utf-8)
...
- [Creating and Deleting Calendars in iOS – Ole Begemann](https://oleb.net/blog/2012/05/creating-and-deleting-calendars-in-ios)
...
- [Checking Code Signing and Sandboxing Status in Code – Ole Begemann](https://oleb.net/blog/2012/02/checking-code-signing-and-sandboxing-status-in-code)
...
- [Passing Data Between View Controllers – Ole Begemann](https://oleb.net/blog/2012/02/passing-data-between-view-controllers)
...
- [Revisiting the App Launch Sequence on iOS – Ole Begemann](https://oleb.net/blog/2012/02/app-launch-sequence-ios-revisited)
...
- [CGPath Hit Testing – Ole Begemann](https://oleb.net/blog/2012/02/cgpath-hit-testing)
...
- [Gesture Recognition on iOS With Attention to Detail – Ole Begemann](https://oleb.net/blog/2012/01/gesture-recognition-on-ios-with-attention-to-detail)
...
- [initWithNibName:bundle: Breaks Encapsulation – Ole Begemann](https://oleb.net/blog/2012/01/initWithNibName-bundle-breaks-encapsulation)
...
- [Tutorial: How to Sort and Group UITableView by Date – Ole Begemann](https://oleb.net/blog/2011/12/tutorial-how-to-sort-and-group-uitableview-by-date)
  **Published:** `2011-12-02T17:40:00Z`
  **Topics:** Foundation & Data Formats · Objective-C & Cocoa · UIKit
...
- [Date and Time Handling in Cocoa Cheat Sheet – Ole Begemann](https://oleb.net/blog/2011/11/date-and-time-in-cocoa-cheat-sheet)
  **Published:** `2011-11-23T18:00:00Z`
  **Topics:** Foundation & Data Formats · Objective-C & Cocoa
...
- [Working with Date and Time in Cocoa (Part 2) – Ole Begemann](https://oleb.net/blog/2011/11/working-with-date-and-time-in-cocoa-part-2)
...
- [Working with Date and Time in Cocoa (Part 1) – Ole Begemann](https://oleb.net/blog/2011/11/working-with-date-and-time-in-cocoa-part-1)
...
- [Accessing Image Properties Without Loading the Image Into Memory – Ole Begemann](https://oleb.net/blog/2011/09/accessing-image-properties-without-loading-the-image-into-memory)
...
- [The App Launch Sequence on iOS – Ole Begemann](https://oleb.net/blog/2011/06/app-launch-sequence-ios)
...
- [How Developers Should Handle All the Stuff Apple Introduced at WWDC – Ole Begemann](https://oleb.net/blog/2011/06/how-developers-should-handle-stuff-apple-introduced-at-wwdc)
...
- [Faking Instance Variables in Objective-C Categories With Associative References – Ole Begemann](https://oleb.net/blog/2011/05/faking-ivars-in-objc-categories-with-associative-references)
...
- [Using Cocoa to Convert Images From RGB to CMYK – Ole Begemann](https://oleb.net/blog/2011/05/using-cocoa-to-convert-images-from-rgb-to-cmyk)
...
- [Inspecting Core Data Attributes – Ole Begemann](https://oleb.net/blog/2011/05/inspecting-core-data-attributes)
...
- [New Site Design, Now Proudly Serving Static HTML – Ole Begemann](https://oleb.net/blog/2011/02/new-site-design-now-proudly-serving-static-html)
...
- [OBSlider, a UISlider Subclass With Variable Scrubbing Speed – Ole Begemann](https://oleb.net/blog/2011/01/obslider-a-uislider-subclass-with-variable-scrubbing-speed)
...
- [My Wish: Syntax Additions to Objective-C for Object Literals – Ole Begemann](https://oleb.net/blog/2010/12/syntax-additions-for-object-literals-to-objective-c)
  **Published:** `2010-12-22T11:07:00Z`
  **Topics:** Cross-Platform & Web · Objective-C & Cocoa
...
- [Animating the Drawing of a CGPath With CAShapeLayer – Ole Begemann](https://oleb.net/blog/2010/12/animating-drawing-of-cgpath-with-cashapelayer)
  ...
  **Topics:** Cross-Platform & Web · Maps & Location
...
- [Method Names in Objective-C – Ole Begemann](https://oleb.net/blog/2010/12/method-names-in-objective-c)
...
- [How to Debug an App That Was Launched by Push Notification or URL Handler – Ole Begemann](https://oleb.net/blog/2010/05/how-to-debug-app-launched-by-remote-event)
  **Published:** `2010-05-06T21:17:00Z`
  **Topics:** App Services & Extensions · Cross-Platform & Web · Foundation & Data Formats
...
- [OBGradientView: A Simple UIView Wrapper for CAGradientLayer – Ole Begemann](https://oleb.net/blog/2010/04/obgradientview-a-simple-uiview-wrapper-for-cagradientlayer)
  **Published:** `2010-04-20T13:15:00Z`
  **Topics:** Apple Platform Ecosystem · Cross-Platform & Web · UIKit
...
- [Porting RRGlossCausticShader to the iPhone – Ole Begemann](https://oleb.net/blog/2010/02/porting-rrglosscausticshader-to-the-iphone)
  **Published:** `2010-02-28T18:02:00Z`
  **Topics:** Apple Platform Ecosystem · Cross-Platform & Web · Graphics, Media & Games
...
- [Mutable Properties of Immutable Objects – Ole Begemann](https://oleb.net/blog/2009/11/mutable-properties-of-immutable-objects)
...
- [OBShapedButton: Non-Rectangular Buttons on the iPhone – Ole Begemann](https://oleb.net/blog/2009/10/obshapedbutton-non-rectangular-buttons-on-the-iphone)
  **Published:** `2009-10-17T16:53:00Z`
  **Topics:** Apple Platform Ecosystem · Cross-Platform & Web
...
- [The Music Player Framework in iPhone SDK 3.0 – Ole Begemann](https://oleb.net/blog/2009/07/the-music-player-framework-in-the-iphone-sdk)
