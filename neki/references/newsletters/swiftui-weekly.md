...
**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming · Performance · Xcode

**Selected links:**
- [Splitting Large SwiftUI Views in the Apple's way](https://emredegirmenci.substack.com/p/splitting-large-swiftui-views-in) — Article · Topics: Swift · SwiftUI · Macros & Metaprogramming
...
- [The Anatomy of a Reusable SwiftUI View](https://alexanderweiss.dev/blog/2026-07-12-the-anatomy-of-a-reusable-swiftui-view) — Article · Topics: Swift · SwiftUI · Performance
...
**Topics:** Swift · SwiftUI · Concurrency · Networking
...
**Topics:** Swift · SwiftUI · Architecture · Liquid Glass · Macros & Metaprogramming · Performance
...
- [SwiftUI: Observable macro under the hood](https://www.nsvasilev.com/posts/swiftui-observable-macro) — Article · Topics: Swift · SwiftUI · Macros & Metaprogramming
...
**Topics:** Swift · SwiftUI · Architecture · Performance · UIKit

**Selected links:**
- [Navigation transition updates in SwiftUI on iOS 27](https://nilcoalescing.com/blog/SwiftUINavigationTransitionUpdatesIniOS27) — Article · Topics: Swift · SwiftUI · Architecture
...
- [WWDC26: SwiftUI Group Lab - Q&A](https://antongubarenko.substack.com/p/wwdc26-swiftui-group-lab-q-and-a) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Architecture

**Selected links:**
- [Formatting Values in SwiftUI Text and TextField](https://serialcoder.dev/text-tutorials/swiftui/formatting-values-in-swiftui-text-and-textfield) — Tutorial · Topics: Swift · SwiftUI · Architecture
...
**Topics:** Swift · SwiftUI · Accessibility · Concurrency · UIKit
...
- [Previewing SwiftUI views in both dark and light mode](https://peterringset.dev/articles/light-and-dark-preview) — Article · Topics: Swift · SwiftUI · Concurrency
...
- [Checking accessibility with SwiftUI Previews](https://mobilea11y.com/blog/swiftui-preview-testing) — Article · Topics: Swift · SwiftUI · Testing
...
**Topics:** Swift · SwiftUI · Liquid Glass
...
- [Talking Liquid Glass with Apple](https://captainswiftui.substack.com/p/talking-liquid-glass-with-apple) — Article · Topics: Swift · SwiftUI · Liquid Glass
...
- [Expanding Animations in SwiftUI Lists](https://nerdyak.tech/development/2026/03/16/expand-animation-in-SwiftUI-List.html) — Article · Topics: Swift · SwiftUI · Liquid Glass
...
**Topics:** Swift · SwiftUI · Accessibility · Performance

**Sections:** Reading

**Selected links:**
- [SwiftUI Pro](https://github.com/twostraws/SwiftUI-Agent-Skill) — Source repository · Topics: Swift · SwiftUI · Accessibility
...
- [Borrowing from Kotlin/Android to Architect Scalable iOS Apps in SwiftUI](https://www.infoq.com/articles/kotlin-scalable-swiftui-patterns) — Article · Topics: Swift · SwiftUI
...
- [Mastering Geometry in SwiftUI - GeometryReader, GeometryProxy & onGeometryChange](https://www.sagarunagar.com/blog/geometry-in-swiftui) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · AI Development · Navigation & Deep Linking · UIKit · Xcode
...
- [Morphing Sheets Out of Buttons in SwiftUI](https://serialcoder.dev/text-tutorials/swiftui/morphing-sheets-out-of-buttons-in-swiftui) — Tutorial · Topics: Swift · SwiftUI · Liquid Glass
...
- [Advanced NavigationStack Patterns in SwiftUI](https://buczel.com/blog/swift-navigation-stack-patterns) — Article · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Observation & State Management · Architecture · Concurrency

**Sections:** Reading

**Selected links:**
- [SwiftUI Agent Skill: Build better views with AI](https://www.avanderlee.com/ai-development/swiftui-agent-skill-build-better-views-with-ai) — Article · Topics: Swift · SwiftUI · AI Development
...
- [Add an Open Recent Menu to a SwiftUI app](https://swiftdevjournal.com/posts/open-recent-menu) — Article · Topics: Swift · Architecture · SwiftUI
...
- [Migrating to the Observation framework in SwiftUI](https://tanaschita.com/swiftui-observation-migrating-to-observation) — Article · Topics: Swift · SwiftUI · Observation & State Management
...
- [Migrating an iOS app from Paid up Front to Freemium](https://www.donnywals.com/migrating-an-ios-app-from-paid-up-front-to-freemium) — Article
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Performance · Observation & State Management · Testing
...
- [From broken to testable SwiftUI navigation: The decoupled approach of MVVM with coordinators](https://matteomanferdini.com/mvvm-coordinator-swiftui) — Article · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
- [Animating SF Symbols in SwiftUI](https://nilcoalescing.com/blog/AnimatingSFSymbolsInSwiftUI) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Observation & State Management · UIKit
...
**Topics:** Swift · SwiftUI · Architecture · AI Development · Performance
...
- [SwiftUI Architecture: Structure Views for Reusability and Clarity](https://www.avanderlee.com/swiftui/swiftui-architecture-structure-views-for-reusability-and-clarity) — Article · Topics: Swift · SwiftUI · Architecture
...
**Topics:** Swift · SwiftUI · Concurrency · Testing
...
- [Tunable, physics-driven motion primitives for SwiftUI](https://github.com/roberthein/kinetics) — Source repository · Topics: Swift · SwiftUI · Concurrency
...
- [Perception 2.0: An updated back-port of Swift’s Observation framework](https://www.pointfree.co/blog/posts/180-perception-2-0-an-updated-back-port-of-swift-s-observation-framework) — Article · Topics: Swift · Observation & State Management
...
**Selected links:**
- [SwiftUI Search Enhancements in iOS and iPadOS 26](https://nilcoalescing.com/blog/SwiftUISearchEnhancementsIniOSAndiPadOS26) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Liquid Glass · Accessibility
...
**Topics:** Swift · SwiftUI · Liquid Glass · Xcode
...
**Topics:** Swift · SwiftUI · Composable Architecture · Accessibility · Architecture · Concurrency
...
- [The evolution of native engineering at Tripadvisor: Part 1](https://medium.com/tripadvisor/the-evolution-of-native-engineering-at-tripadvisor-part-1-577cc0e36ec8) — Article · Topics: Composable Architecture · Architecture · Concurrency
...
- [Enable scrolling based on content size in SwiftUI](https://nilcoalescing.com/blog/EnableScrollingBasedOnContentSizeInSwiftUI) — Article · Topics: Swift · SwiftUI · Accessibility
...
**Selected links:**
- [XCUITest: How to Write UI Tests for SwiftUI Apps](https://www.swiftyplace.com/blog/xcuitest-ui-testing-swiftui) — Article · Topics: Testing · Swift · SwiftUI
...
- [Mesh gradients in SwiftUI](https://nilcoalescing.com/blog/MeshGradientsInSwiftUI) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #215 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-214-8dc)
...
- [Can You use PreferenceKeys for Testing SwiftUI Views](https://www.swiftyplace.com/blog/swiftui-testing-with-preferencekeys) — Article · Topics: Swift · Testing · SwiftUI
...
- [Formatting data inside SwiftUI Text views](https://nilcoalescing.com/blog/FormattingDataInsideSwiftUITextViews) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #214 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-214)
...
**Selected links:**
- [How to persist navigation state in SwiftUI](https://tanaschita.com/swiftui-navigation-persist-state) — Article · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
- [Why Your SwiftUI App Is Slower Than You Think](https://medium.com/@wesleymatlock/why-your-swiftui-app-is-slower-than-you-think-c3e9bb46174b) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #213 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-213)

- Published: `2025-04-21T14:45:08.780Z`

**Topics:** Swift · Concurrency · SwiftUI · Testing · Performance · Macros & Metaprogramming
...
## [SwiftUI Weekly - Issue #212 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-212)
...
## [SwiftUI Weekly - Issue #211 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-211)

- Published: `2025-03-25T13:30:35.672Z`

**Topics:** Swift · SwiftUI · Composable Architecture · Concurrency · Performance · UIKit
...
- [The Composable Architecture: How Architectural Design Decisions Influence Performance](https://www.swiftyplace.com/blog/the-composable-architecture-performance) — Article · Topics: Performance · Architecture · Composable Architecture
...
## [SwiftUI Weekly - Issue #210 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-210)

- Published: `2025-03-17T10:10:06.430Z`

**Topics:** Swift · SwiftUI · Concurrency · UIKit · Navigation & Deep Linking · Performance
...
## [SwiftUI Weekly - Issue #209 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-209)

- Published: `2025-03-03T16:45:42.215Z`

**Topics:** Swift · SwiftUI · Concurrency · Performance
...
## [SwiftUI Weekly - Issue #208 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-208)

- Published: `2025-02-18T13:13:57.808Z`

**Topics:** Swift · SwiftUI · UIKit · Concurrency

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #208 · Reading

**Selected links:**
- [The easiest way to use SwiftUI in a UIKit app](https://www.swiftwithvincent.com/blog/the-easiest-way-to-use-swiftui-in-a-uikit-app) — Article · Topics: Swift · UIKit · SwiftUI
...
## [SwiftUI Weekly - Issue #207 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-207)
...
- [Understanding SwiftUI Preferences](https://peterfriese.dev/blog/2025/swiftui-preferences-swift6) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Testing · Accessibility
...
- [SwiftUI Navigation using the Router Pattern](https://tiagohenriques.vercel.app/blog/swiftui-navigation-router-pattern) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #205 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-205)
...
- [SF Symbol: How to for Swift & SwiftUI](https://www.avanderlee.com/swift/sf-symbol-guide) — Article · Topics: Swift · SwiftUI
...
- [Exploring TabView Advancements in SwiftUI](https://serialcoder.dev/text-tutorials/swiftui/exploring-tabview-advancements-in-swiftui-part-1) — Tutorial · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #204 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-203-c70)

- Published: `2024-12-03T07:24:48.832Z`

**Topics:** Swift · SwiftUI · Xcode · UIKit
...
- [SwiftUI Zoom Navigation Transitions: Add a Touch of Magic to Your App](https://www.stphndxn.com/swiftui-zoom-navigation-transitions-add-a-touch-of-magic-to-your-app) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #203 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-203)

- Published: `2024-11-19T05:45:58.937Z`

**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming · Xcode
...
- [Deep Dive into Environment in SwiftUI](https://azamsharp.com/2024/11/18/deep-dive-into-environment-in-swiftui.html) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #202 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-202)

- Published: `2024-11-11T09:06:45.768Z`

**Topics:** Swift · SwiftUI · Accessibility · UIKit
...
- [Font modifiers in SwiftUI](https://nilcoalescing.com/blog/FontModifiersInSwiftUI) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #201 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-201)

- Published: `2024-10-21T14:26:23.455Z`

**Topics:** Swift · SwiftUI · Architecture · Concurrency
...
- [MockData, PreviewModifiers and PreviewTraits in SwiftUI](https://www.youtube.com/watch?v=Yw7H4Ujpwtg) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [Improve your app's UX with SwiftUI's task view modifier](https://peterfriese.dev/blog/2024/delay-task-modifier) — Article · Topics: Swift · SwiftUI · Concurrency
...
- [SwiftUI Environment](https://nilcoalescing.com/blog/SwiftUIEnvironment) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #200 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-200)
...
**Selected links:**
- [Phase Animator Behavior](https://chris.eidhof.nl/post/phase-animator) — Article · Topics: Swift · SwiftUI
...
- [Insetting Scrollable Views’ Content With contentMargins In SwiftUI](https://serialcoder.dev/text-tutorials/swiftui/insetting-scrollable-views-content-with-contentmargins-in-swiftui) — Tutorial · Topics: Swift · SwiftUI
...
- [Introduction to Communication Patterns in SwiftUI](https://azamsharp.com/2024/09/22/introduction-to-communication-patterns-in-swiftui.html) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #199 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-199)

- Published: `2024-09-09T19:49:43.177Z`

**Topics:** Swift · SwiftUI · Macros & Metaprogramming · Xcode · Observation & State Management · Performance
...
- [Github contribution graph with Swift Charts](https://www.artemnovichkov.com/blog/github-contribution-graph-swift-charts) — Article · Topics: Swift
...
## [SwiftUI Weekly - Issue #198 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-198)

- Published: `2024-08-26T10:56:58.237Z`

**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #198 · Reading

**Selected links:**
- [Using @Observable in SwiftUI views](https://nilcoalescing.com/blog/ObservableInSwiftUI) — Article · Topics: Swift · Observation & State Management · SwiftUI
...
- [SwiftUI for Mac 2024](https://troz.net/post/2024/swiftui-mac-2024) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #197 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-197)
...
**Selected links:**
- [What's New in SwiftUI - WWDC24](https://yaacoub.github.io/articles/swift-tip/what-s-new-in-swiftui-wwdc24) — Article · Topics: Swift · SwiftUI
...
- [Customizing the appearance of symbol images in SwiftUI](https://nilcoalescing.com/blog/CustomizingTheAppearanceOfSymbolImagesInSwiftUI) — Article · Topics: Swift · SwiftUI
...
- [MeshGradients in iOS 18](https://www.youtube.com/watch?v=s_eQZ8rRV8Y) — Video
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.

## [SwiftUI Weekly - Issue #196 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-196)
...
**Selected links:**
- [Build Multilingual Ready Apps](https://yaacoub.github.io/articles/swift-tip/build-multilingual-ready-apps-wwdc24) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #195 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-195)

- Published: `2024-08-05T15:18:59.956Z`

**Topics:** Swift · SwiftUI · Persistence & Synchronisation
...
- [Displaying Data with Table](https://captainswiftui.substack.com/p/displaying-data-with-table-part-i?r=a1d9l&triedRedirect=true) — Article · Topics: Swift · SwiftUI · Persistence & Synchronisation
...
- [Olympic Logo in SwiftUI](https://medium.com/@alessandromanilii/olympic-logo-in-swiftui-dee37cbd53f1) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #194 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-194)

- Published: `2024-07-15T12:03:07.308Z`

**Topics:** Swift · SwiftUI · Macros & Metaprogramming · Performance · Xcode

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #194 · Reading

**Selected links:**
- [Zoom Transitions in SwiftUI](https://www.youtube.com/watch?v=malwmE5fDHw) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [List or LazyVStack: Choosing the Right Lazy Container in SwiftUI](https://itnext.io/list-or-lazyvstack-choosing-the-right-lazy-container-in-swiftui-27f5b8272dae) — Article · Topics: Swift · SwiftUI · Performance
...
- [Creating advanced hover effects in visionOS](https://www.createwithswift.com/creating-advanced-hover-effects-in-visionos) — Article · Topics: Swift
...
- [Blend Modes in SwiftUI](https://digitalbunker.dev/blend-modes-in-swiftui) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #193 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-193)

- Published: `2024-07-08T08:54:13.719Z`

**Topics:** Swift · SwiftUI · Observation & State Management · Testing · UIKit

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #193 · Reading

**Selected links:**
- [SwiftUI can be a bit... eager](https://www.attributedstrings.com/swiftui-can-be-a-bit-eager) — Article · Topics: Swift · SwiftUI · UIKit
...
- [A Summary Of How To Pass Data To SwiftUI Environment](https://serialcoder.dev/text-tutorials/swiftui/a-summary-of-how-to-pass-data-to-swiftui-environment) — Tutorial · Topics: Swift · SwiftUI · Observation & State Management
...
- [Mastering Animatable and AnimatablePair in SwiftUI](https://digitalbunker.dev/mastering-animatable-and-animatablepair-swiftui) — Article · Topics: Swift · SwiftUI
...
- [Laying out views with ContainerRelativeFrame in SwiftUI](https://www.youtube.com/watch?v=DudvesMYAAY) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.

## [SwiftUI Weekly - Issue #192 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-192)

- Published: `2024-07-02T09:09:59.000Z`

**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Accessibility · Observation & State Management

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #192 · Reading

**Selected links:**
- [SwiftUI and Accessibility: Creating Inclusive iOS Applications](https://iosdevlibrary.lemonsqueezy.com/buy/d130b2f9-cc2d-427f-b2a5-a93cfb58bfd1) — Article · Topics: Swift · SwiftUI · Accessibility
...
- [Using TextRenderer to create highlighted text](https://alexanderweiss.dev/blog/2024-06-24-using-textrenderer-to-create-highlighted-text) — Article · Topics: Swift · SwiftUI
...
- [My Favorite SwiftUI Updates in iOS 18](https://www.youtube.com/watch?v=aCbh9LmIZTI) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.

## [SwiftUI Weekly - Issue #191 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-191)
...
- [Zoom navigation transition in SwiftUI](https://augmentedcode.io/2024/06/17/zoom-navigation-transition-in-swiftui) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #190 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-190)

- Published: `2024-06-10T10:26:42.278Z`

**Topics:** Swift · SwiftUI · App Intents & System Surfaces · Composable Architecture · Xcode · Architecture
...
- [Composable Architecture Frequently Asked Questions](https://www.pointfree.co/blog/posts/141-composable-architecture-frequently-asked-questions) — Article · Topics: Composable Architecture · Architecture
...
## [SwiftUI Weekly - Issue #189 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-189)
...
## [SwiftUI Weekly - Issue #188 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-188)

- Published: `2024-05-27T10:42:14.070Z`

**Topics:** Swift · SwiftUI · Navigation & Deep Linking

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #188 · Reading

**Selected links:**
- [Programmatic navigation in SwiftUI with NavigationPath and navigationDestination](https://www.donnywals.com/programmatic-navigation-in-swiftui-with-navigationpath-and-navigationdestination) — Article · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
- [Your Complete Guide to Push Notifications in SwiftUI](https://medium.com/@jpmtech/your-complete-guide-to-push-notifications-in-swiftui-8a13f5588662) — Tutorial · Topics: Swift · SwiftUI
...
- [MVVM: An architectural coding pattern to structure SwiftUI Views](https://www.avanderlee.com/swiftui/mvvm-architectural-coding-pattern-to-structure-views) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #187 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-187)

- Published: `2024-05-20T22:04:41.287Z`

**Topics:** Swift · SwiftUI · UIKit · Xcode · Concurrency · Accessibility

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #187 · Reading

**Selected links:**
- [React to network status updates in SwiftUI](https://nilcoalescing.com/blog/ReactToNetworkStatusUpdatesInSwiftUI) — Article · Topics: Swift · SwiftUI · Concurrency
...
- [Did you know that Xcode Previews also work with UIKit?](https://www.youtube.com/watch?v=sC0WnigbmJw) — Video · Topics: UIKit · Xcode
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
## [SwiftUI Weekly - Issue #186 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-186)

- Published: `2024-05-15T12:55:37.453Z`

**Topics:** Swift · SwiftUI · Architecture · Swift Package Manager · Xcode
...
- [Pointfree's SyncUps App: A Great Example Architecture for a SwiftUI App](https://rodschmidt.com/posts/syncups) — Article · Topics: Architecture · Swift · SwiftUI
...
- [SyncUps](https://github.com/pointfreeco/syncups) — Source repository · Topics: Architecture · Swift · SwiftUI
...
- [Creating Settings Screen in SwiftUI With AppStorage](https://holyswift.app/using-userdefaults-to-persist-in-swiftui) — Article · Topics: Swift · SwiftUI · Persistence & Synchronisation
...
- [Mastering the containerRelativeFrame Modifier in SwiftUI](https://fatbobman.com/en/posts/mastering-the-containerrelativeframe-modifier-in-swiftui) — Article · Topics: Swift · SwiftUI
...
**Topics:** Composable Architecture · Swift · SwiftUI · Architecture · Concurrency
...
- [Flighty in SwiftUI](https://www.youtube.com/watch?v=81FwPLo-1eE) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [TCA](https://github.com/pointfreeco/swift-composable-architecture) — Source repository · Topics: Composable Architecture · Architecture · Swift
...
- [The Composable Architecture: My 3 Year Experience](https://rodschmidt.com/posts/composable-architecture-experience) — Article · Topics: Composable Architecture · Architecture
...
## [SwiftUI Weekly - Issue #183 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-183)

- Published: `2024-04-22T17:42:59.039Z`

**Topics:** Swift · SwiftUI · Observation & State Management · Testing · Architecture

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #183 · Reading

**Selected links:**
- [Making your lists searchable in a SwiftUI app](https://www.createwithswift.com/making-your-lists-searchable-in-a-swiftui-app) — Article · Topics: Swift · SwiftUI
...
- [Improve Test Clarity (TDD with SwiftUI)](https://www.youtube.com/watch?v=AF8cCxrJr8M) — Video · Topics: Swift · SwiftUI · Testing
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [Professional Grade Application Protection for Swift and Objective-C iOS Apps](https://www.vpdae.com/redirect/e9xwl532e60eyhhks87um6yabmy) — Article · Topics: Swift · SwiftUI
...
- [Bar Chart creation using Swift Charts](https://www.avanderlee.com/swift-charts/bar-chart-creation-using-swift-charts) — Article · Topics: Swift · SwiftUI
...
- [Camera capture setup in a SwiftUI app](https://www.createwithswift.com/camera-capture-setup-in-a-swiftui-app) — Tutorial · Topics: Swift · SwiftUI
...
- [In Search of a Smooth Scroll](https://byla.lt/posts/in-search-of-smooth-scroll) — Article
...
**Topics:** Swift · SwiftUI · Concurrency · Observation & State Management · Persistence & Synchronisation · SwiftData

**Sections:** Videos

**Selected links:**
- [Practical SwiftData: Building SwiftUI Applications with Modern Approaches](https://fatbobman.com/en/posts/practical-swiftdata-building-swiftui-applications-with-modern-approaches) — Article · Topics: Swift · Concurrency · SwiftData
...
- [SwiftUI Views and @MainActor](https://fatbobman.com/en/posts/swiftui-views-and-mainactor) — Tutorial · Topics: Swift · SwiftUI · Concurrency
...
- [Key press events detection in SwiftUI](https://www.avanderlee.com/swiftui/key-press-events-detection) — Article · Topics: Swift · SwiftUI · Concurrency
...
- [SwiftUI Inverting A Boolean Binding](https://useyourloaf.com/blog/swiftui-inverting-a-boolean-binding) — Article · Topics: Swift · SwiftUI · Observation & State Management
...
## [SwiftUI Weekly - Issue #179 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-179)
...
**Selected links:**
- [How to build a draggable bottom sheet with a scroll view in SwiftUI](https://tanaschita.com/20240311-draggable-sheet-with-scroll-view) — Article · Topics: Swift · SwiftUI
...
- [Tips and Considerations for Using Lazy Containers in SwiftUI](https://fatbobman.com/en/posts/tips-and-considerations-for-using-lazy-containers-in-swiftui) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Concurrency · Macros & Metaprogramming
...
- [An Introduction to Isolation in Swift](https://www.massicotte.org/intro-to-isolation) — Tutorial · Topics: Concurrency · Swift
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · SwiftData · UIKit · Observation & State Management
...
**Topics:** Swift · SwiftUI · Observation & State Management · Accessibility · Persistence & Synchronisation · Xcode
...
**Selected links:**
- [Implementing volumes in visionOS](https://www.createwithswift.com/implementing-volumes-in-visionos) — Article · Topics: Swift
...
**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming · UIKit
...
**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming · Concurrency · Testing

**Sections:** Reading

**Selected links:**
- [Asynchronous SwiftUI buttons](https://blog.thomasdurand.fr/story/2024-01-14-asynchronous-swiftui-buttons) — Article · Topics: Swift · SwiftUI · Concurrency
...
**Topics:** Swift · SwiftUI · Observation & State Management · Performance
...
## [SwiftUI Weekly - Issue #170 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-170)

- Published: `2023-12-11T13:23:19.560Z`

**Topics:** Swift · SwiftUI · Concurrency · Persistence & Synchronisation · SwiftData · Xcode
...
- [App Localizations](https://www.youtube.com/watch?v=kbgNL7VrQPo) — Video · Topics: Swift · SwiftData · Xcode
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [SwiftUI geometryGroup() Guide: From Theory to Practice](https://medium.com/the-swift-cooperative/swiftui-geometrygroup-guide-from-theory-to-practice-1a7f4b04c4ec) — Article · Topics: Swift · SwiftUI
...
- [How to ask the user to leave an App Store review](https://www.youtube.com/watch?v=RUWGjeDCkN8) — Video
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
**Topics:** Swift · SwiftUI · Architecture · Observation & State Management
...
- [Observable Architecture Beta!](https://www.pointfree.co/blog/posts/125-observable-architecture-beta) — Article · Topics: Architecture · Observation & State Management · Swift
...
## [SwiftUI Weekly - Issue #167 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-167)
...
**Selected links:**
- [Understanding Text Case And Capitalization In SwiftUI](https://serialcoder.dev/text-tutorials/swiftui/understanding-text-case-and-capitalization-in-swiftui) — Tutorial · Topics: Swift · SwiftUI
...
- [Building Complex Scroll Animations With New iOS 17 API's](https://www.youtube.com/watch?v=ytRim2TSdyY) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [Hierarchical background styles in SwiftUI](https://nilcoalescing.com/blog/HierarchicalBackgroundStyles) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Macros & Metaprogramming · UIKit · Observation & State Management · Xcode
...
## [SwiftUI Weekly - Issue #164 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-164)
...
- [How to dismiss Keyboard in SwiftUI](https://sarunw.com/posts/dismiss-keyboard-in-swiftui) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Observation & State Management · Concurrency · Macros & Metaprogramming

**Sections:** Reading · Videos

**Selected links:**
- [Daniel Steinberg - SwiftUI to destroy the Publishing Industry](https://www.youtube.com/watch?v=rhqASksgJu0) — Video · Topics: Swift · SwiftUI · Observation & State Management
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
- [Chris Eidhof - A Day in the Life of a SwiftUI View](https://www.youtube.com/watch?v=MRY3UCUVv98) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
**Topics:** Swift · Concurrency · SwiftUI · Persistence & Synchronisation · SwiftData · Xcode
...
## [SwiftUI Weekly - Issue #161 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-161)

- Published: `2023-09-25T21:58:53.226Z`

**Topics:** Swift · SwiftUI · Concurrency · App Intents & System Surfaces · Testing
...
- [App Intent driven development in Swift and SwiftUI](https://www.avanderlee.com/swift/app-intent-driven-development) — Article · Topics: App Intents & System Surfaces · Swift · SwiftUI
...
- [Understanding Publishers in SwiftUI and Combine](https://medium.com/bumble-tech/understanding-publishers-in-swiftui-and-combine-27806aa78ba1) — Article · Topics: Swift · SwiftUI
...
- [Combine](https://www.swiftbysundell.com/discover/combine) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Observation & State Management · Testing
...
**Topics:** Swift · SwiftUI · SwiftData · Persistence & Synchronisation · UIKit · Xcode
...
**Topics:** Swift · SwiftUI · Macros & Metaprogramming · UIKit
...
**Topics:** Swift · SwiftUI · Observation & State Management · Macros & Metaprogramming · Concurrency

**Sections:** Reading · Library · Videos

**Selected links:**
- [Building a searchable map with SwiftUI and MapKit](https://www.polpiella.dev/mapkit-and-swiftui-searchable-map) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · SwiftData · Macros & Metaprogramming · Observation & State Management

**Sections:** Reading · Videos

**Selected links:**
- [Applying metal shader to text in SwiftUI](https://augmentedcode.io/2023/08/07/applying-metal-shader-to-text-in-swiftui) — Article · Topics: Swift · SwiftUI
...
- [MapKit for SwiftUI](https://useyourloaf.com/blog/mapkit-for-swiftui) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · Composable Architecture · SwiftUI · Architecture · Persistence & Synchronisation · SwiftData
...
- [Composable Architecture](https://github.com/pointfreeco/swift-composable-architecture) — Source repository · Topics: Architecture · Composable Architecture · Swift
  **NeKI brief:** The Composable Architecture structures feature state, actions, reducers, dependencies, and tests around explicit unidirectional flow. Use the repository and migration material to evaluate operational trade-offs before adopting or upgrading TCA in a production app.
- [Composable Architecture 1.0](https://www.pointfree.co/blog/posts/112-composable-architecture-1-0) — Article · Topics: Architecture · Composable Architecture
...
- [SwiftData Saving Changes](https://useyourloaf.com/blog/swiftdata-saving-changes) — Article · Topics: Swift · SwiftData · Persistence & Synchronisation
...
## [SwiftUI Weekly - Issue #151 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-151)

- Published: `2023-07-17T21:13:35.306Z`

**Topics:** Swift · SwiftUI · Persistence & Synchronisation · Observation & State Management · SwiftData · Core Data

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #151 · Reading

**Selected links:**
- [The Ultimate Guide to Building SwiftData Applications](https://azamsharp.com/2023/07/04/the-ultimate-swift-data-guide.html) — Article · Topics: Swift · Persistence & Synchronisation · SwiftData
...
- [SwiftUI AlignmentGuides](https://www.youtube.com/watch?v=fdSGlCgz1fQ) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [Observation Framework in iOS 17](https://sarunw.com/posts/observation-framework-in-ios17) — Article · Topics: Swift · SwiftUI · Observation & State Management
...
**Topics:** Swift · Persistence & Synchronisation · SwiftData · SwiftUI · Concurrency · Observation & State Management
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · SwiftData · App Intents & System Surfaces · Macros & Metaprogramming
...
- [SwiftUI Data Flow 2023](https://troz.net/post/2023/swiftui-data-flow-2023) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #148 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-148)

- Published: `2023-06-28T11:49:47.378Z`

**Topics:** Observation & State Management · Swift · Macros & Metaprogramming · SwiftUI · Persistence & Synchronisation · SwiftData

**Sections:** SwiftUI Weekly · SwiftUI Weekly - Issue #148 · Reading

**Selected links:**
- [#Preview SwiftUI Views using Macros](https://www.avanderlee.com/xcode/preview-swiftui-uikit-appkit-views) — Article · Topics: Swift · Macros & Metaprogramming · SwiftUI
...
- [Relationships In SwiftData](https://www.youtube.com/watch?v=_QMalUGTM4E&feature=youtu.be) — Video · Topics: Swift · SwiftData
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [SwiftUI Data Flow in iOS 17 - Observation](https://www.youtube.com/watch?v=EK7SthdWV2w) — Video · Topics: Observation & State Management · Macros & Metaprogramming · Swift
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
**Selected links:**
- [What’s new in SwiftUI for iOS 17](https://www.hackingwithswift.com/articles/260/whats-new-in-swiftui-for-ios-17) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · SwiftData · Core Data · Networking

**Sections:** Reading · Videos

**Selected links:**
- [ContentUnavailableView: Handling Empty States in SwiftUI](https://www.avanderlee.com/swiftui/contentunavailableview-handling-empty-states) — Article · Topics: Swift · SwiftUI · Networking
...
- [Inspectors in SwiftUI](https://nilcoalescing.com/blog/InspectorInSwiftUI) — Article · Topics: Swift · SwiftUI
...
**Selected links:**
- [What’s new in Swift 5.9?](https://www.hackingwithswift.com/articles/258/whats-new-in-swift-5-9) — Article · Topics: Swift · Concurrency · Macros & Metaprogramming
...
- [Using compositing group for unifying shapes within buttons in SwiftUI](https://nilcoalescing.com/blog/CompositingGroupInButtons) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #144 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-144)
...
**Selected links:**
- [Glassfy](https://eu1.hubs.ly/H01-5vC0) — Article · Topics: Swift · SwiftUI
  **NeKI brief:** Links to Glassfy's service for managing in-app purchases, paywalls, and backend subscription work. Useful as a product integration lead when comparing hosted monetization infrastructure, SDK coverage, and vendor dependency against StoreKit-first designs.
...
**Topics:** Swift · SwiftUI · Core Data · Persistence & Synchronisation · Testing
...
**Selected links:**
- [How to implement a UIViewController delegate when working with SwiftUI](https://tanaschita.com/20230508-coordinators-in-swiftui) — Article · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
- [SwiftUI Showcase View - Highlight App New Features](https://www.youtube.com/watch?v=I9v-zqrE8gI) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
- [Create a color pencil in SwiftUI](https://swdevnotes.com/swift/2023/create-a-color-pencil-in-swiftui) — Article · Topics: Swift · SwiftUI
...
- [Window Management with SwiftUI 4](https://www.fline.dev/window-management-on-macos-with-swiftui-4) — Article · Topics: Swift · SwiftUI
...
**Selected links:**
- [Export SwiftUI views as images in macOS](https://www.polpiella.dev/how-to-save-swiftui-views-as-images-in-macos) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #140 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-140)
...
- [SwiftUI Multiplatform Navigation Example](https://github.com/tunds/SwiftUI-Navigation-Multiplatform-Example) — Source repository · Topics: Swift · SwiftUI · Navigation & Deep Linking
...
- [course](https://youtube.com/playlist?list=PLvUWi5tdh92wWS3F-AVsCJHkhBlrkBp6f) — Video · Topics: Navigation & Deep Linking · Swift · SwiftUI
...
- [Speedrun Design: Heart Rate Zone View in SwiftUI](https://www.david-smith.org/blog/2023/04/24/design-notes-35) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Concurrency · Xcode
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Architecture · Concurrency
...
**Topics:** Swift · SwiftUI · AI Development · Navigation & Deep Linking · Xcode

**Sections:** Reading · Videos

**Selected links:**
- [Can ChatGPT write better SwiftUI code than you?](https://www.youtube.com/watch?v=dxxCPdcMcFw) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
**Topics:** Swift · SwiftUI · Networking · Concurrency
...
**Topics:** Swift · SwiftUI · UIKit · Accessibility · Architecture · Observation & State Management
...
- [The difference between List and LazyVStack](https://dimillian.medium.com/swiftui-the-difference-between-list-and-lazyvstack-3d5eeaccb156) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #132 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-132)
...
**Selected links:**
- [Build for free today](https://eu1.hubs.ly/H01-5vC0) — Article · Topics: Swift · SwiftUI
  **NeKI brief:** Links to Glassfy's service for managing in-app purchases, paywalls, and backend subscription work. Useful as a product integration lead when comparing hosted monetization infrastructure, SDK coverage, and vendor dependency against StoreKit-first designs.
- [Arc Coding Chronicles](https://www.youtube.com/watch?v=94asyypYj5c) — Video · Topics: Swift · SwiftUI
  **NeKI brief:** Builds a SwiftUI showcase view that highlights new app features for users. Useful for designing first-run or release-note presentations with reusable paging, emphasis, and dismissal behavior.
...
- [Reading keyboard modifiers on iPad in SwiftUI](https://nilcoalescing.com/blog/ReadingKeyboardModifiers) — Article · Topics: Swift · SwiftUI
...
## [SwiftUI Weekly - Issue #129 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-129)
...
**Selected links:**
- [30,000 lines of SwiftUI in production later: We love it but you know there was going to be a “but”](https://blog.timing.is/swiftui-production-experience-problems-solutions-performance-tips) — Article · Topics: Swift · SwiftUI · Performance
...
- [Build for free today](https://eu1.hubs.ly/H01-5vC0) — Article · Topics: Swift · SwiftUI
  **NeKI brief:** Links to Glassfy's service for managing in-app purchases, paywalls, and backend subscription work. Useful as a product integration lead when comparing hosted monetization infrastructure, SDK coverage, and vendor dependency against StoreKit-first designs.
- [Container Pattern in SwiftUI](https://azamsharp.com/2023/01/24/introduction-to-container-pattern.html) — Article · Topics: Swift · SwiftUI
...
**Topics:** Swift · SwiftUI · Swift Package Manager · Testing · UIKit
...
- [Swift Package String Localization](https://useyourloaf.com/blog/swift-package-string-localization) — Article · Topics: Swift · Swift Package Manager
...
**Topics:** Swift · SwiftUI · Architecture · UIKit · Testing
...
## [SwiftUI Weekly - Issue #126 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-126)
...
**Topics:** Swift · SwiftUI · Testing · Navigation & Deep Linking
...
**Topics:** Swift · SwiftUI · AI Development · Testing
...
## [SwiftUI Weekly - Issue #123 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-123)

- Published: `2022-12-04T21:25:23.000Z`

**Topics:** Swift · SwiftUI · AI Development · Navigation & Deep Linking
...
**Topics:** Swift · SwiftUI · Architecture · Composable Architecture · Concurrency
...
**Topics:** Swift · SwiftUI · Accessibility · Observation & State Management
...
**Topics:** Swift · SwiftUI · App Intents & System Surfaces · Testing
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Concurrency · Composable Architecture · Architecture
...
**Topics:** Swift · SwiftUI · Testing · Navigation & Deep Linking · Observation & State Management · App Intents & System Surfaces
...
## [SwiftUI Weekly - Issue #114 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-114)

- Published: `2022-09-13T16:37:55.000Z`

**Topics:** Swift · SwiftUI · App Intents & System Surfaces · Navigation & Deep Linking · Performance · Observation & State Management
...
## [SwiftUI Weekly - Issue #111 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-111)

- Published: `2022-08-01T20:26:06.000Z`

**Topics:** Swift · SwiftUI · Swift Package Manager · Xcode · UIKit
...
**Topics:** Swift · SwiftUI · Xcode · Concurrency · UIKit
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Testing · Xcode
...
## [SwiftUI Weekly - Issue #107 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-107)
...
**Topics:** Swift · SwiftUI · Xcode · Navigation & Deep Linking · UIKit
...
## [SwiftUI Weekly - Issue #104 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-104)
...
**Topics:** Swift · SwiftUI · Concurrency · Swift Package Manager · Persistence & Synchronisation · UIKit
...
**Topics:** Swift · SwiftUI · Concurrency · UIKit · Swift Package Manager
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · Core Data · Concurrency
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · Xcode · Testing · Accessibility
...
**Topics:** Swift · SwiftUI · Persistence & Synchronisation · Testing · UIKit
...
**Topics:** Swift · SwiftUI · Testing · Accessibility · Concurrency · Observation & State Management
...
**Topics:** Swift · SwiftUI · Xcode · Core Data · Swift Package Manager · UIKit
...
**Topics:** Swift · SwiftUI · Testing · UIKit · Concurrency
...
**Topics:** Swift · SwiftUI · Architecture · Concurrency · Dependency Injection · Observation & State Management
...
## [SwiftUI Weekly - Issue #90 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-90)

- Published: `2022-01-31T19:01:20.000Z`

**Topics:** Swift · SwiftUI · Architecture · Xcode · UIKit
...
**Topics:** Swift · SwiftUI · Architecture · Swift Package Manager
...
**Topics:** Swift · SwiftUI · Concurrency · Observation & State Management · Persistence & Synchronisation
...
**Topics:** Swift · SwiftUI · Concurrency · Testing · UIKit
...
**Topics:** Swift · SwiftUI · Concurrency · Networking · Core Data · Observation & State Management
...
**Topics:** Swift · SwiftUI · Concurrency · Observation & State Management · Persistence & Synchronisation · UIKit
...
**Topics:** Swift · SwiftUI · Accessibility · UIKit · Xcode
...
**Topics:** Swift · SwiftUI · Accessibility · Composable Architecture · Concurrency · Architecture
...
**Topics:** Swift · SwiftUI · Xcode · Concurrency · Composable Architecture · Testing
...
## [SwiftUI Weekly - Issue #74 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-74)
...
**Topics:** Swift · SwiftUI · Concurrency · Testing · Xcode · UIKit
...
**Topics:** Swift · SwiftUI · Testing · Xcode · Persistence & Synchronisation · Accessibility
...
**Topics:** Swift · SwiftUI · Architecture · Dependency Injection · Testing · Composable Architecture
...
## [SwiftUI Weekly - Issue #66 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-66)
...
**Topics:** Swift · SwiftUI · Xcode · Concurrency · Persistence & Synchronisation
...
**Topics:** Swift · SwiftUI · Concurrency · App Intents & System Surfaces · Xcode
...
**Topics:** Swift · SwiftUI · Concurrency · Observation & State Management · Testing · UIKit
...
**Topics:** Swift · SwiftUI · Core Data · Persistence & Synchronisation · Xcode
...
**Topics:** Swift · SwiftUI · Networking · Performance
...
**Topics:** Swift · SwiftUI · Concurrency · Performance · Swift Package Manager
...
**Topics:** Swift · SwiftUI · Swift Package Manager · Architecture · Composable Architecture · Xcode
...
**Topics:** Swift · SwiftUI · Accessibility · Composable Architecture · Architecture
...
**Topics:** Swift · SwiftUI · Observation & State Management · Networking · Architecture
...
**Topics:** Swift · SwiftUI · Testing · App Intents & System Surfaces · UIKit · Architecture
...
**Topics:** Swift · Testing · SwiftUI · Xcode · Accessibility · Observation & State Management
...
## [SwiftUI Weekly - Issue #50 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-50)

- Published: `2021-03-15T20:06:20.000Z`

**Topics:** Swift · SwiftUI · Xcode · Navigation & Deep Linking · Observation & State Management · UIKit
...
**Topics:** Swift · SwiftUI · Observation & State Management · Testing · Xcode · UIKit
...
## [SwiftUI Weekly - Issue #47 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-47)
...
**Topics:** Swift · SwiftUI · Architecture · Observation & State Management · UIKit
...
**Topics:** Swift · SwiftUI · Observation & State Management · Testing · Architecture · Concurrency
...
**Topics:** Swift · SwiftUI · Performance · UIKit · Observation & State Management · Xcode
...
**Topics:** Swift · SwiftUI · Networking · Observation & State Management
...
**Topics:** Swift · SwiftUI · Performance
...
**Topics:** Swift · SwiftUI · UIKit · Networking · Xcode
...
**Topics:** Swift · SwiftUI · UIKit · Xcode · App Intents & System Surfaces
...
**Topics:** Swift · SwiftUI · UIKit · Accessibility · Testing
...
**Topics:** Swift · SwiftUI · UIKit · Swift Package Manager
...
**Topics:** Swift · SwiftUI · Dependency Injection · Architecture · Navigation & Deep Linking · Concurrency
...
## [SwiftUI Weekly - Issue #33 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-33)

- Published: `2020-10-27T16:57:07.000Z`

**Topics:** Swift · SwiftUI · Xcode · Observation & State Management · UIKit · Accessibility
...
**Topics:** Swift · SwiftUI · Navigation & Deep Linking · Concurrency
...
**Topics:** Swift · SwiftUI · UIKit · Accessibility · Persistence & Synchronisation
...
**Topics:** Swift · SwiftUI · Networking · Accessibility · Observation & State Management
...
## [SwiftUI Weekly - Issue #28 - by Majid Jabrayilov](https://weekly.swiftwithmajid.com/p/swiftui-weekly-issue-28)

- Published: `2020-09-21T17:31:43.000Z`

**Topics:** Swift · SwiftUI · Observation & State Management · Performance · UIKit
