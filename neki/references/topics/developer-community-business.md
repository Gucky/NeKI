...
- [Blog Update Chronicle - Welcoming 2024 with a New Blog](https://fatbobman.com/en/posts/blog-update-chronicle-2024) — Fatbobman · article catalogue
...
- [Handy git customizations | Dave DeLong](https://davedelong.com/blog/2023/03/04/handy-git-customizations) — Dave DeLong · article catalogue
...
- [Creating a Blog with Publish - Plugin](https://fatbobman.com/en/posts/publish-3) — Fatbobman · article catalogue
...
- [A Signal Strength Indicator · objc.io](https://www.objc.io/blog/2020/02/18/a-signal-strength-indicator) — objc.io · article catalogue
  **Published:** `2020-2-18`
...
- [Introducing Time | Dave DeLong](https://davedelong.com/blog/2020/02/29/introducing-time) — Dave DeLong · article catalogue
...
- [A Crash Course in Combine](https://www.pointfree.co/blog/posts/32-a-crash-course-in-combine) — Point-Free · article catalogue
...
- [Reading your own entitlements | Dave DeLong](https://davedelong.com/blog/2018/01/10/reading-your-own-entitlements) — Dave DeLong · article catalogue
...
- [Code vs. Poetry – Ole Begemann](https://oleb.net/blog/2015/01/code-vs-poetry) — Ole Begemann · article catalogue
  **Published:** `2015-01-13T19:10:00Z`
...
- [Dan Grossman’s Programming Languages Course – Ole Begemann](https://oleb.net/blog/2014/12/programming-languages-mooc) — Ole Begemann · article catalogue
  **Published:** `2014-12-10T18:01:00Z`
...
- [Work Habits at Apple – Ole Begemann](https://oleb.net/blog/2014/09/work-habits-at-apple) — Ole Begemann · article catalogue
  **Published:** `2014-09-30T16:40:00Z`
...
- [Selecting People Faster — Chris Eidhof](https://chris.eidhof.nl/post/selecting-people-faster) — Chris Eidhof · article catalogue
  **NeKI brief:** A project update describing a streamlined person-selection flow modeled after familiar recipient entry. Use it as a small UX iteration example rather than reusable component guidance.
- [Radical Honesty — Chris Eidhof](https://chris.eidhof.nl/post/radical-honesty) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal exploration of radical honesty and the tension between openness and avoiding harm. Use it as an individual communication experiment rather than relationship or workplace advice.
- [Radical Friendship — Chris Eidhof](https://chris.eidhof.nl/post/radical-friendship) — Chris Eidhof · article catalogue
  **NeKI brief:** A follow-up personal reflection that reframes complete honesty around supportive friendship and social context. Treat it as the author's evolving perspective, not a general interpersonal method.
- [Lost In Translation — Chris Eidhof](https://chris.eidhof.nl/post/lost-in-translation) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal engineering perspective on how intent gets distorted when people communicate about software. It is useful for reflecting on collaboration and handoffs, not for prescribing a formal team process.
- [Finding My Most Influential Twitter Followers — Chris Eidhof](https://chris.eidhof.nl/post/finding-my-most-influential-twitter-followers) — Chris Eidhof · article catalogue
  **NeKI brief:** Walks through a Ruby and MongoDB experiment for ranking Twitter followers by influence. It is useful as a historical data-analysis example, but its social APIs and dependencies are likely obsolete.
- [DONE — Chris Eidhof](https://chris.eidhof.nl/post/done) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal status update covering UIKonf organization and other work at that point in time. It provides community-history context but little reusable technical guidance.
- [CocoaConf — Chris Eidhof](https://chris.eidhof.nl/post/cocoaconf) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal account of a conference-speaking arrangement and why the planned CocoaConf appearance did not proceed. It is useful as community-history and speaker-experience perspective, not technical material.
...
- [Berlin Tech Meetups — Chris Eidhof](https://chris.eidhof.nl/post/berlin-tech-meetups) — Chris Eidhof · article catalogue
  **NeKI brief:** A community-maintained list of Berlin technology meetups from the time of publication. It is nontechnical discovery material and likely stale, so verify every group and event independently.
...
- [Alt Tech Talks — Chris Eidhof](https://chris.eidhof.nl/post/alt-tech-talks) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal story about turning rejection from Apple's Tech Talks into an independently organized alternative event. It is useful as community-building perspective rather than developer documentation.
- [Weeknotes № 44 — Chris Eidhof](https://chris.eidhof.nl/post/2024-44) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal conference and family-travel note about attending Pragma and making the journey by train. Read it for community and travel perspective, not implementation guidance.
- [Weeknotes № 42-43 — Chris Eidhof](https://chris.eidhof.nl/post/2024-43) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal update spanning cycling, injury management, travel, and Pragma Conference. It provides context on the author's current life and community activity rather than a focused technical topic.
- [Weeknotes № 21 — Chris Eidhof](https://chris.eidhof.nl/post/2024-21) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal work log about preparing and teaching several workshops while also getting ready for a conference talk. It offers a candid view of the workload behind independent technical education.
...
- [Weeknotes № 9 — Chris Eidhof](https://chris.eidhof.nl/post/2024-09) — Chris Eidhof · article catalogue
  **NeKI brief:** A reflection on returning to in-person SwiftUI teaching in Berlin and preparing further workshop and meetup appearances. Useful for the author's perspective on interactive technical instruction.
- [Weeknotes № 46-47 — Chris Eidhof](https://chris.eidhof.nl/post/2023-47) — Chris Eidhof · article catalogue
  **NeKI brief:** A travel-and-work reflection on visiting London, reconnecting with the local iOS community, and preparing workshops. Useful for community and independent-teaching context.
- [Weeknotes № 33 — Chris Eidhof](https://chris.eidhof.nl/post/2023-33) — Chris Eidhof · article catalogue
  **NeKI brief:** A personal conference note about extending a Toronto trip to speak at iOSoho in New York after extensive presentation preparation. Useful for a speaker's perspective on the effort behind technical talks.
...
- [articles](https://swiftology.io/articles) — iOS Dev Weekly · Issue 757 — Article · Topics: Developer Community & Business · Swift
  **Published:** `3rd July 2026`
  **NeKI brief:** Examines Advanced Swift | Functional Programming | Software Design written by Alex Ozun. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [YouTube channel](https://www.youtube.com/@smartherd/featured) — iOS Dev Weekly · Issue 753 — Video · Topics: Developer Community & Business
  **Published:** `5th June 2026`
  **NeKI brief:** I’m Sriyank Siddhartha, Head of Developer Community at next.app devCon. Twelve years ago, I ran my first mobile app and fell in love with building. I taught myself, then taught others - millions through my YouTube channel and my Pluralsight courses. It never…
- [Pluralsight courses](https://www.pluralsight.com/authors/sriyank-siddhartha) — iOS Dev Weekly · Issue 753 — Tutorial · Topics: Developer Community & Business
  **Published:** `5th June 2026`
  **NeKI brief:** Presents Pluralsight courses, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [Swift Island - A Swift Conference, on an island](https://ti.to/swiftisland/2026/discount/ANTOINE_APPROVED) — SwiftLee Weekly · Issue 323 — Article · Topics: Developer Community & Business · Swift
...
- [AcceptedSE-0528`Continuation` — Safe and Performant Async Continuations](https://github.com/apple/swift-evolution/blob/main/proposals/0528-noncopyable-continuation.md) — SwiftLee Weekly · Issue 323 — Source repository · Topics: Concurrency · Developer Community & Business · Swift
  **Published:** `2026-05-12T14:05:49.000Z`
...
- [AI tool policy](https://github.com/hummingbird-project/hummingbird/blob/main/AI_POLICY.md) — iOS Dev Weekly · Issue 748 — Source repository · Topics: AI Development · Developer Community & Business · Developer Tools
  **Published:** `17th April 2026`
  **NeKI brief:** One community announcement that stood out to me this week was the Hummingbird project announcing their AI tool policy.
- [AppLayouts](https://www.applayouts.com/) — iOS Dev Tools · iOS Dev Tools: SwiftZilla, Room Service, Pica — Article · Topics: Developer Community & Business
...
- [88: SwiftLee – Antoine van der Lee](https://launchedfm.com/episode/88-swiftlee-antoine-van-der-lee) — SwiftLee Weekly · Issue 317 — Podcast · Topics: Developer Community & Business · Swift
...
- [iOS Dev Directory](https://iosdevdirectory.com/contributing) — SwiftLee Weekly · Issue 315 — Article · Topics: Developer Community & Business · Swift
...
- [Staff Engineering in Mobile Teams: Myth vs Reality](https://www.youtube.com/watch?v=x5wug2V1244) — Those Who Swift · Issue 256 — Video · Topics: Developer Community & Business · Swift
...
- [The Shift: Using AI as a Developer Advocate and Engineer](https://www.swiftjectivec.com/the-shift-using-ai-as-a-developer-advocate-and-engineer) — Those Who Swift · Issue 250 — Article · Topics: AI Development · Developer Community & Business · Swift
...
- [iOSKonf26 - iOS Conference in the Balkans](https://www.ioskonf.mk/tickets) — Those Who Swift · Issue 248 — Article · Topics: Developer Community & Business
...
- [The Age of Micro-Entrepreneurs](https://merowing.info/posts/the-age-of-micro-entrepreneurs) — Those Who Swift · Issue 248 — Article · Topics: Developer Community & Business · Developer Tools
  **Published:** `2026-01-08`
...
- [Swift coming to Android](https://www.swift.org/blog/nightly-swift-sdk-for-android) — Those Who Swift · Issue 247 — Tutorial · Topics: Cross-Platform & Web · Developer Community & Business · Swift
  **Published:** `2026-01-01`
  **NeKI brief:** We can't wait to see what scary things you will Create with Swift tonight! 🎃👻
- [Using Swift SDKs with Raspberry PIs](https://xtremekforever.substack.com/p/using-swift-sdks-with-raspberry-pis) — iOS Dev Weekly · Issue 737 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `19th December 2025`
  **NeKI brief:** Presents using swift sdks with raspberry pis for Apple-platform developers, highlighting the implementation approach and practical trade-offs. Use it as a focused starting point, then verify APIs, versions, and operational constraints against your project and current documentation.
- [hummingbird-examples](https://github.com/hummingbird-project/hummingbird-examples) — iOS Dev Weekly · Issue 737 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `19th December 2025`
  **NeKI brief:** Examines Examples demonstrating various aspects of the Hummingbird swift server framework - hummingbird-project/hummingbird-examples. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Swiftable 2022](https://www.swiftable.co/2022) — iOS Dev Weekly · Issue 736 — Article · Topics: Developer Community & Business · Swift
  **Published:** `21st November 2025`
  **NeKI brief:** Soroush Khanlou’s conference talk from Swiftable 2022 in Buenos Aires is worth a watch, and the chart-led approach to problem-solving in the post is interesting, too.
...
- [since the closure](https://swiftweekly.github.io/issue-201) — iOS Dev Weekly · Issue 735 — Article · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `14th November 2025`
  **NeKI brief:** Swift Weekly issue 201 is a publicly readable newsletter edition collecting Swift ecosystem news and links.
- [Community Showcase](https://forums.swift.org/c/community-showcase/66) — iOS Dev Weekly · Issue 735 — Article · Topics: Developer Community & Business · Swift
  **Published:** `14th November 2025`
  **NeKI brief:** By the way, the Community Showcase forum is a great way to get the word out on projects like this. I subscribe to posts there by RSS, but there are only a few posts per month. It’s a great way to get the word out about your current project.
...
- [How Antoine van der Lee made $40K on his first Teachable course launch → Teachable](https://teachable.com/blog/antoine-van-der-lee-case-study) — SwiftLee Weekly · Issue 297 — Tutorial · Topics: Developer Community & Business
  **Published:** `2025-11-11T15:06:31.000Z`
...
- [I Gave My First Conference Talk!](https://chriswu.com/posts/speaking/sl2025) — iOS Dev Weekly · Issue 734 — Article · Topics: Developer Community & Business
...
- [first-ever conference talk](https://youtu.be/0MXlt97eTCE) — iOS Dev Weekly · Issue 734 — Video · Topics: Developer Community & Business
  **Published:** `7th November 2025`
  **NeKI brief:** I had to double take when I saw that Chris Wu’s first-ever conference talk was about time zones! That’s quite the topic to start with, Chris, but I’m so glad that you did, and that it inspired this fantastic write-up of your experience. ❤️ I hope it…
...
- [Unlock more sales with multiple payment methods](https://developer.paddle.com/concepts/sell/hosted-checkout-mobile-apps) — Those Who Swift · Issue 237 — Article · Topics: Developer Community & Business
...
- [AcceptedSE-0492Section Placement Control](https://github.com/apple/swift-evolution/blob/main/proposals/0492-section-control.md) — SwiftLee Weekly · Issue 294 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
...
- [AcceptedSE-0494Add `isIdentical(to:)` Methods for Quick Comparisons to Concrete Types](https://github.com/apple/swift-evolution/blob/main/proposals/0494-add-is-identical-methods.md) — SwiftLee Weekly · Issue 294 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `2025-10-21T14:13:02.000Z`
...
- [Active ReviewSE-0497Controlling function definition visibility in clients](https://github.com/apple/swift-evolution/blob/main/proposals/0497-definition-visibility.md) — SwiftLee Weekly · Issue 294 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `2025-10-21T14:13:02.000Z`
...
- [and FOSDEM](https://www.swift.org/blog/memory-safety-ecosystem-talks-java-interoperability-fosdem-2025) — iOS Dev Weekly · Issue 730 — Article · Topics: Developer Community & Business · Swift
  **Published:** `10th October 2025`
  **NeKI brief:** The Swift.org article discusses memory safety, the Swift ecosystem, Java interoperability, and the author's FOSDEM talk.
- [huge financial losses](https://www.timc.dev/posts/the-cost-of-running-a-conference) — iOS Dev Weekly · Issue 729 — Article · Topics: Developer Community & Business · Personal Essays
...
- [tutorials](https://docs.swift.org/getting-started-swift-server/tutorials/getting-started-swift-server) — iOS Dev Weekly · Issue 728 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `26th September 2025`
  **NeKI brief:** Presents tutorials for Apple-platform developers, highlighting the implementation approach and practical trade-offs. Use it as a focused starting point, then verify APIs, versions, and operational constraints against your project and current documentation.
- [site redesign](https://www.swift.org/blog/redesigned-swift-org-is-now-live) — iOS Dev Weekly · Issue 728 — Article · Topics: Developer Community & Business · Swift
  **Published:** `26th September 2025`
  **NeKI brief:** The official Swift website has had plenty of content changes during the last couple of years, but none as significant as this! This week, the redesign project, which has been in the works for months, was unveiled. Even though I’m a member of the Swift…
...
- [Swift 6.2 Java interoperability in practice](https://arturgruchala.com/swift-6-2-java-interoperability-in-practice) — iOS Dev Weekly · Issue 718 — Article · Topics: Developer Community & Business · Personal Essays · Swift
  **Published:** `18th July 2025`
  **NeKI brief:** Examines If you’ve ever tried straddling two worlds—one foot in the elegant, type-safe realm of Swift and the other in the sprawling ecosystem of Java—you know the pain of keeping them in s. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [swift-java package](https://github.com/swiftlang/swift-java) — iOS Dev Weekly · Issue 718 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `18th July 2025`
...
- [AcceptedSE-0474Yielding accessors](https://github.com/apple/swift-evolution/blob/main/proposals/0474-yielding-accessors.md) — SwiftLee Weekly · Issue 278 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `2025-07-01T14:14:53.000Z`
...
- [Swift.org has now officially launched an Android Workgroup](https://www.swift.org/android-workgroup) — Fatbobman’s Swift Weekly · Issue 91 — Article · Topics: Cross-Platform & Web · Developer Community & Business · Swift
...
- [Pedro Piñera](https://mastodon.pepicrft.me/@pedro) — iOS Dev Weekly · Issue 714 — Article · Topics: Developer Community & Business
  **Published:** `13th June 2025`
  **NeKI brief:** Pedro Piñera presents a round-up of developer tooling highlights from this year’s conference, including a comment on container and containerization:
- [case study](https://www.swift.org/blog/swift-at-apple-migrating-the-password-monitoring-service-from-java) — Fatbobman’s Swift Weekly · Issue 87 — Article · Topics: Developer Community & Business · Security & Privacy · Swift
...
- [Ten Years Older: Voice Takes Over](https://byla.lt/posts/ten-years-older-voice-takes-over) — Those Who Swift · Issue 213 — Tutorial · Topics: AI Development · Developer Community & Business
...
- [Building a Business on Swift on the Server, Vapor & Open Source](https://podcast.going-indie.com/episodes/building-a-business-on-swift-on-the-server-vapor-open-source-tim-condon) — SwiftLee Weekly · Issue 266 — Podcast · Topics: Developer Community & Business · Swift
...
- [Swift by Sundell is back!](https://www.swiftbysundell.com/special/swift-by-sundell-is-back) — SwiftLee Weekly · Issue 265 — Article · Topics: Developer Community & Business · Personal Essays · Swift
...
- [The Power of Consistency: a Path to Indie Development - Pol Piella](https://podcast.going-indie.com/episodes/the-power-of-consistency-a-path-to-indie-development-pol-piella) — SwiftLee Weekly · Issue 263 — Podcast · Topics: Developer Community & Business
...
- [blog](https://www.revenuecat.com/blog) — iOS Dev Weekly · Issue 703 — Podcast · Topics: Developer Community & Business
  **Published:** `14th March 2025`
  **NeKI brief:** The company is RevenueCat, and their main content output is their blog, but they also have a podcast and newsletter.
- [podcast and newsletter](https://www.revenuecat.com/subclub) — iOS Dev Weekly · Issue 703 — Podcast · Topics: Developer Community & Business
  **Published:** `14th March 2025`
  **NeKI brief:** Presents podcast and newsletter, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [discussion and consideration](https://forums.swift.org/t/social-presence-outside-twitter/74968) — Fatbobman’s Swift Weekly · Issue 72 — Article · Topics: Developer Community & Business · Swift
...
- [FOSDEM](https://fosdem.org/2025) — iOS Dev Weekly · Issue 698 — Article · Topics: Developer Community & Business · Swift
  **Published:** `7th February 2025`
  **NeKI brief:** Examines FOSDEM 2025 - Home. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Download HERE.](https://donnywals.gumroad.com/l/practical-bundle) — Those Who Swift · Issue 199 — Article · Topics: Developer Community & Business
...
- [Things that did (and didn't) contribute to Burnout Buddy's success](https://swiftrocks.com/things-that-did-and-didnt-contribute-to-burnout-buddys-success) — SwiftLee Weekly · Issue 256 — Tutorial · Topics: Developer Community & Business · Swift
...
- [Desina02](https://www.desina.it/ospiti/imaginary-institute?ref=createwithswift.com) — Create with Swift · Issue 42 — Article · Topics: Developer Community & Business · Swift
  **Published:** `2024-12-27T16:00:38.000Z`
  **NeKI brief:** Desina02, DesignFAO, iOSDevUK, Swift Conf, Swift Heroes, Swift Leeds
- [Swift Heroes](https://swiftheroes.com/swiftheroes-2024/speaker/LJWKMQ?ref=createwithswift.com) — Create with Swift · Issue 42 — Article · Topics: Developer Community & Business · Swift
  **Published:** `2024-12-27T16:00:38.000Z`
  **NeKI brief:** Desina02, DesignFAO, iOSDevUK, Swift Conf, Swift Heroes, Swift Leeds
- [Under the Radar Podcast: What's In Our Toolbox: Simulators & Source Control](https://www.relay.fm/radar/308) — SwiftLee Weekly · Issue 251 — Podcast · Topics: Developer Community & Business
...
- [labelling](https://docs.bsky.app/docs/advanced-guides/moderation) — iOS Dev Weekly · Issue 690 — Article · Topics: Developer Community & Business
  **Published:** `6th December 2024`
  **NeKI brief:** There are enough interesting accounts to follow that are outside of the tech community that my timeline is nicely varied, which never happened for me on Mastodon. I also love some of the technical features, like being able to remove the default timeline and…
- [Do you have a Black Friday deal?](https://github.com/mRs-/Black-Friday-Deals) — iOS Dev Weekly · Issue 688 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `22nd November 2024`
  **NeKI brief:** Examines Black Friday Deals for macOS / iOS Software & Books - mRs-/Black-Friday-Deals. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [or Sonumi](https://shaminospage.blogspot.com/2024/02/apples-magic-sound-file-renaming.html) — iOS Dev Weekly · Issue 681 — Article · Topics: Cross-Platform & Web · Developer Community & Business · Swift
  **Published:** `4th October 2024`
  **NeKI brief:** I mentioned in the last issue that I didn’t have the full context from Tony Parker and Ben Cohen’s announcement of swift-java. Now the videos from last week’s Server-Side Swift Conference are out, you can watch the whole announcement. All the other session…
- [swift-java](https://github.com/swiftlang/swift-java.git) — iOS Dev Weekly · Issue 680 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `30th September 2024`
  **NeKI brief:** The big Swift news from last week happened at the Server-Side Swift conference in the keynote session. Tony Parker and Ben Cohen announced swift-java, a Swift/Java interoperability library.
...
- [Create with Swift - Napoli Meetup](https://airtable.com/appdaAgCSYdwA8wch/shruZ80n2BqwLHbO1?ref=createwithswift.com) — Create with Swift · Issue 23 — Article · Topics: Developer Community & Business · Swift
...
- [Create with Swift](https://www.createwithswift.com/make-it-spatial) — iOS Dev Weekly · Issue 669 — Article · Topics: Developer Community & Business · Swift
  **Published:** `12th July 2024`
  **NeKI brief:** So the million (or billion) dollar question is, will third-party developers choose to invest that time and effort? I’ve been keeping a close eye on the community since the US launch, and have noticed that the number of people writing about development in…
- [elkraneo](https://www.elkraneo.com/tag/visionos) — iOS Dev Weekly · Issue 669 — Article · Topics: Developer Community & Business · Spatial Computing
  **Published:** `12th July 2024`
  **NeKI brief:** So the million (or billion) dollar question is, will third-party developers choose to invest that time and effort? I’ve been keeping a close eye on the community since the US launch, and have noticed that the number of people writing about development in…
- [New GitHub Organization for the Swift Project](https://www.swift.org/blog/swiftlang-github) — iOS Dev Weekly · Issue 665 — Article · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `14th June 2024`
  **NeKI brief:** Examines Today, we are announcing an exciting development for the Swift programming language: its migration to a dedicated GitHub organization at GitHub.com/swiftlang. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [MessageKit](https://github.com/MessageKit/MessageKit) — iOS Dev Tools · iOS Dev Tools: AppDab, MessageKit, Stats — Source repository · Topics: Developer Community & Business · Developer Tools
...
- [disagrees with Jim](https://en.wikipedia.org/wiki/Worldwide_Developers_Conference) — iOS Dev Weekly · Issue 660 — Article · Topics: Developer Community & Business
  **Published:** `10th May 2024`
  **NeKI brief:** Presents disagrees with Jim, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [Creating iOSExpert](https://racecondition.software/blog/iosexpert) — iOS Dev Weekly · Issue 651 — Tutorial · Topics: Combine & Reactive Programming · Developer Career & Practice · Developer Community & Business
  **Published:** `8th March 2024`
  **NeKI brief:** Describes the creation of iOSExpert and the product decisions behind a specialized iOS development tool. Useful for examining how focused developer utilities are shaped around real workflow friction.
...
- [hundreds of community members](https://github.com/daveverwer/iOSDevDirectory/pulls?q=is%3Apr+is%3Amerged) — iOS Dev Weekly · Issue 642 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `5th January 2024`
  **NeKI brief:** Examines The iOS Dev Directory. Contribute to iOSDevDirectory/iOSDevDirectory development by creating an account on GitHub. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [in the Community Showcase forum](https://forums.swift.org/t/meet-plain-swift/68898) — iOS Dev Weekly · Issue 640 — Article · Topics: Developer Community & Business · Swift
  **Published:** `15th December 2023`
  **NeKI brief:** Examines Here's my take on developing Windows apps in Swift: Plain Swift. Plain Swift on the Web: https://www.plainswift.com Plain Swift in Microsoft Store: Plain Swift - Official app i. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [The power of the 8-Point Grid Guide](https://david.y4ng.fr/the-art-of-the-corner-radius) — iOS Dev Weekly · Issue 639 — Tutorial · Topics: Developer Community & Business
  **Published:** `8th December 2023`
  **NeKI brief:** Presents The power of the 8-Point Grid Guide, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [posted to the Swift Community Showcase](https://forums.swift.org/t/swift-chat-showcase-for-distributed-application/67803) — iOS Dev Weekly · Issue 631 — Article · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `13th October 2023`
  **NeKI brief:** The page covers “posted to the Swift Community Showcase” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [longer have this excuse](https://xkcd.com/303) — iOS Dev Weekly · Issue 624 — Tutorial · Topics: Developer Community & Business
  **Published:** `25th August 2023`
  **NeKI brief:** Of course, it means you’ll no longer have this excuse, so… you know… pros and cons. 😂
- [one of the hard problems](https://martinfowler.com/bliki/TwoHardThings.html) — iOS Dev Weekly · Issue 623 — Article · Topics: Cross-Platform & Web · Developer Community & Business · Swift
...
- [Driving Users to Sign Into the Community Database](https://ryanashcraft.com/driving-users-to-sign-into-the-community-database) — iOS Dev Weekly · Issue 618 — Article · Topics: Developer Community & Business · Persistence & Synchronisation
  **Published:** `14th July 2023`
  **NeKI brief:** Examines A retrospective on a relatively minor design change that actually made a significant difference on some key product metrics. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [SwiftUI Data Flow 2023](https://troz.net/post/2023/swiftui-data-flow-2023) — SwiftUI Weekly · SwiftUI Weekly - Issue #149 — Article · Topics: Developer Community & Business · Swift · SwiftUI
...
- [Swift core team](https://www.swift.org/community) — iOS Dev Weekly · Issue 609 — Article · Topics: Developer Community & Business · Swift
  **Published:** `12th May 2023`
  **NeKI brief:** In case you’re not aware, Saleem is a Swift core team member and the driving force behind Swift on Windows and other efforts like SwiftWinRT and SwiftWin32.
- [driving force behind Swift on Windows](https://www.swift.org/blog/swift-on-windows) — iOS Dev Weekly · Issue 609 — Article · Topics: Developer Community & Business · Swift
  **Published:** `12th May 2023`
  **NeKI brief:** Examines The Swift project is introducing new downloadable Swift toolchain images for Windows! These images contain development components needed to build and run Swift code on Windows. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [implement this suggestion](https://github.com/daveverwer/iOSDevDirectory/issues/686) — iOS Dev Weekly · Issue 591 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `6th January 2023`
  **NeKI brief:** So, whether you’ve fully migrated to Mastodon or now split your time between multiple platforms, let people know where they can find you by opening a pull request that updates your entry in the blogs.json. Of course, if you haven’t yet added an entry for…
- [Sunsetting AppCode](https://blog.jetbrains.com/appcode/2022/12/appcode-2022-3-release-and-end-of-sales-and-support) — iOS Dev Weekly · Issue 589 — Article · Topics: Developer Community & Business · Swift
  **Published:** `16th December 2022`
  **NeKI brief:** Explores Sunsetting AppCode, focusing on the article discusses was sad to read this post from anastasia kazakova announcing an end-of-life plan for appcode. some people will dearly. Follow it to assess the approach and trade-offs before applying it in a current Swift or Apple-platform project.
...
- [Kodeco](https://www.kodeco.com/36641071-introducing-kodeco-the-new-raywenderlich-com) — iOS Dev Weekly · Issue 582 — Article · Topics: Developer Community & Business · Product Design · Swift
  **Published:** `28th October 2022`
  **NeKI brief:** Presents Kodeco, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
- [2](https://www.kodeco.com/36641099-why-rebrand-the-backstory-of-raywenderlich-com) — iOS Dev Weekly · Issue 582 — Article · Topics: Developer Community & Business · Product Design · Swift
  **Published:** `28th October 2022`
  **NeKI brief:** Examines Kodeco is the new raywenderlich.com! Learn where it all started, and what led us to a rebrand. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [3](https://www.kodeco.com/36671698-to-infinity-and-far-far-beyond) — iOS Dev Weekly · Issue 582 — Article · Topics: Developer Community & Business · Product Design · Swift
  **Published:** `28th October 2022`
  **NeKI brief:** Examines With the new Kodeco brand launched, CEO Matt Derrick reflects on what’s changed since 2021 and gives us a glimpse of what to expect in 2023 and beyond!. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [4](https://www.kodeco.com/36641116-319-days-to-building-a-new-brand) — iOS Dev Weekly · Issue 582 — Article · Topics: Developer Community & Business · Product Design · Swift
  **Published:** `28th October 2022`
  **NeKI brief:** Examines Pivoting a global brand is as challenging as you would think! CEO Matt Derrick talks about the journey to Kodeco.com — and the pitfalls (narrowly) avoided. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Chime 2.0](https://www.chimehq.com/blog/version-two) — iOS Dev Weekly · Issue 582 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `28th October 2022`
  **NeKI brief:** The release post introduces Chime 2.0 and describes the changes to the Mac code editor and development tool.
- [article on ExtensionKit](https://www.chimehq.com/blog/extensionkit-intro) — iOS Dev Weekly · Issue 582 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `28th October 2022`
...
- [left the organisers with a huge bill to pay](https://www.gofundme.com/f/cover-2022-final-hotel-bill) — iOS Dev Weekly · Issue 575 — Article · Topics: Developer Community & Business
  **Published:** `9th September 2022`
  **NeKI brief:** Unfortunately, that’s not the only conference news this week, with the sad announcement that this year’s 360 iDev would be the last. I never managed to attend a 360 iDev event, but I know they were well-loved by many. It’s also a tragedy that it left the…
- [check out upcoming Apple-platform conferences](https://confs.tech/ios) — iOS Dev Weekly · Issue 575 — Article · Topics: Developer Community & Business
  **Published:** `9th September 2022`
  **NeKI brief:** The page lists upcoming Apple-platform conferences and events, providing a readable directory of event information.
- [Mobile DevOps Summit on November 10th. Call For Speakers is now open!](https://sessionize.com/mobile-devops-summit-2022) — iOS Dev Weekly · Issue 572 — Article · Topics: Developer Community & Business
  **Published:** `19th August 2022`
  **NeKI brief:** Mobile DevOps Summit 2022 is a one-day virtual conference powered by Bitrise that brings together over 2500 mobile practitioners and global business leaders to discuss unique challenges faced by mobile teams. Submit your talk and become a speaker to drive…
...
- [Two years of Indie Dev Monday](https://indiedevmonday.com/issue-106) — iOS Dev Weekly · Issue 570 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `5th August 2022`
  **NeKI brief:** Examines Today I’m celebrating the Year Two Anniversary of Indie Dev Monday. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [be a part of it a few weeks ago](https://indiedevmonday.com/issue-101) — iOS Dev Weekly · Issue 570 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `5th August 2022`
  **NeKI brief:** The Indie Dev Monday issue is a publicly readable edition containing independent-app development links and commentary.
- [merchandise sale](https://indiedevmonday.com/two-year-anniversary) — iOS Dev Weekly · Issue 570 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `5th August 2022`
  **NeKI brief:** Marks an independent-development publication anniversary and discusses its creator workflow. Useful for product-process context, though promotional material is not technical guidance.
...
- [consistent maintenance](https://github.com/parse-community/parse-server/graphs/contributors) — iOS Dev Weekly · Issue 560 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `27th May 2022`
  **NeKI brief:** The README looked impressive and seemed to be primarily created by one person, Corey E Baker. I was curious, so I reached out to him, and he explained that his interest came out of wanting to sync some CareKit data through to Parse. The Parse server has…
- [just look at that graph](https://github.com/parse-community/Parse-Swift/graphs/contributors) — iOS Dev Weekly · Issue 560 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `27th May 2022`
  **NeKI brief:** The page covers “just look at that graph” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [Paid Contributors Program](https://github.com/parse-community/Governance/blob/main/paid-contributors.md) — iOS Dev Weekly · Issue 560 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `27th May 2022`
  **NeKI brief:** Examines Details about the leadership & decision making process for the Parse Community - Governance/paid-contributors.md at main · parse-community/Governance. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [excellent sample code](https://www.highcaffeinecontent.com/blog/20210605-Catalyst-Sample-Code-Roundup) — iOS Dev Weekly · Issue 546 — Tutorial · Topics: Developer Community & Business
...
- [thoughts on what could be improved](https://www.highcaffeinecontent.com/blog/20220216-Where-Mac-Catalyst-Falls-Short) — iOS Dev Weekly · Issue 546 — Tutorial · Topics: Developer Community & Business
  **Published:** `18th February 2022`
  **NeKI brief:** Presents thoughts on what could be improved, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
- [Tips for getting the most out of DocC](https://rhonabwy.com/2022/02/10/tips-for-getting-the-most-out-of-docc) — iOS Dev Weekly · Issue 546 — Article · Topics: Developer Community & Business
  **Published:** `18th February 2022`
  **NeKI brief:** Presents Tips for getting the most out of DocC, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [Swift Package Index project](https://github.com/SwiftPackageIndex/SwiftPackageIndex-Server) — iOS Dev Weekly · Issue 533 — Source repository · Topics: Developer Community & Business · Swift · Swift Package Manager
...
- [Disclosure Group in SwiftUI](https://serialcoder.dev/text-tutorials/swiftui/disclosure-group-in-swiftui) — iOS Dev Weekly · Issue 526 — Tutorial · Topics: Developer Community & Business · Swift · SwiftUI
  **Published:** `24th September 2021`
  **NeKI brief:** Explores Disclosure Group in SwiftUI, focusing on i’ve never been a big fan of disclosure/drop-down ui in. Follow it to assess the approach and trade-offs before applying it in a current Swift or Apple-platform project.
- [Swift Regrets](https://belkadan.com/blog/2021/09/Swift-Regrets) — iOS Dev Weekly · Issue 525 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `17th September 2021`
  **NeKI brief:** Explores Swift Regrets, focusing on these regrets from jordan rose are fascinating. it’s easy to think that when apple adds something to swift, the language designers all. Follow it to assess the approach and trade-offs before applying it in a current Swift or Apple-platform project.
- [the full list of posts here](https://belkadan.com/blog/tags/swift-regrets) — iOS Dev Weekly · Issue 525 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `17th September 2021`
...
- [earlier this year](https://www.dailysalesemail.com/blog/1-getting-started-with-daily-sales-email) — iOS Dev Weekly · Issue 524 — Article · Topics: Developer Community & Business
  **Published:** `10th September 2021`
  **NeKI brief:** The post explains getting started with Daily Sales Email and provides publicly readable product and workflow information.
...
- [Open-Sourcing Pulse](https://kean.blog/post/open-sourcing-pulse) — iOS Dev Weekly · Issue 516 — Article · Topics: Developer Community & Business
  **Published:** `16th July 2021`
  **NeKI brief:** Examines Open-source developer tools. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Apple’s DocC is excellent, but unusable for open source projects](https://www.jessesquires.com/blog/2021/06/29/apple-docc-great-but-useless-for-oss) — iOS Dev Weekly · Issue 514 — Article · Topics: Developer Community & Business
  **Published:** `2nd July 2021`
  **NeKI brief:** Examines I was very excited at this year’s WWDC when Apple announced DocC, their new “Documentation Compiler” tool that generates documentation from comments in your. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [iOS Chats](https://nemecek.be/chats) — iOS Dev Weekly · Issue 498 — Article · Topics: Developer Community & Business
  **Published:** `12th March 2021`
  **NeKI brief:** This is a nice idea. Filip Němeček has started writing up interviews with various members of the community. He always begins by asking how they got started, but the conversations head in many different directions after that.
...
- [follow up](https://blog.human-friendly.com/microinjection-tiny-dependency-injection-package) — iOS Dev Weekly · Issue 497 — Tutorial · Topics: Developer Community & Business · Swift · SwiftUI
  **Published:** `5th March 2021`
  **NeKI brief:** Presents MicroInjection, a deliberately small dependency-injection package, and positions it against SwiftUI environment-based approaches. Useful when evaluating whether an app needs a lightweight explicit dependency boundary instead of adopting a larger container or global service locator.
...
- [Computers, Privacy & Data Protection Conference](https://www.youtube.com/watch?v=zjP9JYeAS5s) — iOS Dev Weekly · Issue 493 — Video · Topics: Developer Community & Business · Security & Privacy
  **Published:** `5th February 2021`
  **NeKI brief:** It was Data Privacy Day last week, and Apple was all over it. The most significant part of the event was Tim Cook’s appearance at the Computers, Privacy & Data Protection Conference. Tim doesn’t often speak publicly, which should tell you how important this…
- [The 2020 iOS Developer Community Survey](https://iosdevweekly.typeform.com/to/u7UvzNZh) — iOS Dev Weekly · Issue 492 — Article · Topics: Developer Community & Business
  **Published:** `29th January 2021`
  **NeKI brief:** As of earlier today, this year’s questionnaire is now open for responses, so what are you waiting for? Please spend a few minutes contributing to the 2020 iOS Developer Community Survey. I can’t wait to see how things have changed since last year.
...
- [The Missing Guide for Mac Catalyst Apps](https://www.craft.do/maccatalyst-guide) — iOS Dev Weekly · Issue 482 — Article · Topics: Developer Community & Business
  **Published:** `13th November 2020`
  **NeKI brief:** The guide explains how to approach Mac Catalyst apps and covers practical considerations for adapting an iPad application to macOS.
- [the story at 2m58s in this podcast](https://www.swiftbysundell.com/podcast/75) — iOS Dev Weekly · Issue 480 — Podcast · Topics: Developer Community & Business · Swift
  **Published:** `30th October 2020`
  **NeKI brief:** Examines Dave Verwer and Sven A. Schmidt join John to talk about their newly launched Swift Package Index, and what the overall state of Swift’s package ecosystem currently is. Also, depend. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Introducing Swift on Windows](https://swift.org/blog/swift-on-windows) — iOS Dev Weekly · Issue 475 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `25th September 2020`
  **NeKI brief:** Examines Introducing Swift on Windows, focusing on i’m not sure i can see this becoming more than a curiosity, but if you’re not afraid of a few sharp edges and want to…. Use it as a focused research reference for related Apple-platform work, and verify.
...
- [Hacking with Swift Live](https://www.hackingwithswift.com/live) — iOS Dev Weekly · Issue 455 — Article · Topics: Developer Community & Business · Swift
...
- [how Swift on the server is doing](https://iosdevsurvey.com/2019/how-is-swift-on-the-server-doing) — iOS Dev Weekly · Issue 453 — Article · Topics: Developer Community & Business · Swift
  **Published:** `24th April 2020`
  **NeKI brief:** I’ve been poking around the results from the iOS Developer Community Survey again this week, specifically looking at the questions relating to Swift on the server. I ended up putting together a quick piece on how Swift on the server is doing. I’ll not spoil…
- [Designing App Icons](https://applypixels.com/class/designing-app-icons) — iOS Dev Weekly · Issue 448 — Tutorial · Topics: Developer Community & Business
...
- [being uploaded to YouTube](https://www.youtube.com/playlist?list=PLxpqfOFALZU9IG6DbP3inWOgm3Rzv4ISd) — iOS Dev Weekly · Issue 448 — Video · Topics: Developer Community & Business
  **Published:** `20th March 2020`
  **NeKI brief:** The YouTube playlist provides a publicly readable collection of developer videos and their playlist metadata.
...
- [Apple might typically announce it](https://david-smith.org/wwdc) — iOS Dev Weekly · Issue 446 — Article · Topics: Apple Platform Ecosystem · Developer Community & Business
  **Published:** `6th March 2020`
  **NeKI brief:** In the light of so many tech conferences being postponed, cancelled, or going virtual there’s plenty of speculation about this year’s WWDC, especially as we get close to the date Apple might typically announce it.
- [SwiftUI defaults considered harmful](https://tonsky.me/blog/swiftui) — iOS Dev Weekly · Issue 445 — Article · Topics: Developer Community & Business · Swift · SwiftUI
  **Published:** `28th February 2020`
  **NeKI brief:** Examines SwiftUI defaults considered harmful, offering practical guidance on SwiftUI composition and layout behavior. Apply its examples to compare choices and spot edge cases, then verify historical SDK assumptions before production use.
...
- [2020 iOS Conference Calendar](https://www.alexcurylo.com/2020/01/04/2020-ios-conference-calendar) — iOS Dev Weekly · Issue 438 — Article · Topics: Developer Community & Business
  **Published:** `10th January 2020`
  **NeKI brief:** Examines Mainkan slot online paling gacor hanya di Oktogel! Nikmati RTP tinggi, bonus besar, dan koleksi game slot terbaik dari provider ternama. Daftar dan menang sekarang!. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Vadim Drobinin’s post](https://drobinin.com/posts/what-ive-learned-after-sending-147-proposals-to-36-conferences-in-a-year) — iOS Dev Weekly · Issue 438 — Article · Topics: Developer Community & Business
  **Published:** `10th January 2020`
  **NeKI brief:** Examines This year I sent out quite a few proposals to the majority of mobile conferences in Europe. Some ignored me, the others replied with automated rejections. However, some accepted an. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [iOS Developer Community Survey](https://iosdevweekly.typeform.com/to/NhoqpX) — iOS Dev Weekly · Issue 436 — Article · Topics: Developer Community & Business
  **Published:** `27th December 2019`
  **NeKI brief:** Covers this is your last reminder, focusing on Swift and Apple-platform engineering practice. Use the examples to compare implementation choices, assess edge cases, and plan verification in a production codebase; confirm current SDK support before adopting this historical guidance.
...
- [Server-side Swift conference](https://www.serversideswift.info/2019) — iOS Dev Weekly · Issue 435 — Article · Topics: Developer Community & Business · Graphics, Media & Games · Swift
  **Published:** `20th December 2019`
  **NeKI brief:** After my comment today, it might be the perfect time to dive into learning some server-side Swift. How about doing that with these videos from the Server-side Swift conference.
- [Please take a look, and let me know what you think](https://docs.google.com/document/d/1mrZEkefK_LYPT70U5LBRG25VFZztsub8MDcUu_ixHmI/edit?usp=sharing) — iOS Dev Weekly · Issue 432 — Article · Topics: Developer Community & Business
  **Published:** `29th November 2019`
  **NeKI brief:** To prove that this is truly a community survey, I want the design of it to be as open as the results will be. I’ve put a good amount of work into creating a (very 😬) long list of questions that cover what I think are interesting areas, but I’d love to know…
...
- [recent podcast episode](https://www.swiftbysundell.com/podcast/59) — iOS Dev Weekly · Issue 429 — Podcast · Topics: Developer Community & Business · Swift · SwiftUI
  **Published:** `8th November 2019`
  **NeKI brief:** Provides episode 59 of Swift by Sundell’s podcast with its discussion context and episode metadata. Useful for following the speakers’ reasoning about Swift development practices, while checking any version-sensitive API advice against current sources.
...
- [Let’s Build a Regex Engine](http://kean.github.io/post/lets-build-regex) — iOS Dev Weekly · Issue 423 — Tutorial · Topics: Developer Community & Business · Developer Tools
  **Published:** `27th September 2019`
  **NeKI brief:** Alexander Grebenyuk with a fantastic series of posts on building a Regex engine. Of course, I’m not linking to this because I think you should use the resulting library, but because it’s a fascinating look into how it was built.
- [the resulting library](https://github.com/kean/Regex) — iOS Dev Weekly · Issue 423 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `27th September 2019`
  **NeKI brief:** Examines Open source regex engine. Contribute to kean/Regex development by creating an account on GitHub. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Follow Through](https://inessential.com/2019/08/29/follow_through) — iOS Dev Weekly · Issue 419 — Tutorial · Topics: Developer Community & Business
  **Published:** `30th August 2019`
  **NeKI brief:** Examines inessential: Follow-Through. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [release](https://inessential.com/2019/08/26/netnewswire_5_0_now_available) — iOS Dev Weekly · Issue 419 — Tutorial · Topics: Developer Community & Business
  **Published:** `30th August 2019`
  **NeKI brief:** When you are hurtling towards a release, it can often feel like shipping the binary is the finish line. Of course, it’s just the beginning of a new phase of the app lifecycle, and Brent Simmons is here with some great pointers after the release of…
- [CSAT](https://en.wikipedia.org/wiki/Customer_satisfaction) — iOS Dev Weekly · Issue 418 — Article · Topics: Developer Community & Business
  **Published:** `23rd August 2019`
  **NeKI brief:** But if we felt that our feedback and bug reports were being treated with care and respect, I believe the positive effects in the developer community would be huge. Apple’s CSAT matters to them, what about some DSAT? 😀
...
- [SwiftUIX](https://github.com/SwiftUIX/SwiftUIX) — iOS Dev Weekly · Issue 416 — Source repository · Topics: Developer Community & Business · Swift · SwiftUI
...
- [almost 2 hours to make a decision](https://en.wikipedia.org/wiki/Apple_Worldwide_Developers_Conference) — iOS Dev Weekly · Issue 410 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `28th June 2019`
  **NeKI brief:** Discusses almost 2 hours to make a decision, connecting the concrete app-design or engineering decision to practical considerations for Apple-platform developers.
- [Appsterdam](https://appsterdam.rs/about-us) — iOS Dev Weekly · Issue 410 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `28th June 2019`
  **NeKI brief:** Examines Appsterdam is a volunteer-run, non-profit community which organizes events for App Makers, by App Makers. We provide infrastructure to support the app ecosystem with weekly lecture. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [watch it on YouTube](https://www.youtube.com/watch?v=YALkDLc_DD4) — iOS Dev Weekly · Issue 410 — Video · Topics: Developer Community & Business
  **Published:** `28th June 2019`
  **NeKI brief:** Examines We wrap up ourAltConf coverage from San Jose in a discussion of the foundations and objectives of AltConf…what it has accomplished, and where it goes from he. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [used to run](https://daveverwer.com/blog/saying-goodbye-to-app-review-times) — iOS Dev Weekly · Issue 406 — Podcast · Topics: App Distribution & Store Operations · Developer Community & Business
...
- [100 Days of Swift](https://www.hackingwithswift.com/100) — iOS Dev Weekly · Issue 404 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `17th May 2019`
  **NeKI brief:** I linked to the 100 days of Swift project back in Issue 404, and now Paul Hudson is following it up with a hundred days of SwiftUI. It started a few days ago, but that doesn’t mean you can’t still join in. Become a SwiftUI expert before the new year rings…
...
- [Eliminating Degenerate View Controller States](http://www.vadimbulavin.com/degenerate-view-controller-states) — iOS Dev Weekly · Issue 396 — Tutorial · Topics: Developer Community & Business
  **Published:** `22nd March 2019`
  **NeKI brief:** Examines Learn how to identify and remove degenerate state in your UIViewControllers and UIViews with Swift 5. This allows to significantly simplify your view controllers and views Swift co. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [over 190 community contributions](https://github.com/daveverwer/iOSDevDirectory/pulls?q=is%3Apr+is%3Aclosed) — iOS Dev Weekly · Issue 395 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `15th March 2019`
  **NeKI brief:** I have a favour to ask! A couple of weeks ago I launched the iOS Dev Directory, an attempt to build a comprehensive list of blogs on iOS development. While it certainly had a great launch with over 85 pull requests merged and new sections being added for…
...
- [Minimum Viable Complication](https://mackuba.eu/2019/03/06/watchkit-adventure-2-mvc) — iOS Dev Weekly · Issue 394 — Tutorial · Topics: Developer Community & Business
  **Published:** `8th March 2019`
  **NeKI brief:** What happens when you realise your watchOS app doesn’t actually need much of a UI at all? You build a complication, of course. This is a fantastic article from Kuba Suder with everything you need to know about making an app for a tiny section inside a tiny…
...
- [first episode](https://www.swiftcommunitypodcast.org/episodes/1) — iOS Dev Weekly · Issue 392 — Podcast · Topics: Developer Community & Business · Swift
  **Published:** `22nd February 2019`
  **NeKI brief:** Examines first episode, focusing on if you listened to the first episode of the swift community podcast then you may want to skip this. Use it as a focused research reference for related Apple-platform work, and verify version-specific details against current documentation.
...
- [organise episodes](https://github.com/SwiftCommunityPodcast/podcast/issues) — iOS Dev Weekly · Issue 387 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `18th January 2019`
  **NeKI brief:** A new podcast from John Sundell, Garric Nahapetian and Chris Lattner. The first episode takes a look at the birth of Swift, but the reason it made the news here is that they’re trying something new with the show. Instead of being the same format every week…
- [How to use Static Table View in View Controllers](https://fluffy.es/static-table-view) — iOS Dev Weekly · Issue 381 — Tutorial · Topics: Developer Community & Business
  **Published:** `7th December 2018`
  **NeKI brief:** The page covers “How to use Static Table View in View Controllers” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [O’Reilly Etech 2006](http://conferences.oreillynet.com/etech) — iOS Dev Weekly · Issue 380 — Article · Topics: Developer Community & Business
  **Published:** `30th November 2018`
  **NeKI brief:** I was a fairly late adopter of Apple technology. At the start of 2006, I was a pretty frustrated manager leading a team of ASP.NET developers writing HR software. As part of that job, I headed over to San Diego to attend O’Reilly Etech 2006. It was an…
...
- [MVCTodo](https://github.com/davedelong/MVCTodo) — iOS Dev Weekly · Issue 375 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `26th October 2018`
  **NeKI brief:** Examines A very simple "To Do" app to illustrate the principles from my "A Better MVC" talk - davedelong/MVCTodo. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [“real” Photoshop](https://www.theverge.com/2018/10/15/17969754/adobe-photoshop-apple-ipad-creative-cloud) — iOS Dev Weekly · Issue 374 — Article · Topics: Developer Community & Business · Personal Essays
  **Published:** `19th October 2018`
  **NeKI brief:** The article reports Adobe bringing a full Photoshop experience to the iPad through Creative Cloud.
- [event on the 30th](https://www.theverge.com/2018/10/18/17978622/apple-october-2018-event-ipad-pro-macbook-air-date-announcement) — iOS Dev Weekly · Issue 374 — Article · Topics: Developer Community & Business · Hardware & Devices · Personal Essays
  **Published:** `19th October 2018`
  **NeKI brief:** After this week, it certainly seems possible. As you’ll have already seen, Adobe previewed “real” Photoshop running on an iPad at their Max conference on Monday. Then yesterday Apple announced their (presumably iPad focused) event on the 30th.
...
- [Videos from NSSpain 2018](https://vimeo.com/nsspain) — iOS Dev Weekly · Issue 372 — Video · Topics: Developer Community & Business · Graphics, Media & Games
  **Published:** `5th October 2018`
...
- [Next steps for the Swift Server work group](https://forums.swift.org/t/next-steps-for-the-swift-server-work-group/15816/1) — iOS Dev Weekly · Issue 368 — Article · Topics: Developer Community & Business · Swift
  **Published:** `7th September 2018`
  **NeKI brief:** Examines As announced at try! Swift New York City, the Swift Server work group is now entering a new chapter in its evolution. With the release of SwiftNIO and it’s subsequent adoption by p. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Splash](https://github.com/JohnSundell/Splash) — iOS Dev Weekly · Issue 367 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `31st August 2018`
  **NeKI brief:** Examines A fast, lightweight and flexible Swift syntax highlighter for blogs, tools and fun! - JohnSundell/Splash. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Making Swift.org a more valuable resource for the Swift community](https://forums.swift.org/t/rfc-making-swift-org-a-more-valuable-resource-for-the-swift-community/15303) — iOS Dev Weekly · Issue 365 — Article · Topics: Developer Community & Business · Swift
  **Published:** `17th August 2018`
  **NeKI brief:** Compared to the web sites for many open source projects I’d say Swift.org is well above average, but is it as good as it could be? Apple are asking for feedback on what would make the site more useful. There’s plenty of suggestions already but there’s always…
...
- [Ladybug](https://itunes.apple.com/app/ladybug-handles-radar-links/id1402968134) — iOS Dev Weekly · Issue 361 — Tutorial · Topics: Developer Community & Business
  **Published:** `20th July 2018`
  **NeKI brief:** Discusses Ladybug, connecting the concrete app-design or engineering decision to practical considerations for Apple-platform developers.
- [open source](https://github.com/ethanhuang13/ladybug) — iOS Dev Weekly · Issue 361 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `20th July 2018`
  **NeKI brief:** Presents open source, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
- [Brisk](https://github.com/br1sk/brisk) — iOS Dev Weekly · Issue 361 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `20th July 2018`
...
- [this week’s episode](http://atp.fm/episodes/278) — iOS Dev Weekly · Issue 356 — Tutorial · Topics: Developer Community & Business
  **Published:** `15th June 2018`
  **NeKI brief:** Examines Three nerds discussing tech, Apple, programming, and loosely related matters. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Touch ID and Face ID on iOS](http://michael-brown.net/2018/touch-id-and-face-id-on-ios) — iOS Dev Weekly · Issue 352 — Tutorial · Topics: Developer Community & Business
  **Published:** `18th May 2018`
  **NeKI brief:** Examines Touch ID and Face ID on iOS · Michael Brown. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [demo of Google Duplex](https://www.youtube.com/watch?v=ogfYd705cRs&t=2167) — iOS Dev Weekly · Issue 351 — Video · Topics: Developer Community & Business
  **Published:** `11th May 2018`
  **NeKI brief:** So Google had their I/O conference this week and you almost certainly saw the demo of Google Duplex which has been everwhere since it happened. I don’t want to get into it in too much detail here, but my thoughts can be summed up as follows:
...
- [conference talk](https://www.youtube.com/watch?v=YWVzCd5FYbs) — iOS Dev Weekly · Issue 349 — Video · Topics: Developer Community & Business
  **Published:** `27th April 2018`
  **NeKI brief:** Examines There are many different ways to build your apps, and each approach brings its own set of challenges and pitfalls. Recent years have seen the emergence of pa. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [sweet solution](https://youtu.be/vKKISOnOCaw?t=50) — iOS Dev Weekly · Issue 346 — Video · Topics: Developer Community & Business · Personal Essays
...
- [Ending the Swift Weekly Brief](https://www.jessesquires.com/blog/swift-weekly-brief-hiatus) — iOS Dev Weekly · Issue 333 — Article · Topics: Developer Community & Business · Swift
  **Published:** `5th January 2018`
  **NeKI brief:** Unfortunately, Swift Weekly Brief’s 100th issue is its last, at least until someone else takes over the reins from Jesse Squires. I really enjoyed reading this newsletter, and I’m sad to see such a valuable resource for the community go.
...
- [Awesome Mobile Conferences](https://github.com/amobconf/awesome-mobile-conferences) — iOS Dev Weekly · Issue 323 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `20th October 2017`
  **NeKI brief:** The GitHub repository contains a public database of mobile conferences and related event information.
...
- [Azure](https://azure.microsoft.com/en-gb/services/app-service/mobile) — iOS Dev Weekly · Issue 321 — Tutorial · Topics: Developer Community & Business
  **Published:** `6th October 2017`
...
- [Firebase](https://firebase.google.com/products/realtime-database) — iOS Dev Weekly · Issue 321 — Tutorial · Topics: Developer Community & Business · Persistence & Synchronisation
  **Published:** `6th October 2017`
  **NeKI brief:** Examines Data is synced across all clients in realtime, and remains available when your app goes offline. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [detailed comparison between the two](https://firebase.google.com/docs/firestore/rtdb-vs-firestore) — iOS Dev Weekly · Issue 321 — Tutorial · Topics: Developer Community & Business
  **Published:** `6th October 2017`
  **NeKI brief:** Examines A guide to help you choose between Cloud Firestore and Realtime Database, with a comparison of their features and capabilities. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [going well](https://mixpanel.com/trends) — iOS Dev Weekly · Issue 320 — Tutorial · Topics: Developer Community & Business
  **Published:** `29th September 2017`
  **NeKI brief:** As a developer, I’m also excited about the iOS 11 adoption spike that should come along with the 70 new emoji 🤯. iOS 11 adoption seems just a little behind iOS 10 last year but it’s already at ~64% which is still pretty good! It’s probably still a bit…
- [The Power of Switch Statements in Swift](https://www.swiftbysundell.com/posts/the-power-of-switch-statements-in-swift) — iOS Dev Weekly · Issue 320 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `29th September 2017`
  **NeKI brief:** Examines While switch statements are hardly something that was invented as part of Swift, they are made a lot more powerful when combined with Swift. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [of course](https://www.youtube.com/watch?v=OnB1TgxgwEA) — iOS Dev Weekly · Issue 318 — Video · Topics: Developer Community & Business
  **Published:** `15th September 2017`
  **NeKI brief:** Of course, my views on the notch will settle when I’m using the phone every day (yes, of course I’m going to get one) but from first impressions, I think everything is going to be just fine and I’d even go as far as to say I quite like the “ears” in portrait…
- [Smart Gesture Recognition in iOS 11 with Core ML and TensorFlow](https://hackernoon.com/smart-gesture-recognition-in-ios-11-with-core-ml-and-tensorflow-1a0a92c99c51) — iOS Dev Weekly · Issue 318 — Tutorial · Topics: Developer Community & Business
  **Published:** `15th September 2017`
  **NeKI brief:** The page covers “Smart Gesture Recognition in iOS 11 with Core ML and TensorFlow” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [part 1](https://hackernoon.com/a-new-approach-to-touch-based-mobile-interaction-ba47b14400b0) — iOS Dev Weekly · Issue 318 — Tutorial · Topics: Developer Community & Business
  **Published:** `15th September 2017`
  **NeKI brief:** Discusses part 1, connecting the concrete app-design or engineering decision to practical considerations for Apple-platform developers.
- [Task-based concurrency manifesto draft for Swift](https://gist.github.com/lattner/31ed37682ef1576b16bca1432ea9f782) — iOS Dev Weekly · Issue 315 — Source repository · Topics: Concurrency · Developer Community & Business · Swift
...
- [async/await proposal](https://gist.github.com/lattner/429b9070918248274f25b714dcfc7619) — iOS Dev Weekly · Issue 315 — Source repository · Topics: Concurrency · Developer Community & Business · Developer Tools
  **Published:** `25th August 2017`
...
- [statement](https://512pixels.net/2017/07/rip-ipod-nano-shuffle) — iOS Dev Weekly · Issue 312 — Tutorial · Topics: Developer Community & Business
  **Published:** `4th August 2017`
  **NeKI brief:** A commentary on Apple's retirement of the iPod nano and shuffle as the lineup narrowed to iPod touch models. Read it for Apple product-history context rather than development advice.
- [Add payments to your point of sale app with Square’s API](https://docs.connect.squareup.com/articles/point-of-sale-api-overview) — iOS Dev Weekly · Issue 311 — Article · Topics: Developer Community & Business
  **Published:** `28th July 2017`
  **NeKI brief:** Examines The Point of Sale API lets mobile applications open the Square Point of Sale application to process in-person payments using Square hardware. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Cracking the code behind Apple’s App Store promo card design](http://blog.equinux.com/2017/07/cracking-the-code-behind-apples-app-store-promo-card-design) — iOS Dev Weekly · Issue 311 — Article · Topics: App Distribution & Store Operations · Developer Community & Business · Graphics, Media & Games
  **Published:** `28th July 2017`
  **NeKI brief:** A wonderful set of videos from the ADD conference which was held last month in the beautiful city of Barcelona.
- [A favorite hack](http://david-smith.org/blog/2017/07/07/a-favorite-hack) — iOS Dev Weekly · Issue 310 — Podcast · Topics: Developer Community & Business
  **Published:** `21st July 2017`
  **NeKI brief:** The article describes a favorite software hack and explains the practical behavior that makes the technique useful.
- [The Future of Teaching With Swift Playgrounds](http://martiancraft.com/blog/2017/07/future-of-teaching-with-swift-playgrounds) — iOS Dev Weekly · Issue 308 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `7th July 2017`
  **NeKI brief:** Education has always been a top priority for Apple and of course it continues today with iPad and the Swift Playgrounds app. Alex Repty takes a look at the current state, and the future of Swift on the iPad and shows what a promising future it has. On the…
- [always been a top priority](http://www.npr.org/2011/10/09/141186979/computers-in-class-another-legacy-of-steve-jobs) — iOS Dev Weekly · Issue 308 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `7th July 2017`
  **NeKI brief:** Education has always been a top priority for Apple and of course it continues today with iPad and the Swift Playgrounds app. Alex Repty takes a look at the current state, and the future of Swift on the iPad and shows what a promising future it has. On the…
...
- [Macaw](https://github.com/exyte/macaw) — iOS Dev Weekly · Issue 290 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `3rd March 2017`
  **NeKI brief:** Examines Powerful and easy-to-use vector graphics Swift library with SVG support - exyte/Macaw. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Swift Hashable](http://useyourloaf.com/blog/swift-hashable) — iOS Dev Weekly · Issue 288 — Tutorial · Topics: Developer Community & Business · Swift
...
- [this](http://atp.fm/episodes/205) — iOS Dev Weekly · Issue 284 — Podcast · Topics: Developer Community & Business
...
- [Amazon Lex](https://aws.amazon.com/lex) — iOS Dev Weekly · Issue 279 — Article · Topics: Developer Community & Business
  **Published:** `2nd December 2016`
  **NeKI brief:** Examines Amazon Lex, focusing on loads of announcements from amazon this week as they held their re-invent conference. Use it as a focused research reference for related Apple-platform work, and verify version-specific details against current documentation.
- [AWS iOS SDK](https://github.com/aws/aws-sdk-ios/tree/master/AWSLex) — iOS Dev Weekly · Issue 279 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `2nd December 2016`
  **NeKI brief:** The page covers “AWS iOS SDK” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [StatefulViewController](https://github.com/aschuch/StatefulViewController) — iOS Dev Weekly · Issue 279 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `2nd December 2016`
  **NeKI brief:** The page covers “StatefulViewController” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [Structs and NSCoding](http://khanlou.com/2016/10/structs-and-nscoding) — iOS Dev Weekly · Issue 274 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `28th October 2016`
  **NeKI brief:** The article explains using Swift structs with NSCoding and discusses practical serialization considerations for iOS code.
...
- [Getting Started with Mobile Analytics](https://www.raywenderlich.com/138939/getting-started-mobile-analytics) — iOS Dev Weekly · Issue 273 — Tutorial · Topics: Developer Community & Business · Personal Essays
  **Published:** `21st October 2016`
  **NeKI brief:** Kishin Manglani with an article on implementing analytics inside your app. Of course getting the basics up and running with any of the analytics providers is a 5 minute job, but is that enough? I liked the approach here of using real world examples of where…
...
- [I am an Indie Dev](http://gabrielhauber.net/devBlog/2016/09/14/indie-dev-part-3) — iOS Dev Weekly · Issue 269 — Tutorial · Topics: Developer Community & Business
  **Published:** `23rd September 2016`
  **NeKI brief:** An interesting, and very personal post from Gabriel Hauber about his journey as an independent developer. It’s an interesting story of course but also includes some good data about experimenting with revenue models and pricing.
- [Copying](http://robnapier.net/copying) — iOS Dev Weekly · Issue 267 — Tutorial · Topics: Developer Community & Business
  **Published:** `9th September 2016`
  **NeKI brief:** Uses an experience from try! Swift to reflect on small acts of generosity, community behavior, and the assumptions developers bring to shared spaces. Useful as a human and community perspective around technical events, not as API guidance.
- [iOS Developer Podcasts](https://github.com/vermont42/Podcasts) — iOS Dev Weekly · Issue 262 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `5th August 2016`
  **NeKI brief:** Examines A list of podcasts of interest to iOS developers and other habitués of the Apple ecosystem. - vermont42/Podcasts. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [FileKit: Simple and expressive file management in Swift](https://github.com/Dschee/FileKit) — iOS Dev Weekly · Issue 259 — Source repository · Topics: Developer Career & Practice · Developer Community & Business · Swift
  **Published:** `15th July 2016`
  **NeKI brief:** Examines Simple and expressive file management in Swift. Contribute to Jeehut/FileKit development by creating an account on GitHub. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Guilty of Being Stupid](https://releasenotes.tv/165-guilty-of-being-stupid-part-1) — iOS Dev Weekly · Issue 259 — Podcast · Topics: Developer Community & Business
  **Published:** `15th July 2016`
  **NeKI brief:** Examines #165: Guilty of Being Stupid (part 1) | Release Notes. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Release Notes podcast](https://releasenotes.tv/aboutthepodcast) — iOS Dev Weekly · Issue 259 — Podcast · Topics: Developer Community & Business
  **Published:** `15th July 2016`
  **NeKI brief:** Examines About the Podcast | Release Notes. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Iconic: Auto-generated icon font library for iOS](https://github.com/dzenbot/Iconic) — iOS Dev Weekly · Issue 257 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `1st July 2016`
  **NeKI brief:** The GitHub repository contains Iconic, an open-source library for generating icon fonts for iOS applications.
...
- [been implemented](https://github.com/apple/swift-evolution/blob/master/README.md) — iOS Dev Weekly · Issue 251 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
...
- [Packing Bytes in Swift](http://www.russbishop.net/packing-bytes-in-swift) — iOS Dev Weekly · Issue 250 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `13th May 2016`
  **NeKI brief:** The page covers “Packing Bytes in Swift” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [Designing an Alternative to the Hamburger Menu](http://scottjensen.design/2016/04/designing-an-alternative-to-the-hamburger-menu) — iOS Dev Weekly · Issue 247 — Tutorial · Topics: Developer Community & Business
  **Published:** `22nd April 2016`
  **NeKI brief:** Explores alternatives to the hamburger menu for mobile navigation. Follow it for concrete information-architecture and discoverability trade-offs, while adapting patterns to current platform guidance.
...
- [pull request](https://github.com/apple/swift/pull/1442) — iOS Dev Weekly · Issue 245 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `8th April 2016`
...
- [Swift Weekly Brief](https://swiftweekly.github.io/issue-13) — iOS Dev Weekly · Issue 242 — Tutorial · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `18th March 2016`
  **NeKI brief:** Examines Welcome to issue #13 of the weekly brief! This week Apple released beta 6 of iOS 9.3, watchOS 2.2, and OS X 10.11.4, with no new beta for Xcode 7.3 — the final release should be ge. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Accepted!](https://github.com/apple/swift-evolution/blob/master/proposals/0007-remove-c-style-for-loops.md) — iOS Dev Weekly · Issue 229 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `18th December 2015`
  **NeKI brief:** The page covers “Accepted!” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [warning in 2.2](https://bugs.swift.org/browse/SR-226) — iOS Dev Weekly · Issue 229 — Article · Topics: Developer Community & Business · Swift
  **Published:** `18th December 2015`
  **NeKI brief:** Just two weeks in and already the first Swift Evolution proposal from the community has been accepted. Erica Sadun proposed the removal of C style for loops from the language, and it’s been accepted! They will become a warning in 2.2 and an error in 3.0. I…
- [error in 3.0](https://bugs.swift.org/browse/SR-227) — iOS Dev Weekly · Issue 229 — Article · Topics: Developer Community & Business · Swift
  **Published:** `18th December 2015`
  **NeKI brief:** Explains error in 3.0, focusing on the concrete iOS or Swift implementation technique and the trade-offs relevant to production applications.
...
- [discussion of plans and features for future releases](https://github.com/apple/swift-evolution) — iOS Dev Weekly · Issue 227 — Source repository · Topics: Developer Community & Business · Developer Tools · Swift
  **Published:** `4th December 2015`
  **NeKI brief:** The page covers “discussion of plans and features for future releases” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [full source code is included](https://github.com/FlexMonkey/3D-ReTouch) — iOS Dev Weekly · Issue 221 — Source repository · Topics: Developer Community & Business · Developer Tools
  **Published:** `23rd October 2015`
  **NeKI brief:** Simon Gladman is back again this week with more 3D Touch experiments. This time it’s an experimental UI for retouching photos using pressure to vary the intensity of whatever retouch effect you’re currently applying. Of course, full source code is included…
- [Push / Pop modal SFSafariViewController (Hacking swipe from edge gesture)](http://www.stringcode.co.uk/push-pop-modal-sfsafariviewcontroller-hacking-swipe-from-edge-gesture) — iOS Dev Weekly · Issue 220 — Tutorial · Topics: Developer Community & Business
  **Published:** `16th October 2015`
  **NeKI brief:** The long winter of our discontent over Tweetbot’s implementation of Safari view controller ended this week and we can once again use a swipe gesture to dismiss it. Of course, this means that we lose the internal implementation back/forward, but it feels much…
- [ended this week](https://www.macstories.net/linked/tweetbot-4-0-2-lets-you-swipe-safari-view-controller-away) — iOS Dev Weekly · Issue 220 — Tutorial · Topics: Developer Community & Business
  **Published:** `16th October 2015`
  **NeKI brief:** The MacStories link reports on Tweetbot 4.0.2 adding the ability to swipe away Safari View Controller, a concrete iOS interaction change.
...
- [How to symbolicate watchOS 2 extension crash logs from device](http://aplus.rs/2015/how-to-symbolicate-watchos-2-extension-crash-logs-from-device) — iOS Dev Weekly · Issue 210 — Tutorial · Topics: Developer Community & Business
  **Published:** `7th August 2015`
  **NeKI brief:** Examines How to symbolicate watchOS 2 extension crash logs from device · aplus.rs. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [watchOS 2.0](http://www.sneakycrab.com/blog/2015/6/8/watchos-20-tldr) — iOS Dev Weekly · Issue 202 — Article · Topics: Developer Community & Business
  **Published:** `12th June 2015`
  **NeKI brief:** Examines watchOS 2.0 tl;dr — Sneaky Crab. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [before the conference](http://techcrunch.com/2015/05/27/apples-jeff-williams-says-native-watch-sdk-will-give-direct-access-to-sensors) — iOS Dev Weekly · Issue 202 — Article · Topics: Developer Community & Business
  **Published:** `12th June 2015`
  **NeKI brief:** So as we knew before the conference, the native watch SDK is now available in beta. The good news is that it’s not going to be a huge change to get your apps transferred across as the basic structure is the same, it just runs on the device now. But what else…
...
- [podcast on RadioLab](http://www.radiolab.org/story/trust-engineers) — iOS Dev Weekly · Issue 200 — Podcast · Topics: Developer Community & Business
  **Published:** `29th May 2015`
  **NeKI brief:** Examines How a tiny group of social engineers are making our online relationships kindler and gentler—whether we like it or not. . Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [A Week in the Life of Indie Developers](http://www.macstories.net/stories/a-week-in-the-life-of-indie-developers) — iOS Dev Weekly · Issue 188 — Podcast · Topics: Developer Community & Business
  **Published:** `6th March 2015`
  **NeKI brief:** Graham Spencer talks with several independent developers about what they do on a day to day basis. On a similar subject, Mike Hurley’s Inquisitive Podcast has been really great recently with a series (1, 2, 3) of episodes interviewing developers on life and…
- [Inquisitive Podcast](http://www.relay.fm/inquisitive) — iOS Dev Weekly · Issue 188 — Podcast · Topics: Developer Community & Business
  **Published:** `6th March 2015`
  **NeKI brief:** The page covers “Inquisitive Podcast” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [1](http://www.relay.fm/inquisitive/27) — iOS Dev Weekly · Issue 188 — Podcast · Topics: Developer Community & Business
  **Published:** `6th March 2015`
  **NeKI brief:** Provides episode 27 of the Inquisitive podcast and its discussion context. Useful as a route to the speakers’ reasoning and examples, while treating the recording as supplementary material rather than a precise technical reference.
- [2](http://www.relay.fm/inquisitive/28) — iOS Dev Weekly · Issue 188 — Podcast · Topics: Developer Community & Business
  **Published:** `6th March 2015`
  **NeKI brief:** Graham Spencer talks with several independent developers about what they do on a day to day basis. On a similar subject, Mike Hurley’s Inquisitive Podcast has been really great recently with a series (1, 2, 3) of episodes interviewing developers on life and…
- [3](http://www.relay.fm/inquisitive/29) — iOS Dev Weekly · Issue 188 — Podcast · Topics: Developer Community & Business
  **Published:** `6th March 2015`
  **NeKI brief:** The Relay FM episode page provides a publicly readable Inquisitive podcast episode with its topic description and show information.
- [Year in Review](http://blog.desk.pm/2014-yir) — iOS Dev Weekly · Issue 185 — Article · Topics: Developer Community & Business
  **Published:** `13th February 2015`
  **NeKI brief:** Great post by John Saddington about his sponsorship of Daring Fireball for his app, Desk. I won’t spoil the answer to the question here, but once you’re done with it his Year in Review post is also worth a look.
...
- [Top 10 iOS Conferences in 2015](http://www.raywenderlich.com/93886/top-10-ios-conferences-in-2015) — iOS Dev Weekly · Issue 182 — Article · Topics: Developer Community & Business
  **Published:** `23rd January 2015`
  **NeKI brief:** Examines Check out the top 10 iOS conferences in 2015 – WWDC, 360iDev, CocoaConf, NSConference, iOSDevUK, and more!. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Lanyrd iOS conference list](http://lanyrd.com/topics/ios) — iOS Dev Weekly · Issue 182 — Article · Topics: Developer Community & Business
  **Published:** `23rd January 2015`
  **NeKI brief:** Explains Lanyrd iOS conference list, focusing on the concrete iOS implementation technique and the trade-offs relevant to production applications.
...
- [A great app for recording podcasts](http://www.allenpike.com/2014/podcast-recording) — iOS Dev Weekly · Issue 175 — Podcast · Topics: Developer Community & Business
  **Published:** `5th December 2014`
  **NeKI brief:** Examines I evaluate building an app. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [few](http://www.sicpers.info/2014/09/apples-watch-and-jonys-compelling-beginning) — iOS Dev Weekly · Issue 163 — Tutorial · Topics: Developer Community & Business
  **Published:** `12th September 2014`
  **NeKI brief:** Examines So of course we got the new iPhone, and yes the “wearable” turned out to be a watch. The big surprise of the event to me was Pay. Huge news! As for the watch? I’ve tried but I just can’t get excited about it, not becaus Useful for understanding the concrete implementation trade-offs in this Apple-platform topic before applying the technique to a production codebase.
...
- [language guide](https://itunes.apple.com/us/book/swift-programming-language/id881256329?mt=11) — iOS Dev Weekly · Issue 149 — Tutorial · Topics: Developer Community & Business · Swift
  **Published:** `6th June 2014`
  **NeKI brief:** Explains language guide with a concrete Apple-platform development perspective and examples. Use it to understand the linked technique, workflow, or design trade-off, then verify API availability and assumptions against current SDK documentation because this is a historical iOS Dev Weekly reference.
...
- [Castro’s playback scrubber](http://subjc.com/castro-playback-scrubber) — iOS Dev Weekly · Issue 136 — Podcast · Topics: Developer Community & Business
  **Published:** `7th March 2014`
  **NeKI brief:** Another wonderful article from Sam Page digging into the details, and then reimplementing a specific UI element in an iOS app. This time he takes on the audio scrubber from Castro (which is absolutely the best podcast player on iOS). My guess would be that…
...
- [iOS Community Growing Pains](http://ashfurrow.com/blog/ios-community-growing-pains) — iOS Dev Weekly · Issue 128 — Article · Topics: Developer Community & Business
  **Published:** `10th January 2014`
  **NeKI brief:** Examines I read a really interesting article this morning about developing for iOS 7 and beyond. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Stanford Developing Apps for iPhone & iPad on Piazza](https://piazza.com/coding-together) — iOS Dev Weekly · Issue 78 — Tutorial · Topics: Developer Community & Business · Personal Essays
  **Published:** `25th January 2013`
  **NeKI brief:** Examines Piazza is a free online gathering place where students can ask, answer, and explore 24/7, under the guidance of their instructors. Students as well as instructors can answer questi. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [iOS conferences and events in 2013](http://lanyrd.com/topics/ios/2013) — iOS Dev Weekly · Issue 75 — Article · Topics: Developer Community & Business
  **Published:** `4th January 2013`
  **NeKI brief:** Explains iOS conferences and events in 2013, focusing on the concrete iOS implementation technique and the trade-offs relevant to production applications.
...
- [Debug Podcast](http://www.imore.com/debug-2-paul-haddad-tapbots) — iOS Dev Weekly · Issue 70 — Podcast · Topics: Developer Community & Business
  **Published:** `30th November 2012`
  **NeKI brief:** Explains Debug Podcast with a concrete Apple-platform development perspective and examples. Use it to understand the linked technique, workflow, or design trade-off, then verify API availability and assumptions against current SDK documentation because this is a historical iOS Dev Weekly reference.
...
- [Skeuomorphism is the easy way out](http://blog.wells.ee/skeuomorphism) — iOS Dev Weekly · Issue 58 — Tutorial · Topics: Developer Community & Business
  **Published:** `7th September 2012`
  **NeKI brief:** The historical skeuomorphism article now lands on the author’s general blog rather than the original post. Useful only as a documented redirect and design-history lead, not as a verified standalone treatment of skeuomorphism.
...
- [How people use tablets and what it means for the future of news](http://www.journalism.org/analysis_report/tablet) — iOS Dev Weekly · Issue 13 — Article · Topics: Developer Community & Business
  **Published:** `28th October 2011`
  **NeKI brief:** Interesting stats from journalism.org looking at tablet usage in the US for news content. Given that recent stats showed that the iPad was responsible for 97% of US tablet sales this must mean that ~11% of the US population owns an iPad, that’s impressive.
...
- [The shareware history](https://go.peterfriese.dev/the-shareware-history?s=newsletter&t=ext) — Not only Swift · Issue 97 — Article · Topics: AI Development · Developer Community & Business · Swift
  **NeKI brief:** Traces the history and economics of shareware software distribution. It provides product and indie-development context for thinking about pricing, licensing, and sustainable utility apps.
...
- [Tips on making effective tech presentations](https://www.rwapp.co.uk/blog/speaking) — Not only Swift · Issue 85 — Article · Topics: Developer Community & Business · Personal Essays
  **NeKI brief:** This article presents practical advice for making technical presentations effective, including shaping the explanation around the audience and communicating complex engineering material clearly. It is useful for developers who need to share implementation decisions, demos, or architecture with a technical audience.
...
- [Tune in](https://youtu.be/ha9fzJEJDvk) — Not only Swift · Issue 82 — Video · Topics: Developer Community & Business
  **NeKI brief:** This livestream discusses Swift error messages and the ErrorKit library. It provides a concrete developer walkthrough of improving error presentation and diagnosis in Swift applications through a focused library-based approach.
- [Swift WTF – Surprising behaviors while learning Swift](https://www.youtube.com/watch?v=dQJUoNIbDsg) — Not only Swift · Issue 82 — Video · Topics: Developer Community & Business · Swift
  **NeKI brief:** This Swift WTF session explains a surprising Swift behavior that is easy to encounter while learning or maintaining Swift code. The recording is useful for understanding the language rule behind the behavior and the practical correction developers should apply.
