...
- [The importance of human touch in AI-driven development – Donny Wals](https://www.donnywals.com/the-importance-of-human-touch-in-ai-driven-development) — Donny Wals · article catalogue
...
- [Staying productive as an indie developer – Donny Wals](https://www.donnywals.com/staying-productive-as-an-indie-developer) — Donny Wals · article catalogue
...
- [Impress at Job Interviews by Inspecting their App Bundle](https://blog.jacobstechtavern.com/p/impress-at-job-interviews-by-decompiling) — Jacob’s Tech Tavern · newsletter edition
...
- [Using iOS 18’s new TabView with a sidebar – Donny Wals](https://www.donnywals.com/using-ios-18s-new-tabview-with-a-sidebar) — Donny Wals · article catalogue
...
- [Tips and tricks for exploring a new codebase – Donny Wals](https://www.donnywals.com/tips-and-tricks-for-exploring-a-new-codebase) — Donny Wals · article catalogue
...
- [Mobile is actually pretty hard.](https://blog.jacobstechtavern.com/p/mobile-is-actually-pretty-hard) — Jacob’s Tech Tavern · newsletter edition
...
- [Finding the difference between two Arrays – Donny Wals](https://www.donnywals.com/finding-the-difference-between-two-arrays) — Donny Wals · article catalogue
...
- [Presentation Nerves | Dave DeLong](https://davedelong.com/blog/2018/04/23/presentation-nerves) — Dave DeLong · article catalogue
...
- [On variable naming when teaching – Donny Wals](https://www.donnywals.com/on-variable-naming-when-teaching) — Donny Wals · article catalogue
...
- [How to choose between rem and em – Donny Wals](https://www.donnywals.com/how-to-choose-between-rem-and-em) — Donny Wals · article catalogue
...
- [How I improved my workflow with Imagemagick – Donny Wals](https://www.donnywals.com/how-i-improved-my-workflow-with-imagemagick) — Donny Wals · article catalogue
...
- [Thoughts On Ethics & AI](https://martiancraft.com/blog/2023/04/thoughts-on-ai) — MartianCraft · article catalogue
  **NeKI brief:** The AI ethics discussion focuses on responsibility, user impact, and decision boundaries rather than treating generated output as autonomous truth. Follow it when designing reviewable AI-assisted product workflows.
...
- [Technical Interview Protips](https://martiancraft.com/blog/2018/05/technical-interview-protips) — MartianCraft · article catalogue
  **NeKI brief:** Technical interview advice emphasizes making reasoning and trade-offs observable rather than reciting API trivia. Follow it for a concrete way to evaluate debugging communication alongside implementation skill.
- [How to get started developing iOS apps](https://martiancraft.com/blog/2017/10/starting-iOS) — MartianCraft · article catalogue
  **NeKI brief:** The iOS getting-started route connects Swift fundamentals, Xcode project structure, and platform conventions into a first workflow. It is useful for orienting newcomers without hiding the simulator, signing, and review lifecycle.
...
- [Tips for being a better developer](https://martiancraft.com/blog/2016/08/better-developer) — MartianCraft · article catalogue
...
- [Working for the man — Chris Eidhof](https://chris.eidhof.nl/post/working-for-the-man) — Chris Eidhof · article catalogue
...
- [Why I want to become rich — Chris Eidhof](https://chris.eidhof.nl/post/why-i-want-to-become-rich) — Chris Eidhof · article catalogue
...
- [Trust your geeks — Chris Eidhof](https://chris.eidhof.nl/post/trust-your-geeks) — Chris Eidhof · article catalogue
...
- [Survivorship bias — Chris Eidhof](https://chris.eidhof.nl/post/survivorship-bias) — Chris Eidhof · article catalogue
...
- [Status Update — Chris Eidhof](https://chris.eidhof.nl/post/status-update) — Chris Eidhof · article catalogue
...
- [Starting new projects — Chris Eidhof](https://chris.eidhof.nl/post/starting-new-projects) — Chris Eidhof · article catalogue
...
- [Start of Week 2 — Chris Eidhof](https://chris.eidhof.nl/post/start-of-week-2) — Chris Eidhof · article catalogue
...
- [Speaking Up — Chris Eidhof](https://chris.eidhof.nl/post/speaking-up) — Chris Eidhof · article catalogue
...
- [Rotation fun — Chris Eidhof](https://chris.eidhof.nl/post/rotation-fun) — Chris Eidhof · article catalogue
...
- [RIP Steve Jobs — Chris Eidhof](https://chris.eidhof.nl/post/rip-steve-jobs) — Chris Eidhof · article catalogue
...
- [Reaching a plateau — Chris Eidhof](https://chris.eidhof.nl/post/reaching-a-plateau) — Chris Eidhof · article catalogue
...
- [30 day experiment: no more sugar — Chris Eidhof](https://chris.eidhof.nl/post/no-more-sugar) — Chris Eidhof · article catalogue
...
- [New Things — Chris Eidhof](https://chris.eidhof.nl/post/new-things) — Chris Eidhof · article catalogue
...
- [Implementing Value Objects in Objective C — Chris Eidhof](https://chris.eidhof.nl/post/implementing-value-objects-in-objective-c) — Chris Eidhof · article catalogue
...
- [I Use This — Chris Eidhof](https://chris.eidhof.nl/post/i-use-this) — Chris Eidhof · article catalogue
...
- [HTML5 is no silver bullet for apps — Chris Eidhof](https://chris.eidhof.nl/post/html5-is-no-silver-bullet-for-apps) — Chris Eidhof · article catalogue
...
- [How to succeed as a freelance developer — Chris Eidhof](https://chris.eidhof.nl/post/how-to-succeed-as-a-freelance-developer) — Chris Eidhof · article catalogue
...
- [How to keep your classes small and clean — Chris Eidhof](https://chris.eidhof.nl/post/how-to-keep-your-classes-small-and-clean) — Chris Eidhof · article catalogue
...
- [Behind the scenes — Chris Eidhof](https://chris.eidhof.nl/post/how-i-write-for-objcio) — Chris Eidhof · article catalogue
...
- [How I got a burnout — Chris Eidhof](https://chris.eidhof.nl/post/how-i-got-a-burnout) — Chris Eidhof · article catalogue
...
- [How I dealt with a burnout — Chris Eidhof](https://chris.eidhof.nl/post/how-i-dealt-with-a-burnout) — Chris Eidhof · article catalogue
...
- [How a burnout changed my life — Chris Eidhof](https://chris.eidhof.nl/post/how-a-burnout-changed-my-life) — Chris Eidhof · article catalogue
...
- [Hard Decisions — Chris Eidhof](https://chris.eidhof.nl/post/hard-decisions) — Chris Eidhof · article catalogue
...
- [Freeform blogging — Chris Eidhof](https://chris.eidhof.nl/post/freeform-blogging) — Chris Eidhof · article catalogue
...
- [Fast Running — Chris Eidhof](https://chris.eidhof.nl/post/fast-running) — Chris Eidhof · article catalogue
...
- [Entitled — Chris Eidhof](https://chris.eidhof.nl/post/entitled) — Chris Eidhof · article catalogue
...
- [Communicate Often — Chris Eidhof](https://chris.eidhof.nl/post/communicate-often) — Chris Eidhof · article catalogue
...
- [Changing Tech Education — Chris Eidhof](https://chris.eidhof.nl/post/changing-tech-education) — Chris Eidhof · article catalogue
...
- [Burnout: five years later — Chris Eidhof](https://chris.eidhof.nl/post/burnout-five-years-later) — Chris Eidhof · article catalogue
...
- [On Burnout — Chris Eidhof](https://chris.eidhof.nl/post/burnout) — Chris Eidhof · article catalogue
...
- [Book Review: Start Small, Stay Small — Chris Eidhof](https://chris.eidhof.nl/post/book-review-start-small-stay-small) — Chris Eidhof · article catalogue
...
- [A month of blogging — Chris Eidhof](https://chris.eidhof.nl/post/a-month-of-blogging) — Chris Eidhof · article catalogue
...
- [2025 — Chris Eidhof](https://chris.eidhof.nl/post/2025) — Chris Eidhof · article catalogue
...
- [2024 in Review — Chris Eidhof](https://chris.eidhof.nl/post/2024-review) — Chris Eidhof · article catalogue
...
- [Weeknotes № 52 — Chris Eidhof](https://chris.eidhof.nl/post/2024-52) — Chris Eidhof · article catalogue
...
- [Weeknotes № 51 — Chris Eidhof](https://chris.eidhof.nl/post/2024-51) — Chris Eidhof · article catalogue
...
- [Weeknotes № 49 — Chris Eidhof](https://chris.eidhof.nl/post/2024-49) — Chris Eidhof · article catalogue
...
- [Weeknotes № 48 — Chris Eidhof](https://chris.eidhof.nl/post/2024-48) — Chris Eidhof · article catalogue
...
- [Weeknotes № 41 — Chris Eidhof](https://chris.eidhof.nl/post/2024-40) — Chris Eidhof · article catalogue
...
- [Weeknotes № 39 — Chris Eidhof](https://chris.eidhof.nl/post/2024-38) — Chris Eidhof · article catalogue
...
- [Weeknotes № 38 — Chris Eidhof](https://chris.eidhof.nl/post/2024-37) — Chris Eidhof · article catalogue
...
- [Weeknotes № 48 — Chris Eidhof](https://chris.eidhof.nl/post/2023-48) — Chris Eidhof · article catalogue
...
- [Weeknotes № 45 — Chris Eidhof](https://chris.eidhof.nl/post/2023-45) — Chris Eidhof · article catalogue
...
- [Weeknotes № 44 — Chris Eidhof](https://chris.eidhof.nl/post/2023-44) — Chris Eidhof · article catalogue
...
- [Weeknotes № 42 — Chris Eidhof](https://chris.eidhof.nl/post/2023-42) — Chris Eidhof · article catalogue
...
- [Weeknotes № 40 — Chris Eidhof](https://chris.eidhof.nl/post/2023-40) — Chris Eidhof · article catalogue
...
- [Weeknotes № 28 — Chris Eidhof](https://chris.eidhof.nl/post/2023-28) — Chris Eidhof · article catalogue
...
- [Weeknotes № 20 — Chris Eidhof](https://chris.eidhof.nl/post/2023-20) — Chris Eidhof · article catalogue
...
- [Weeknotes № 18 — Chris Eidhof](https://chris.eidhof.nl/post/2023-18) — Chris Eidhof · article catalogue
...
- [Weeknotes № 17 — Chris Eidhof](https://chris.eidhof.nl/post/2023-17) — Chris Eidhof · article catalogue
...
- [Weeknotes № 15 — Chris Eidhof](https://chris.eidhof.nl/post/2023-15) — Chris Eidhof · article catalogue
...
- [Weeknotes № 13 — Chris Eidhof](https://chris.eidhof.nl/post/2023-13) — Chris Eidhof · article catalogue
...
- [Weeknotes № 7 — Chris Eidhof](https://chris.eidhof.nl/post/2023-07) — Chris Eidhof · article catalogue
...
- [Weeknotes № 3 — Chris Eidhof](https://chris.eidhof.nl/post/2023-03) — Chris Eidhof · article catalogue
...
- [2019 — Chris Eidhof](https://chris.eidhof.nl/post/2019) — Chris Eidhof · article catalogue
...
- [Apple Sues OpenAI Over Trade Secrets](https://mjtsai.com/blog/2026/07/13/apple-sues-openai-over-trade-secrets) — iOS Dev Weekly · Issue 759 — Article · Topics: AI Development · Developer Career & Practice
  **Published:** `17th July 2026`
  **NeKI brief:** Examines Michael Tsai - Blog - Apple Sues OpenAI Over Trade Secrets. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [iOS 27: Notable UIKit Additions](https://www.swiftjectivec.com/ios-27-notable-uikit-additions) — Those Who Swift · Issue 270 — Article · Topics: Developer Career & Practice · Swift · UIKit
...
- [I Couldn’t Find The Perfect Browser, So I Built One With AI In Two Weeks](https://www.swiftdifferently.com/blog/career-advice/how-I-built-full-browser-in-two-weeks) — Those Who Swift · Issue 264 — Article · Topics: AI Development · Developer Career & Practice · Swift
...
- [Senior Software Engineer - Mobile @ Hatch](https://job-boards.greenhouse.io/hatchcareers/jobs/4639069006) — iOS Dev Weekly · Issue 744 — Article · Topics: Developer Career & Practice
  **Published:** `27th February 2026`
  **NeKI brief:** The page covers “Senior Software Engineer - Mobile @ Hatch” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [re-use more than 100k lines of code between platforms](https://web.dev/case-studies/goodnotes) — iOS Dev Weekly · Issue 742 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `6th February 2026`
  **NeKI brief:** First up, Yuta Saito told me how Goodnotes has built their whole tech stack on Wasm, enabling them to re-use more than 100k lines of code between platforms. They are even hiring for a couple of roles (1, 2), if you’re interested in using Swift and Wasm…
- [1](https://job-boards.greenhouse.io/goodnotes/jobs/5762785004) — iOS Dev Weekly · Issue 742 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `6th February 2026`
  **NeKI brief:** First up, Yuta Saito told me how Goodnotes has built their whole tech stack on Wasm, enabling them to re-use more than 100k lines of code between platforms. They are even hiring for a couple of roles (1, 2), if you’re interested in using Swift and Wasm…
- [2](https://job-boards.greenhouse.io/goodnotes/jobs/5689829004) — iOS Dev Weekly · Issue 742 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `6th February 2026`
  **NeKI brief:** First up, Yuta Saito told me how Goodnotes has built their whole tech stack on Wasm, enabling them to re-use more than 100k lines of code between platforms. They are even hiring for a couple of roles (1, 2), if you’re interested in using Swift and Wasm…
...
- [Ten Years of Being an Indie Developer](https://ikennd.ac/blog/2025/10/ten-years-of-being-indie) — Those Who Swift · Issue 238 — Article · Topics: Developer Career & Practice · Personal Essays
...
- [SwiftLeeds – Questions & Answers](https://danielsaidi.com/blog/2025/10/11/swiftleeds-questions-and-answers) — Those Who Swift · Issue 236 — Article · Topics: Developer Career & Practice · Swift
...
- [Swift Configuration - Unified Configuration Management](https://l.fatbobman.com/w0105-07) — Fatbobman’s Swift Weekly · Issue 105 — Article · Topics: Developer Career & Practice · Swift
...
- [Runway’s 2025 Mobile Release Survey](https://www.runway.team/whitepapers/2025-state-of-mobile-release-management-report) — iOS Dev Weekly · Issue 715 — Article · Topics: Developer Career & Practice
...
- [What's the cost of not prioritizing mobile release management?](https://www.runway.team/webinar/the-roi-of-mobile-release-management) — SwiftLee Weekly · Issue 269 — Article · Topics: Developer Career & Practice
...
- [Things](https://culturedcode.com/things) — Fatbobman’s Swift Weekly · Issue 72 — Article · Topics: Developer Career & Practice · Swift
...
- [The 7 Habits of Highly Effective People by Stephen Covey](https://amzn.to/46uww4e) — SwiftLee Weekly · Issue 258 — Article · Topics: Developer Career & Practice · Swift
...
- [Task Management in Swift: A 3-Part Series](https://junebash.bearblog.dev/task-management-in-swift-part-1-the-problem) — Those Who Swift · Issue 199 — Article · Topics: Developer Career & Practice · Developer Tools · Swift
...
- [Introduction to Non-Copyable types in Swift](https://www.youtube.com/watch?v=ydbcczlMEkA) — Those Who Swift · Issue 198 — Video · Topics: Developer Career & Practice · Swift
...
- [Pinwheel](https://bjango.com/mac/pinwheel) — iOS Dev Weekly · Issue 693 — Article · Topics: Developer Career & Practice
  **Published:** `3rd January 2025`
  **NeKI brief:** I meant to link to this new tool from Bjango last year, but I wanted to have a proper go with it first. I managed to spend some time with it and I can say that what might at first glance seem like a straightforward colour management tool is much more than…
...
- [Mackup](https://github.com/lra/mackup) — iOS Dev Tools · iOS Dev Tools: KVKCalendar, PLCrashReporter, Mackup — Source repository · Topics: Developer Career & Practice · Developer Tools
...
- [R.swift](https://github.com/mac-cain13/R.swift) — iOS Dev Tools · iOS Dev Tools: R.swift, Alamofire, SwiftFormat — Source repository · Topics: Developer Career & Practice · Developer Tools · Swift
...
- [Worried about losing Microsoft App Center?](https://bitrise.io/platform/devops/release-management) — iOS Dev Weekly · Issue 668 — Article · Topics: Developer Career & Practice
  **Published:** `5th July 2024`
  **NeKI brief:** The Bitrise page describes release-management workflows for mobile applications and positions the service as an alternative development platform.
...
- [The power of DevOps for device management, now available for iOS devices](https://www.vpdae.com/redirect/ectb14txzzz5x9v1q2gy9tgphm8) — iOS Dev Tools · iOS Dev tools: EditKit, Copilot for Xcode, PhoneNumberKit — Article · Topics: Developer Career & Practice
...
- [Singularity achieved](https://www.monkeyuser.com/2023/deprecated) — iOS Dev Weekly · Issue 628 — Article · Topics: Developer Career & Practice
  ...
  **NeKI brief:** Are you hiring? I say it every week, but don’t forget that you can post jobs for free to iOS Dev Jobs!
...
- [this thread on the Swift Forums](https://forums.swift.org/t/announcing-atoms-a-new-state-management-library/64702) — iOS Dev Weekly · Issue 608 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `5th May 2023`
  **NeKI brief:** The page covers “this thread on the Swift Forums” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
...
- [Build Native Apps Used by Millions at WillowTree](https://www.willowtreeapps.com/careers?gh_src=934929f32us) — iOS Dev Weekly · Issue 559 — Article · Topics: Developer Career & Practice
  **Published:** `20th May 2022`
  **NeKI brief:** Examines TELUS Digital Jobs Website. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Weak self, a story about memory management and closure](https://benoitpasquier.com/weak-self-story-memory-management-closure-swift) — iOS Dev Weekly · Issue 553 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `8th April 2022`
  **NeKI brief:** Explains Weak self, a story about memory management and closure, focusing on the concrete iOS or Swift implementation technique and the trade-offs relevant to production applications.
...
- [Steve Jobs Stories](https://youtu.be/5YRn41OnfPE?t=132) — iOS Dev Weekly · Issue 497 — Video · Topics: Developer Career & Practice
  **Published:** `5th March 2021`
  **NeKI brief:** Links to a timestamped Steve Jobs story segment. Useful as audiovisual historical context, while treating the recording as supplementary rather than technical authority.
- [California](https://www.arun.is/blog/apple-watch-faces) — iOS Dev Weekly · Issue 492 — Article · Topics: Developer Career & Practice
  **Published:** `29th January 2021`
  **NeKI brief:** Examines Did you know that several Apple Watch faces are digital reinterpretations of iconic real-life watches? Their design reflects a respect for history and a spirit of innovation. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [What’s New in KeyboardKit for iOS 14?](https://douglashill.co/whats-new-in-keyboardkit-for-ios-14) — iOS Dev Weekly · Issue 477 — Article · Topics: Developer Career & Practice · Hardware & Devices
  **Published:** `9th October 2020`
  **NeKI brief:** Details KeyboardKit’s Swift Package Manager support and its UIKit sidebar and list work for iOS 14. Useful when integrating a custom keyboard framework while evaluating package support and collection-view architecture.
- [Never miss a terminal bell again](https://www.youtube.com/watch?v=uG8VpN6Z_YA) — iOS Dev Weekly · Issue 475 — Video · Topics: Developer Career & Practice · Developer Tools
  **Published:** `25th September 2020`
  **NeKI brief:** Examines With the Analog Terminal Bell, you'll never miss another terminal bell notification again! Go to analogterminalbell.com for more information. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Memory Management in Swift: Heaps & Stacks](https://heartbeat.fritz.ai/memory-management-in-swift-heaps-stacks-baa755abe16a) — iOS Dev Weekly · Issue 407 — Article · Topics: AI Development · Developer Career & Practice · Swift
  **Published:** `7th June 2019`
  **NeKI brief:** Yes yes, there’s lots of exciting new things to learn this week, but that doesn’t mean we shouldn’t also take care of the basics! I really liked this article from Sarin Swift on memory management in Swift. Even if Swift abstracts a lot of this stuff, it’s…
...
- [The Downsides of Freelancing](https://www.vanschneider.com/the-downsides-of-freelancing) — iOS Dev Weekly · Issue 393 — Article · Topics: Developer Career & Practice
  **Published:** `1st March 2019`
  **NeKI brief:** Examines You can find plenty of positive things online about being your own boss, and we all know someone who says going freelance was the best decision they've ever made. With this ar. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Early returning functions in Swift](https://www.swiftbysundell.com/posts/early-returning-functions-in-swift) — iOS Dev Weekly · Issue 368 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `7th September 2018`
  **NeKI brief:** Explores Early returning functions in Swift in an Apple-platform development context, highlighting practical techniques, design decisions, or trade-offs. Use it as historical community guidance, then validate implementation details, security considerations, and current SDK behavior before applying it.
...
- [The visual project management tool built for iOS Developers](http://go.thoughtleaders.io/79120180420) — iOS Dev Weekly · Issue 348 — Article · Topics: Developer Career & Practice
  **Published:** `20th April 2018`
  **NeKI brief:** This landing page promotes a visual project-management tool for iOS developers. Follow it only for workflow and product context; its promotional material is not implementation guidance.
- [iOS Developer at MartianCraft (Remote)](http://martiancraft.com/careers) — iOS Dev Weekly · Issue 341 — Article · Topics: Developer Career & Practice
  **Published:** `2nd March 2018`
  **NeKI brief:** This MartianCraft page advertises a remote iOS developer position. It is recruitment material rather than technical reading and should normally be excluded from the knowledge index.
- [App Camp for Girls empowers youth to develop careers in technology](http://appcamp4girls.com/contribute) — iOS Dev Weekly · Issue 332 — Article · Topics: Developer Career & Practice
  **Published:** `22nd December 2017`
  **NeKI brief:** Examines Just another WordPress site. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Depicting Colors Correctly Across All Devices](https://bjango.com/articles/colourmanagementgamut) — iOS Dev Weekly · Issue 326 — Article · Topics: Developer Career & Practice
  **Published:** `10th November 2017`
  **NeKI brief:** Even after building Chameleon and explored everything from RGB and HSB to CIELAB color spaces, I never gave color management much thought. However, with the release of the iPhone X and newer devices with wider gamuts, it’ll soon be impossible to continue to…
- [Bold and innovative iOS Developer wanted @ youSee/TDC Group in Copenhagen](https://tdc.csod.com/ats/careersite/jobdetails.aspx?site=2&c=tdc&id=3086) — iOS Dev Weekly · Issue 313 — Article · Topics: Developer Career & Practice
  **Published:** `11th August 2017`
  **NeKI brief:** Denmark’s biggest TV streaming app needs new blood and highly ambitious developers.
- [What Your Career Wants to Be](http://www.allenpike.com/2017/what-your-career-wants-to-be) — iOS Dev Weekly · Issue 308 — Article · Topics: Developer Career & Practice
  **Published:** `7th July 2017`
  **NeKI brief:** Examines We learn Bluetooth, and it works. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [A Swift iOS SDK for Mobile Image Management](http://cloudinary.com/blog/cloudinary_s_ios_sdk_makes_a_swift_move_for_mobile_image_management) — iOS Dev Weekly · Issue 302 — Article · Topics: Developer Career & Practice · Swift
  **Published:** `26th May 2017`
  **NeKI brief:** Profiles A Swift iOS SDK for Mobile Image Management, a developer tool or product relevant to Apple-platform workflows. Evaluate its integration surface, operational costs, privacy implications, and fit for the current project, then verify supported SDKs and capabilities before adoption.
- [The Average Mac Developer 👨🏻‍💻](https://www.git-tower.com/blog/average-developer-on-the-mac) — iOS Dev Weekly · Issue 301 — Article · Topics: Developer Career & Practice · Developer Tools
  **Published:** `19th May 2017`
  **NeKI brief:** Examines Over 7,000 web and software developers on the Mac took part in our survey - and helped us paint a picture of the "Average Developer on the Mac". Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Interviewing, applying and getting your first job in iOS](http://artsy.github.io/blog/2016/01/30/iOS-Junior-Interviews) — iOS Dev Weekly · Issue 236 — Article · Topics: Developer Career & Practice · Developer Tools
  **Published:** `5th February 2016`
  **NeKI brief:** Examines When I was at the beginning of my career, my first developer job application was to a design agency who were doing Mac development too. It was pret. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Senior iOS Engineer at ServiceNow - San Diego, CA](http://hire.jobvite.com/CompanyJobs/Careers.aspx?nl=1&k=Job&j=oHZB1fw2&s=iOSDevWeekly) — iOS Dev Weekly · Issue 214 — Article · Topics: Developer Career & Practice
  **Published:** `4th September 2015`
  **NeKI brief:** Award winning Mobile team championing the iOS development platform
