...
- [My Toddler Still Loves Planes, So I Upgraded Her Radar](https://blog.jacobstechtavern.com/p/my-toddler-still-loves-planes-so) — Jacob’s Tech Tavern · newsletter edition
...
- [My First App | Dave DeLong](https://davedelong.com/blog/2022/08/31/my-first-app) — Dave DeLong · article catalogue
...
- [The Missing Accessory | Dave DeLong](https://davedelong.com/blog/2020/06/15/the-missing-accessory) — Dave DeLong · article catalogue
...
- [Anything worth doing… | Dave DeLong](https://davedelong.com/blog/2020/06/14/anything-worth-doing) — Dave DeLong · article catalogue
...
- [Animating Explicit Changes · objc.io](https://www.objc.io/blog/2019/09/17/animating-explicit-changes) — objc.io · article catalogue
  **Published:** `2019-9-17`
...
- [Via Alpina — Chris Eidhof](https://chris.eidhof.nl/post/via-alpina) — Chris Eidhof · article catalogue
...
- [Traveling alone — Chris Eidhof](https://chris.eidhof.nl/post/traveling-alone) — Chris Eidhof · article catalogue
...
- [Race Report: Rotterdam Marathon — Chris Eidhof](https://chris.eidhof.nl/post/race-report-rotterdam-harzquerung) — Chris Eidhof · article catalogue
...
- [Race Report: Munich Marathon — Chris Eidhof](https://chris.eidhof.nl/post/race-report-munich-marathon) — Chris Eidhof · article catalogue
...
- [Race Report: Berlin Marathon — Chris Eidhof](https://chris.eidhof.nl/post/race-report-berlin-marathon) — Chris Eidhof · article catalogue
...
- [One app in four weeks: kickoff — Chris Eidhof](https://chris.eidhof.nl/post/one-app-in-four-weeks-kickoff) — Chris Eidhof · article catalogue
...
- [On Running — Chris Eidhof](https://chris.eidhof.nl/post/on-running) — Chris Eidhof · article catalogue
...
- [On Breakups — Chris Eidhof](https://chris.eidhof.nl/post/on-breakups) — Chris Eidhof · article catalogue
...
- [On Berlin — Chris Eidhof](https://chris.eidhof.nl/post/on-berlin) — Chris Eidhof · article catalogue
...
- [Good coffeeshops in Berlin — Chris Eidhof](https://chris.eidhof.nl/post/good-coffeeshops-in-berlin) — Chris Eidhof · article catalogue
...
- [Weeknotes № 50 — Chris Eidhof](https://chris.eidhof.nl/post/2024-50) — Chris Eidhof · article catalogue
...
- [Weeknotes № 46 — Chris Eidhof](https://chris.eidhof.nl/post/2024-46) — Chris Eidhof · article catalogue
...
- [Weeknotes № 41 — Chris Eidhof](https://chris.eidhof.nl/post/2024-41) — Chris Eidhof · article catalogue
...
- [Weeknotes № 2 — Chris Eidhof](https://chris.eidhof.nl/post/2024-02) — Chris Eidhof · article catalogue
...
- [Weeknotes № 1 — Chris Eidhof](https://chris.eidhof.nl/post/2024-01) — Chris Eidhof · article catalogue
...
- [Weeknotes № 41 — Chris Eidhof](https://chris.eidhof.nl/post/2023-41) — Chris Eidhof · article catalogue
...
- [10 iPhone apps for backpackers — Chris Eidhof](https://chris.eidhof.nl/post/10-iphone-apps-for-backpackers) — Chris Eidhof · article catalogue
...
- [Introducing Cursor 2.0 and Composer](https://cursor.com/blog/2-0) — Those Who Swift · Issue 239 — Article · Topics: Personal Essays
...
- [OpenHands](https://github.com/All-Hands-AI/OpenHands) — Those Who Swift · Issue 196 — Source repository · Topics: AI Development · Developer Tools · Personal Essays
...
- [Reminder: Apple Watches use 32 bit pointers](https://jeffverkoeyen.com/blog/2024/10/02/arm64_32-PSA) — iOS Dev Weekly · Issue 681 — Article · Topics: Personal Essays · Swift · SwiftUI
  **Published:** `4th October 2024`
  **NeKI brief:** Presents reminder: apple watches use 32 bit pointers for Apple-platform developers, highlighting the implementation approach and practical trade-offs. Use it as a focused starting point, then verify APIs, versions, and operational constraints against your project and current documentation.
...
- [Reminder: Conditional Breakpoints are Slow](https://twocentstudios.com/2024/08/08/conditional-breakpoints) — iOS Dev Weekly · Issue 673 — Article · Topics: Personal Essays
  **Published:** `9th August 2024`
  **NeKI brief:** Explains Reminder: Conditional Breakpoints are Slow, focusing on the concrete iOS or Swift implementation technique and the trade-offs relevant to production applications.
...
- [run Swift on a Raspberry Pi Pico](https://forums.swift.org/t/embedded-swift-running-on-the-raspberry-pi-pico/69001) — iOS Dev Weekly · Issue 651 — Article · Topics: Personal Essays · Swift
  **Published:** `8th March 2024`
  **NeKI brief:** Discusses running embedded Swift on the Raspberry Pi Pico, including toolchain and platform constraints. Useful for exploring Swift beyond Apple operating systems and for separating language capability from target-runtime support.
...
- [getting started](https://www.swift.org/getting-started) — iOS Dev Weekly · Issue 634 — Article · Topics: Personal Essays · Swift
  **Published:** `3rd November 2023`
  **NeKI brief:** You might have noticed a couple of changes to the Swift website recently. First, a long-running project from the Swift Website Workgroup¹ went live with a significant content update. The old home page introduction paragraph is gone, replaced with code…
...
- [Swift on the server](https://www.swift.org/server) — iOS Dev Weekly · Issue 634 — Article · Topics: Personal Essays · Swift
  **Published:** `3rd November 2023`
  **NeKI brief:** You might have noticed a couple of changes to the Swift website recently. First, a long-running project from the Swift Website Workgroup¹ went live with a significant content update. The old home page introduction paragraph is gone, replaced with code…
- [many more improvements](https://github.com/apple/swift-org-website/pull/354) — iOS Dev Weekly · Issue 634 — Source repository · Topics: Developer Tools · Personal Essays · Swift
  **Published:** `3rd November 2023`
  **NeKI brief:** The Swift.org website pull request records proposed improvements to the public Swift website and its implementation.
...
- [What’s new in RxSwift 6?](https://dev.to/freak4pc/what-s-new-in-rxswift-6-2nog) — iOS Dev Weekly · Issue 491 — Article · Topics: Personal Essays · Swift
  **Published:** `22nd January 2021`
  **NeKI brief:** Covers What's new in RxSwift 6?, focusing on Swift and Apple-platform engineering practice. Use the examples to compare implementation choices, assess edge cases, and plan verification in a production codebase; confirm current SDK support before adopting this historical guidance.
- [a post on running SwiftWasm inside a Swift app](http://www.alwaysrightinstitute.com//swifty-wasmer) — iOS Dev Weekly · Issue 490 — Article · Topics: Personal Essays · Swift
  **Published:** `15th January 2021`
  **NeKI brief:** Examines Today we are going to embed and run WebAssembly (Wasm) modules in a Swift program. Using Wasmer, an embeddable runtime for Wasm, wrapped in a simple Swift API. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Implementing multi-user support in tvOS 14](https://nemecek.be/blog/52/implementing-multi-user-support-in-tvos-14) — iOS Dev Weekly · Issue 479 — Article · Topics: Personal Essays
  **Published:** `23rd October 2020`
  **NeKI brief:** Presents Implementing multi-user support in tvOS 14, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
...
- [X-SwiftFormat](https://github.com/ruiaureliano/X-SwiftFormat) — iOS Dev Weekly · Issue 450 — Source repository · Topics: Developer Tools · Swift · Xcode
...
- [SwiftLint](https://github.com/realm/SwiftLint) — iOS Dev Weekly · Issue 431 — Source repository · Topics: Developer Tools · Personal Essays · Swift
...
- [SourceKit-LSP](https://github.com/apple/sourcekit-lsp) — iOS Dev Weekly · Issue 379 — Source repository · Topics: Developer Tools · Personal Essays
  **Published:** `23rd November 2018`
  **NeKI brief:** Examines Here we go! SourceKit-LSP can now power code completion, quick help and a few other features in Visual Studio Code! Mattt walks us through the steps needed to get everything up and running. I tried this and it worked rea Useful for understanding the concrete implementation trade-offs in this Apple-platform topic before applying the technique to a production codebase.
- [Killing the Slopes Pass](https://blog.curtisherbert.com/slopes-diaries-26-killing-the-slopes-pass) — iOS Dev Weekly · Issue 378 — Article · Topics: Personal Essays
  **Published:** `16th November 2018`
  **NeKI brief:** The Slopes diary entry explains the decision to remove or change the Slopes Pass and records the product-engineering reasoning.
...
- [How GDPR Will Change The Way You Develop](https://www.smashingmagazine.com/2018/02/gdpr-for-web-developers) — iOS Dev Weekly · Issue 341 — Article · Topics: Personal Essays
  **Published:** `2nd March 2018`
  **NeKI brief:** I haven’t linked to anything on GDPR yet but it has the potential to affect every one of us as developers (yes, even if you don’t live in the EU) and time is running out. I came across this article by Heather Burns this week and it’s a great, in-depth guide…
- [GDPR](https://ico.org.uk/for-organisations/guide-to-the-general-data-protection-regulation-gdpr) — iOS Dev Weekly · Issue 341 — Article · Topics: Personal Essays
  **Published:** `2nd March 2018`
  **NeKI brief:** I haven’t linked to anything on GDPR yet but it has the potential to affect every one of us as developers (yes, even if you don’t live in the EU) and time is running out. I came across this article by Heather Burns this week and it’s a great, in-depth guide…
...
- [An Illustrated History of iOS](https://www.git-tower.com/blog/history-of-ios) — iOS Dev Weekly · Issue 297 — Article · Topics: Developer Tools · Personal Essays
  **Published:** `21st April 2017`
  **NeKI brief:** Examines The iPhone was one of the most exciting new products of this millenia. But as amazing as the device may be, the real superstar is the software that drives it! Take a seat and enjoy. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Future iOS update will shut the door on apps from the dawn of the smartphone](https://arstechnica.com/apple/2017/01/future-ios-release-will-soon-end-support-for-unmaintained-32-bit-apps) — iOS Dev Weekly · Issue 286 — Article · Topics: Personal Essays
  **Published:** `3rd February 2017`
  **NeKI brief:** Examines Apple is on track to complete its 32-to-64-bit transition in just four years. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Introducing IBAnalyzer](http://holko.pl/2017/01/31/ibanalyzer) — iOS Dev Weekly · Issue 286 — Article · Topics: Personal Essays
  **Published:** `3rd February 2017`
  **NeKI brief:** Explores Introducing IBAnalyzer in an Apple-platform development context, highlighting practical techniques, design decisions, or trade-offs. Use it as historical community guidance, then validate implementation details, security considerations, and current SDK behavior before applying it.
...
- [Vapor](https://github.com/vapor/vapor) — iOS Dev Weekly · Issue 275 — Source repository · Topics: Developer Tools · Personal Essays · Swift
  **Published:** `4th November 2016`
...
- [The A5 is dead (almost)](http://www.jessesquires.com/the-a5-is-dead) — iOS Dev Weekly · Issue 255 — Article · Topics: Personal Essays
  **Published:** `17th June 2016`
  **NeKI brief:** The iPad 2 and friends have had an incredible run, but it’s coming to an end. This is really great news as it’s been painful to keep everything running smoothly on that device, even for Apple… Have you tried iOS 9 on an iPad 2 recently? It’s not great 😀
...
- [Parse Server Goes Realtime With Live Queries](http://blog.parse.com/announcements/parse-server-goes-realtime-with-live-queries) — iOS Dev Weekly · Issue 243 — Article · Topics: Personal Essays
  **Published:** `25th March 2016`
  **NeKI brief:** When Parse announced its shutdown, I think the view was that Parse Server was a nice move, but that it was more of a “keep things running” solution than something that would see active development. Apparently not! Live queries are a significant new feature…
- [Crashlytics Velocity Alerts](https://www.crashlytics.com/blog/introducing-velocity-alerts) — iOS Dev Weekly · Issue 243 — Article · Topics: Personal Essays
  **Published:** `25th March 2016`
  **NeKI brief:** Not all crashes are created equal. There’s a huge difference between something that crashes your app on one device for one user, and something that’s causing pain to half of your customers. If you’re running an app with a large user base, this is going to…
...
- [xctool](https://github.com/facebook/xctool) — iOS Dev Weekly · Issue 238 — Source repository · Topics: Developer Tools · Personal Essays · Testing
  **Published:** `19th February 2016`
...
- [Hello Server Side Swift](https://medium.com/@LogMaestro/server-side-swift-c965b7ebe6e7) — iOS Dev Weekly · Issue 238 — Article · Topics: Personal Essays · Swift
  **Published:** `19th February 2016`
  **NeKI brief:** Explains Hello Server Side Swift with a concrete Apple-platform development perspective and examples. Use it to understand the linked technique, workflow, or design trade-off, then verify API availability and assumptions against current SDK documentation because this is a historical iOS Dev Weekly reference.
...
- [Is it too early for me to start a pay-per-click campaign?](https://signalvnoise.com/posts/3899-is-it-too-early-for-me-to-start-a-pay-per-click-campaign) — iOS Dev Weekly · Issue 210 — Article · Topics: Personal Essays
  **Published:** `7th August 2015`
  **NeKI brief:** Examines A Redditor asks: My SaaS product is done. We have a customer who we reached out to locally. I’ve got a freelance writer (via Reddit!) who is working on creating an email cour. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
...
- [Lessons Learned from Running an iOS Consultancy](http://www.raywenderlich.com/84368/lessons-learned-running-ios-consultancy) — iOS Dev Weekly · Issue 176 — Article · Topics: Personal Essays
  **Published:** `12th December 2014`
  **NeKI brief:** Kyle Richter with a two part article about running a successful iOS agency. There’s a load of great advice in here and some interesting stories too. It’s in two parts so don’t forget to read the second post as well.
- [read the second post](http://www.raywenderlich.com/86929/lessons-learned-running-ios-consultancy-part-2) — iOS Dev Weekly · Issue 176 — Article · Topics: Personal Essays
  **Published:** `12th December 2014`
  **NeKI brief:** Kyle Richter with a two part article about running a successful iOS agency. There’s a load of great advice in here and some interesting stories too. It’s in two parts so don’t forget to read the second post as well.
...
- [Major iBeacon Improvement in iOS 7.1](http://beekn.net/2014/03/apple-ios-7-1-launches-major-ibeacon-improvement) — iOS Dev Weekly · Issue 137 — Article · Topics: Personal Essays
  **Published:** `14th March 2014`
  **NeKI brief:** Explains Major iBeacon Improvement in iOS 7.1, focusing on the concrete UIKit or iOS implementation technique and the trade-offs relevant to production apps.
...
- [Going beyond iOS 7’s pretty face](http://in.tapstream.com/iosdev-jul5) — iOS Dev Weekly · Issue 101 — Article · Topics: Personal Essays
  **Published:** `5th July 2013`
  **NeKI brief:** Examines Tapstream - App Marketing Cloud. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Strategies, Tips, and Tricks for Sometimes Connected Apps](http://vimeo.com/66986079) — iOS Dev Weekly · Issue 97 — Video · Topics: Personal Essays
  **Published:** `7th June 2013`
  **NeKI brief:** The video presents strategies and implementation tips for building applications that sometimes operate without a network connection.
- [Early iPhone Prototype Photos](http://arstechnica.com/apple/2013/03/exclusive-super-early-iphone-prototype-had-5x7-screen-serial-port) — iOS Dev Weekly · Issue 85 — Article · Topics: Personal Essays
  **Published:** `15th March 2013`
  **NeKI brief:** Examines What did the iPhone look like before it looked like an iPhone?. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [iOS Apps: Disable the Sleep Timer for Long-Running Tasks](http://oleb.net/blog/2013/02/ios-apps-disable-sleep-timer-long-running-tasks) — iOS Dev Weekly · Issue 80 — Article · Topics: Personal Essays
