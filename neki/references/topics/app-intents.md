...
- [Siri Shortcuts Tutorial in iOS 12 | Kodeco](https://www.kodeco.com/6462-siri-shortcuts-tutorial-in-ios-12) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [SiriKit Tutorial for iOS | Kodeco](https://www.kodeco.com/600-sirikit-tutorial-for-ios) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Speech Recognition Tutorial for iOS | Kodeco](https://www.kodeco.com/573-speech-recognition-tutorial-for-ios) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 10: Handling Interactions with SiriKit | Kodeco](https://www.kodeco.com/4998-ios-10-handling-interactions-with-sirikit) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 10: Creating a SiriKit UI Extension | Kodeco](https://www.kodeco.com/4987-ios-10-creating-a-sirikit-ui-extension) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 10: SiriKit Resolution & Confirmation | Kodeco](https://www.kodeco.com/4986-ios-10-sirikit-resolution-confirmation) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 10: Creating a SiriKit Extension | Kodeco](https://www.kodeco.com/4984-ios-10-creating-a-sirikit-extension) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Interactive Widgets With SwiftUI | Kodeco](https://www.kodeco.com/43771410-interactive-widgets-with-swiftui) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introducing iOS 9 Search APIs | Kodeco](https://www.kodeco.com/3357-introducing-ios-9-search-apis) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Building an iOS App like Siri | Kodeco](https://www.kodeco.com/2422-building-an-ios-app-like-siri) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [How to Make a Narrated Book Using AVSpeechSynthesizer in iOS 7 | Kodeco](https://www.kodeco.com/2411-how-to-make-a-narrated-book-using-avspeechsynthesizer-in-ios-7) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [SwiftUI Charts for WidgetKit | Kodeco](https://www.kodeco.com/20591515-swiftui-charts-for-widgetkit) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 9 App Search Tutorial: Introduction to App Search | Kodeco](https://www.kodeco.com/1544-ios-9-app-search-tutorial-introduction-to-app-search) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS 27, Your App, and Siri | Swiftjective-C](https://swiftjectivec.com/Siri-AI-for-iOS027) — Swiftjective-C · article catalogue
...
- [Create an Interactive Snippet Shortcut using App Intents | Swiftjective-C](https://swiftjectivec.com/Create-Interactive-Snippet-Shortcut-in-AppIntents) — Swiftjective-C · article catalogue
...
- [Open Intent in iOS 26 | Swiftjective-C](https://swiftjectivec.com/Open-Intent-Additions-iOS26-In-AppIntents) — Swiftjective-C · article catalogue
...
- [Core Spotlight integration for Spotlight and internal app search](https://nilcoalescing.com/blog/CoreSpotlightIntegration) — Nil Coalescing · article catalogue
...
- [Donate content to Spotlight and open it using NSUserActivity](https://www.createwithswift.com/donate-content-to-spotlight-and-open-it-using-nsuseractivity) — Create with Swift · article catalogue
  **Published:** `2025-06-10T13:03:58.000Z`
...
- [Integrating App Intents with Control Action](https://www.createwithswift.com/integrating-app-intents-with-control-action) — Create with Swift · article catalogue
  **Published:** `2025-05-29T13:00:24.000Z`
...
- [The re-emergence of sound interfaces with Siri and Artificial Intelligence](https://www.createwithswift.com/the-re-emergence-of-sound-interfaces-with-siri-and-artificial-intelligence) — Create with Swift · article catalogue
  **Published:** `2025-05-22T13:14:23.000Z`
...
- [Customizing an App Intent](https://www.createwithswift.com/customizing-an-app-intent) — Create with Swift · article catalogue
  **Published:** `2025-05-13T13:00:15.000Z`
...
- [Creating an Intent using AppIntent and AppEnum protocols](https://www.createwithswift.com/creating-an-intent-using-appintent-and-appenum-protocols) — Create with Swift · article catalogue
  **Published:** `2025-05-06T13:02:34.000Z`
...
- [Make your app content show on Spotlight](https://www.createwithswift.com/make-your-app-content-show-on-spotlight) — Create with Swift · article catalogue
  **Published:** `2025-04-11T13:03:01.000Z`
...
- [Integrating the Search Intent using Assistant Schemas](https://www.createwithswift.com/integrating-the-search-intent-using-assistant-schemas) — Create with Swift · article catalogue
...
- [Performing your app actions with Siri through App Shortcuts Provider](https://www.createwithswift.com/performing-your-app-actions-with-siri-through-app-shortcuts-provider) — Create with Swift · article catalogue
  **Published:** `2025-03-18T14:00:04.000Z`
...
- [Using App Intents in a SwiftUI app](https://www.createwithswift.com/using-app-intents-swiftui-app) — Create with Swift · article catalogue
  **Published:** `2024-06-04T13:45:38.000Z`
...
- [Creating an interactive widget with SwiftUI](https://www.createwithswift.com/creating-interactive-widget-swiftui) — Create with Swift · article catalogue
  **Published:** `2024-05-28T13:12:14.000Z`
...
- [Getting Started With App Intents](https://useyourloaf.com/blog/getting-started-with-app-intents) — Use Your Loaf · article catalogue
...
- [Create an Interactive Widget Using App Intents | Swiftjective-C](https://swiftjectivec.com/Snip-Create-A-Basic-Interactive-Widget-Using-App-Intent-Button) — Swiftjective-C · article catalogue
...
- [Create a Basic Shortcut using App Intents | Swiftjective-C](https://swiftjectivec.com/Snip-Create-A-Basic-App-Intent) — Swiftjective-C · article catalogue
...
- [Mastering Dynamic Island in SwiftUI | Swift with Majid](https://swiftwithmajid.com/2022/09/28/mastering-dynamic-island-in-swiftui) — Swift with Majid · article catalogue
...
- [Implementing iOS Notes' Document Scanning Feature with Apple's Official API](https://fatbobman.com/en/posts/docscaner) — Fatbobman · article catalogue
...
- [Creating a Siri Shortcut | Swiftjective-C](https://swiftjectivec.com/Create-A-Siri-Shortcut) — Swiftjective-C · article catalogue
...
- [Spotlight Search using NSUserActivity | Swiftjective-C](https://swiftjectivec.com/Spotlight-Search-User-Activity) — Swiftjective-C · article catalogue
...
- [Spotlight search using Core Spotlight | Swiftjective-C](https://swiftjectivec.com/Spotlight-Search-Core-Spotlight) — Swiftjective-C · article catalogue
  **Published:** `2021-01-01T00:00:00-06:00`
...
- [Showing Maps in Widgets](https://useyourloaf.com/blog/showing-maps-in-widgets) — Use Your Loaf · article catalogue
...
- [WidgetKit for iOS - Getting Started](https://useyourloaf.com/blog/widgetkit-for-ios-getting-started) — Use Your Loaf · article catalogue
...
- [NSUserActivity with SwiftUI - The SwiftUI Lab](https://swiftui-lab.com/nsuseractivity-with-swiftui) — SwiftUI Lab · article catalogue
  **Published:** `2020-09-10T13:21:23+00:00`
...
- [Adding your app’s content to Spotlight – Donny Wals](https://www.donnywals.com/adding-your-apps-content-to-spotlight) — Donny Wals · article catalogue
...
- [if let: How not to use it | Sarunw](https://sarunw.com/posts/if-let-how-not-to-use-it) — Sarunw · article catalogue
...
- [Privacy Settings in iOS 10](https://useyourloaf.com/blog/privacy-settings-in-ios-10) — Use Your Loaf · article catalogue
...
- [Edit distance and edit steps | Dave DeLong](https://davedelong.com/blog/2015/12/01/edit-distance-and-edit-steps) — Dave DeLong · article catalogue
...
- [iOS 5 apple event](https://useyourloaf.com/blog/ios-5-apple-event) — Use Your Loaf · article catalogue
...
- [No Code, All Keys](https://detailspro.app/blog/no-code-all-keys-designing-swiftui-faster-with-your-keyboard) — iOS Dev Weekly · Issue 584 — Article · Topics: App Intents & System Surfaces · Hardware & Devices · Swift
...
- [App Search API Validation Tool](https://search.developer.apple.com/appsearch-validation-tool) — iOS Dev Weekly · Issue 214 — Article · Topics: App Intents & System Surfaces · Objective-C & Cocoa
