...
- [Introduction to Google Cardboard for iOS | Kodeco](https://www.kodeco.com/992-introduction-to-google-cardboard-for-ios) — Kodeco / Ray Wenderlich archive · article catalogue
...
- [Beginning ARKit | Kodeco](https://www.kodeco.com/737368-beginning-arkit) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Building a Museum App with ARKit 2 | Kodeco](https://www.kodeco.com/6957-building-a-museum-app-with-arkit-2) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Building a Portal App in ARKit: Materials and Lighting | Kodeco](https://www.kodeco.com/5524-building-a-portal-app-in-arkit-materials-and-lighting) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Building a Portal App in ARKit: Getting Started | Kodeco](https://www.kodeco.com/5516-building-a-portal-app-in-arkit-getting-started) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introducing ARKit by Tutorials! | Kodeco](https://www.kodeco.com/5405-introducing-arkit-by-tutorials) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [RWDevCon 2018 Vault Free Tutorial Session: Getting Started with ARKit | Kodeco](https://www.kodeco.com/5216-rwdevcon-2018-vault-free-tutorial-session-getting-started-with-arkit) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introduction to ARKit: Error Management | Kodeco](https://www.kodeco.com/5033-introduction-to-arkit-error-management) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introduction to ARKit: Measuring Distances | Kodeco](https://www.kodeco.com/5032-introduction-to-arkit-measuring-distances) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introduction to ARKit: Getting Started | Kodeco](https://www.kodeco.com/5031-introduction-to-arkit-getting-started) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Introduction to ARKit: Adding 3D Models | Kodeco](https://www.kodeco.com/5030-introduction-to-arkit-adding-3d-models) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Augmented Reality and ARKit Tutorial | Kodeco](https://www.kodeco.com/378-augmented-reality-and-arkit-tutorial) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Why I Love ARKit for Apple iOS 11 | Kodeco](https://www.kodeco.com/374-why-i-love-arkit-for-apple-ios-11) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Augmented Reality Tutorial for iOS | Kodeco](https://www.kodeco.com/3054-augmented-reality-tutorial-for-ios) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Augmented Reality iOS Tutorial: Marker Tracking | Kodeco](https://www.kodeco.com/2674-augmented-reality-ios-tutorial-marker-tracking) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [MartianCraft & Apple Vision Pro: Pioneering the Future of AR Technology](https://martiancraft.com/blog/2024/01/apple-vision-pro-pioneering-the-future) — MartianCraft · article catalogue
...
- [VISION POSSIBLE: A New Paradigm in Computing?](https://martiancraft.com/blog/2023/06/vision-possible) — MartianCraft · article catalogue
...
- [moved on to Meta](https://gizmodo.com/alan-dye-leaving-apple-for-meta-liquid-glass-visionos-2000695284) — Those Who Swift · Issue 246 — Article · Topics: Spatial Computing
...
- [Bezel for Mac](https://nonstrict.eu/bezel) — Those Who Swift · Issue 217 — Article · Topics: Spatial Computing
...
- [What’s new for enterprise in visionOS 2](https://support.apple.com/en-us/121160) — Those Who Swift · Issue 195 — Article
  **Published:** `2025-06-18`
...
- [Speculative Spatial Design Canvas](https://imaginaryinstitute.gumroad.com/l/speculative-spatial-design-canvas?ref=createwithswift.com) — Create with Swift · Issue 4 — Article · Topics: Spatial Computing · Swift
...
- [this post from Cristian Díaz](https://www.elkraneo.com/the-framework-next-door) — iOS Dev Weekly · Issue 695 — Article
  **Published:** `17th January 2025`
  **NeKI brief:** Presents this post from Cristian Díaz, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
- [Subdivisions in RealityKit](https://www.elkraneo.com/subdivisions-in-realitykit) — iOS Dev Weekly · Issue 690 — Article
  **Published:** `6th December 2024`
  **NeKI brief:** Here’s one for the visionOS developers. Actually, it’s for a subset of visionOS developers who are developing with 3D objects. I found Cristian Díaz’s look at subdivisions and when/where you can use them in RealityKit interesting.
...
- [The visionOS 2.2 Ultrawide Display](https://www.macrumors.com/2024/11/05/vision-pro-ultrawide-display) — iOS Dev Weekly · Issue 687 — Article · Topics: Spatial Computing
  **Published:** `15th November 2024`
  **NeKI brief:** Is this the feature you’ve been waiting for to invest in a Vision Pro? You’ll never get a monitor this big on your desk!
...
- [Spatial Interaction Playgrounds for visionOS](https://imaginaryinstitute.gumroad.com/l/spatialinteractionsplaygrounds?ref=createwithswift.com) — Create with Swift · Issue 28 — Tutorial · Topics: Swift
...
- [Jacob Bartlett](https://jacobbartlett.substack.com/p/impress-at-job-interviews-by-decompiling) — Fatbobman’s Swift Weekly · Issue 47 — Article · Topics: Spatial Computing
...
- [Let's VisionOS](https://letsvisionos24.swiftgg.team/en) — Fatbobman’s Swift Weekly · Issue 41 — Article · Topics: Spatial Computing · Swift
...
- [Emanuele Agosta](https://bento.me/emanueleagosta) — iOS Dev Weekly · Issue 662 — Article
  **Published:** `24th May 2024`
  **NeKI brief:** Yes, this post from Emanuele Agosta is targeted at visionOS, but it’s also full of great tips for creating better designs using built-in typography across all platforms. 👍
...
- [Workshop: Creating Apps for visionOS](https://www.eventbrite.it/e/creating-apps-for-visionos-tickets-859327330177?aff=oddtdtcreator&ref=createwithswift.com) — Create with Swift · Issue 9 — Tutorial · Topics: Spatial Computing · Swift
...
- [look at the event page with the detailed program of the workshop](https://www.eventbrite.it/e/creating-apps-for-visionos-tickets-859327330177?ref=createwithswift.com) — Create with Swift · Issue 9 — Tutorial · Topics: Spatial Computing · Swift
  **Published:** `2024-04-19T15:00:58.000Z`
...
- [If you’ve created a visionOS app with a volume, you probably did it wrong](https://www.lunarskydiving.com/blog/volume-window-zoom) — iOS Dev Weekly · Issue 651 — Article
  **Published:** `8th March 2024`
  **NeKI brief:** That’s a bold post title, but regardless of whether you got it wrong or not, there’s some useful information in this post from Drew Olbrich. He also followed up with more information on Volumes in a second post if you enjoy this one!
- [Customizing Windows in visionOS](https://blog.overdesigned.net/posts/2024-02-29-visionos-window-basics) — iOS Dev Weekly · Issue 650 — Article · Topics: Spatial Computing
  **Published:** `1st March 2024`
  **NeKI brief:** Examines Tips and tricks for working with windows and glass in visionOS. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [Streaks for Apple Vision Pro](https://crunchybagel.com/streaks-for-apple-vision-pro) — iOS Dev Weekly · Issue 648 — Article · Topics: Spatial Computing
  **Published:** `16th February 2024`
  **NeKI brief:** Discusses Streaks for Apple Vision Pro, connecting the concrete app-design or engineering decision to practical considerations for Apple-platform developers.
...
- [XReality Zone](https://xreality.zone/en) — Fatbobman’s Swift Weekly · Issue 18 — Article · Topics: Spatial Computing
...
- [完蛋！我被 OpenAI 新闻包围了！](https://justinyan.me/post/5835) — Fatbobman’s Swift Weekly · Issue 8 — Article · Topics: AI Development · Spatial Computing
...
- [Adapting an App to visionOS](https://varrall.substack.com/p/adapting-an-app-to-visionos) — iOS Dev Weekly · Issue 623 — Article · Topics: Spatial Computing
  **Published:** `18th August 2023`
  **NeKI brief:** Examines Documenting the initial experience. Follow it when evaluating the implementation choices, constraints, or workflow described on this page in an Apple-platform project.
- [TipKit Examples](https://github.com/jordibruin/TipKit-Examples) — iOS Dev Weekly · Issue 621 — Source repository · Topics: Developer Tools · Swift
  **Published:** `4th August 2023`
  **NeKI brief:** The page covers “TipKit Examples” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [visionOS](https://github.com/jordibruin/visionOS-Examples) — iOS Dev Weekly · Issue 621 — Source repository · Topics: Developer Tools · Swift
  **Published:** `4th August 2023`
  **NeKI brief:** If you’ve not checked out TipKit yet after last week’s link, then maybe this example repository from Jordi Bruin is the inspiration you need. It looks like he has example repositories for visionOS, the dynamic island, and Swift Charts, too!
- [dynamic island](https://github.com/jordibruin/Dynamic-Islands) — iOS Dev Weekly · Issue 621 — Source repository · Topics: Developer Tools · Swift
  **Published:** `4th August 2023`
  **NeKI brief:** The page covers “dynamic island” for Apple-platform development or software practice. Follow it for the concrete subject and examples presented there, while verifying version-sensitive details and implementation assumptions against current primary documentation.
- [Swift Charts](https://github.com/jordibruin/Swift-Charts-Examples) — iOS Dev Weekly · Issue 621 — Source repository · Topics: Developer Tools · Swift
  **Published:** `4th August 2023`
  **NeKI brief:** Examines If you’ve not checked out TipKit yet after last week’s link, then maybe this example repository from Jordi Bruin is the inspiration you need. It looks like he has example repositories for visionOS, the dynamic island, an Useful for understanding the concrete implementation trade-offs in this Apple-platform topic before applying the technique to a production codebase.
...
- [Designing a Weather app for visionOS](https://www.david-smith.org/blog/2023/07/12/design-notes-40) — iOS Dev Weekly · Issue 618 — Article
  **Published:** `14th July 2023`
  **NeKI brief:** Here’s David Smith again! This time, showing that visionOS will be a beautiful operating system as he takes the weather screen from Widgetsmith from iOS to visionOS. 🥽
...
- [large amount of VR titles](https://www.oculus.com/experiences/quest) — iOS Dev Weekly · Issue 612 — Article · Topics: Spatial Computing
  **Published:** `2nd June 2023`
  **NeKI brief:** It’s also worth thinking about the possibility of it launching without being able to run non-Apple apps. Even though ARKit and related tech has been with us for a long time, something this different from a flat screen² may need a little time to settle before…
...
- [Recording ARKit Sessions](https://www.ittybittyapps.com/blog/posts/2018/11/recording-arkit-sessions) — iOS Dev Weekly · Issue 379 — Article · Topics: Spatial Computing
  **Published:** `23rd November 2018`
  **NeKI brief:** Vlas Voloshin with an interesting exploration of a few private ARKit APIs that allow recording of session data. The best case for these APIs is that they weren’t quite ready for iOS 12, and were pushed out to next year. The worst case is that they were…
...
- [Swift Playgrounds meets AR](https://www.macrumors.com/2017/09/19/apple-swift-playgrounds-ar-challenge) — iOS Dev Weekly · Issue 319 — Article · Topics: Spatial Computing · Swift
  **Published:** `22nd September 2017`
  **NeKI brief:** Explores Swift Playgrounds meets AR in an Apple-platform development context, highlighting practical techniques, design decisions, or trade-offs. Use it as historical community guidance, then validate implementation details, security considerations, and current SDK behavior before applying it.
...
- [ARuler](https://github.com/duzexu/ARuler) — iOS Dev Weekly · Issue 310 — Source repository · Topics: Developer Tools · Spatial Computing
  **Published:** `21st July 2017`
  **NeKI brief:** Presents ARuler, providing concrete engineering context that Apple-platform developers can use when evaluating the described technique or workflow.
