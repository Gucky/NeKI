...
- [RWDevCon 2017 Vault Free Tutorial #1: Swift Memory Management | Kodeco](https://www.kodeco.com/651-rwdevcon-2017-vault-free-tutorial-1-swift-memory-management) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [ALT-U Live Online Training: iOS Debugging, Auto Layout, and Instruments | Kodeco](https://www.kodeco.com/533-alt-u-live-online-training-ios-debugging-auto-layout-and-instruments) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Data Structures and Algorithms in Swift: Heap Sort | Kodeco](https://www.kodeco.com/53-data-structures-and-algorithms-in-swift-heap-sort) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [HEIC Image Compression for iOS | Kodeco](https://www.kodeco.com/4726843-heic-image-compression-for-ios) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [XML Tutorial for iOS: How To Choose The Best XML Parser for Your iPhone Project | Kodeco](https://www.kodeco.com/3145-xml-tutorial-for-ios-how-to-choose-the-best-xml-parser-for-your-iphone-project) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Performance-Profiling Swift on Linux: Getting Started | Kodeco](https://www.kodeco.com/31390549-performance-profiling-swift-on-linux-getting-started) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Facebook Tutorial for iOS: How To Get a User Profile with Facebook’s New Graph API from your iPhone App | Kodeco](https://www.kodeco.com/3118-facebook-tutorial-for-ios-how-to-get-a-user-profile-with-facebook-s-new-graph-api-from-your-iphone-app) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [iOS Code Signing: Under The Hood | Kodeco](https://www.kodeco.com/3078-ios-code-signing-under-the-hood) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [25 iOS App Performance Tips & Tricks | Kodeco](https://www.kodeco.com/2752-25-ios-app-performance-tips-tricks) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Monitoring for iOS with MetricKit: Getting Started | Kodeco](https://www.kodeco.com/20952676-monitoring-for-ios-with-metrickit-getting-started) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Advanced Swift: Values and References | Kodeco](https://www.kodeco.com/1940309-advanced-swift-values-and-references) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Swift Algorithms: Getting Started | Kodeco](https://www.kodeco.com/18517868-swift-algorithms-getting-started) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Top 5 iOS and Swift Newsletters | Kodeco](https://www.kodeco.com/1156-top-5-ios-and-swift-newsletters) — Kodeco / Ray Wenderlich archive · article catalogue
  **Published:** `2026-07-17`
...
- [Bugfender: Catch Bugs Before Users Notice - iOS Dev Tools](https://iosdev.tools/blog/bugfender) — iOS Dev Tools Blog · article catalogue
  **Published:** `2025-11-04T09:24:37+00:00`
  **NeKI brief:** Profiles Bugfender as catch Bugs Before Users Notice. Use it when evaluating whether this tool or package fits an Apple-platform development, testing, or delivery workflow.
...
- [A Peek into My Debugging Process (With Real Examples)](https://www.polpiella.dev/how-i-fix-bugs-in-my-apps) — Pol Piella · article catalogue
...
- [PlayCover: Run iOS Apps and Games Natively on Your Apple Silicon Mac - iOS Dev Tools](https://iosdev.tools/blog/playcover) — iOS Dev Tools Blog · article catalogue
  **Published:** `2025-07-16T14:09:10+00:00`
  **NeKI brief:** Profiles PlayCover as run iOS Apps and Games Natively on Your Apple Silicon Mac. Use it when evaluating whether this tool or package fits an Apple-platform development, testing, or delivery workflow.
...
- [ASO.Report: Get Your App an Audit in Seconds - iOS Dev Tools](https://iosdev.tools/blog/asoreport) — iOS Dev Tools Blog · article catalogue
  **Published:** `2025-07-10T17:16:00+00:00`
  **NeKI brief:** Profiles ASO.Report as get Your App an Audit in Seconds. Use it when evaluating whether this tool or package fits an Apple-platform development, testing, or delivery workflow.
...
- [Using equatable() to Avoid the NavigationLink Pre-Build Pitfall](https://fatbobman.com/en/posts/using-equatable-to-avoid-the-navigationlink-pre-build-pitfall) — Fatbobman · article catalogue
...
- [Using Instruments to profile a SwiftUI app – Donny Wals](https://www.donnywals.com/using-instruments-to-profile-a-swiftui-app) — Donny Wals · article catalogue
...
- [Method dispatch mechanisms in Swift: static and dynamic dispatch](https://nilcoalescing.com/blog/MethodDispatchMechanismsInSwift) — Nil Coalescing · article catalogue
...
- [Lazy Initialization @State in SwiftUI - Overcoming Premature Object Creation](https://fatbobman.com/en/posts/lazy-initialization-state-in-swiftui) — Fatbobman · article catalogue
...
- [Automate Apple app code signing using fastlane match](https://www.polpiella.dev/automate-code-signing-with-fastlane-match) — Pol Piella · article catalogue
...
- [Mastering Data Binning with Swift Charts](https://fatbobman.com/en/posts/mastering-data-binning-with-swift-charts) — Fatbobman · article catalogue
...
- [How to decide between a Set and Array in Swift? – Donny Wals](https://www.donnywals.com/how-to-decide-between-a-set-and-array-in-swift) — Donny Wals · article catalogue
...
- [How to profile your app's performance and Main Thread usage with Instruments and os_signposts](https://www.polpiella.dev/time-profiler-instruments) — Pol Piella · article catalogue
  **Published:** `2024-05-08T00:00:00.000Z`
...
- [Tips and Considerations for Using Lazy Containers in SwiftUI](https://fatbobman.com/en/posts/tips-and-considerations-for-using-lazy-containers-in-swiftui) — Fatbobman · article catalogue
...
- [High Performance Swift Apps](https://blog.jacobstechtavern.com/p/high-performance-swift-apps) — Jacob’s Tech Tavern · newsletter edition
...
- [The Case Against [unowned self]](https://blog.jacobstechtavern.com/p/the-case-against-unowned-self) — Jacob’s Tech Tavern · newsletter edition
...
- [GeometryReader - Blessing or Curse?](https://fatbobman.com/en/posts/geometryreader-blessing-or-curse) — Fatbobman · article catalogue
...
- [COW2LLVM: The isKnownUniquelyReferenced Deep-Dive](https://blog.jacobstechtavern.com/p/cow2llvm-the-isknownuniquelyreferenced) — Jacob’s Tech Tavern · newsletter edition
...
- [How to fix "libobjc.A.dylib is being read from process memory" error | Sarunw](https://sarunw.com/posts/how-to-fix-libobjc_A_dylib-is-being-read-from-process-memory-error) — Sarunw · article catalogue
...
- [A Deep Dive Into Observation - A New Way to Boost SwiftUI Performance](https://fatbobman.com/en/posts/mastering-observation) — Fatbobman · article catalogue
...
- [MacBook Pro Usage Experience](https://fatbobman.com/en/posts/experience_of_macbook_pro) — Fatbobman · article catalogue
...
- [Building custom layout in SwiftUI. Caching. | Swift with Majid](https://swiftwithmajid.com/2022/11/29/building-custom-layout-in-swiftui-caching) — Swift with Majid · article catalogue
...
- [Ask Apple 2022 Q&A Related to SwiftUI (Part 2)](https://fatbobman.com/en/posts/swiftui-of-ask-apple-2022-2) — Fatbobman · article catalogue
...
- [How to Avoid Repeating SwiftUI View Updates](https://fatbobman.com/en/posts/avoid_repeated_calculations_of_swiftui_views) — Fatbobman · article catalogue
...
- [Measuring app performance in Swift | Swift with Majid](https://swiftwithmajid.com/2022/05/04/measuring-app-performance-in-swift) — Swift with Majid · article catalogue
...
- [Demystifying SwiftUI List Responsiveness - Best Practices for Large Datasets](https://fatbobman.com/en/posts/optimize_the_response_efficiency_of_list) — Fatbobman · article catalogue
...
- [How to draw custom paths and shapes in SwiftUI | Sarunw](https://sarunw.com/posts/how-to-draw-custom-paths-and-shapes-in-swiftui) — Sarunw · article catalogue
...
- [Structural identity in SwiftUI | Swift with Majid](https://swiftwithmajid.com/2021/12/09/structural-identity-in-swiftui) — Swift with Majid · article catalogue
...
- [Understanding how and when SwiftUI decides to redraw views](https://www.donnywals.com/understanding-how-and-when-swiftui-decides-to-redraw-views) — Donny Wals · article catalogue
...
- [Animations | Swift by Sundell](https://www.swiftbysundell.com/basics/animations) — Swift by Sundell · article catalogue
...
- [What makes code “Swifty”? | Swift by Sundell](https://www.swiftbysundell.com/articles/what-makes-code-swifty) — Swift by Sundell · article catalogue
  **Published:** `2021-10-30`
...
- [Sorting Swift collections | Swift by Sundell](https://www.swiftbysundell.com/articles/sorting-swift-collections) — Swift by Sundell · article catalogue
  **Published:** `2021-10-30`
...
- [Slicing Swift collections | Swift by Sundell](https://www.swiftbysundell.com/articles/slicing-swift-collections) — Swift by Sundell · article catalogue
  **Published:** `2021-10-30`
...
- [Computed properties in Swift | Swift by Sundell](https://www.swiftbysundell.com/articles/computed-properties-in-swift) — Swift by Sundell · article catalogue
  **Published:** `2021-10-30`
...
- [Caching in Swift | Swift by Sundell](https://www.swiftbysundell.com/articles/caching-in-swift) — Swift by Sundell · article catalogue
  **Published:** `2021-10-30`
...
- [How I use GitHub Actions to update my GitHub profile](https://www.polpiella.dev/updating-your-profile-readme-with-github-actions) — Pol Piella · article catalogue
...
- [A Fast Fuzzy Search Implementation · objc.io](https://www.objc.io/blog/2020/08/18/fuzzy-search) — objc.io · article catalogue
  **Published:** `2020-8-18`
...
- [Open Sourcing Parsing](https://www.pointfree.co/blog/posts/49-open-sourcing-parsing) — Point-Free · article catalogue
...
- [Slow Swift Compiler Performance](https://useyourloaf.com/blog/slow-swift-compiler-performance) — Use Your Loaf · article catalogue
...
- [Discussing List and ForEach in SwiftUI](https://fatbobman.com/en/posts/swiftui-list-foreach) — Fatbobman · article catalogue
...
- [How to renew an expired certificate with Fastlane Match | Sarunw](https://sarunw.com/posts/how-to-renew-expired-certificate-with-fastlane-match) — Sarunw · article catalogue
...
- [HowTo - SwiftUI 2.0 LazyVStack and LazyHStack](https://fatbobman.com/en/posts/howto-swiftui-lazystack) — Fatbobman · article catalogue
...
- [Sleep sort: A sorting algorithm without compare | Sarunw](https://sarunw.com/posts/sleep-sort-sorting-algorithm-without-compare) — Sarunw · article catalogue
...
- [Removing a specific object from an Array in Swift – Donny Wals](https://www.donnywals.com/remove-instances-of-an-object-from-an-array-in-swift) — Donny Wals · article catalogue
...
- [Measuring performance with os_signpost – Donny Wals](https://www.donnywals.com/measuring-performance-with-os_signpost) — Donny Wals · article catalogue
...
- [Finding slow code with Instruments – Donny Wals](https://www.donnywals.com/finding-slow-code-with-instruments) — Donny Wals · article catalogue
...
- [Image Resizing Techniques - NSHipster](https://nshipster.com/image-resizing) — NSHipster · article catalogue
...
- [Swift Tip: Quick Performance Timing · objc.io](https://www.objc.io/blog/2018/06/14/quick-performance-timing) — objc.io · article catalogue
  **Published:** `2018-6-14`
...
- [Optimizing Images | Swiftjective-C](https://swiftjectivec.com/optimizing-images) — Swiftjective-C · article catalogue
...
- [Array performance: append() vs reserveCapacity() – Hacking with Swift](https://www.hackingwithswift.com/articles/128/array-performance-append-vs-reservecapacity) — Hacking with Swift articles · article catalogue
  **Published:** `2018-10-04T21:50:04+00:00`
...
- [WWDC 2018 Viewing Guide](https://useyourloaf.com/blog/wwdc-2018-viewing-guide) — Use Your Loaf · article catalogue
...
- [How to find and fix slow code using Instruments – Hacking with Swift](https://www.hackingwithswift.com/articles/81/how-to-find-and-fix-slow-code-using-instruments) — Hacking with Swift articles · article catalogue
  **Published:** `2018-04-18T15:16:58+00:00`
...
- [How to find and fix memory leaks using Instruments – Hacking with Swift](https://www.hackingwithswift.com/articles/80/how-to-find-and-fix-memory-leaks-using-instruments) — Hacking with Swift articles · article catalogue
  **Published:** `2018-04-17T13:39:55+00:00`
...
- [How to find and fix slow drawing using Instruments – Hacking with Swift](https://www.hackingwithswift.com/articles/79/how-to-find-and-fix-slow-drawing-using-instruments) — Hacking with Swift articles · article catalogue
  **Published:** `2018-04-16T10:33:03+00:00`
...
- [Swift Tip: A Quick Tip For String Performance · objc.io](https://www.objc.io/blog/2017/12/12/quick-tip-for-string-performance) — objc.io · article catalogue
...
- [A Sorted Array Implementation in Swift – Ole Begemann](https://oleb.net/blog/2017/02/sorted-array) — Ole Begemann · article catalogue
  **Published:** `2017-02-08T19:40:23Z`
...
- [Random number generators in Swift | Cocoa with Love](https://www.cocoawithlove.com/blog/2016/05/19/random-numbers.html) — Cocoa with Love · article catalogue
...
- [Comparing Swift to C++ for parsing | Cocoa with Love](https://www.cocoawithlove.com/blog/2016/05/01/swift-name-demangling.html) — Cocoa with Love · article catalogue
...
- [High performance shadows for UIView – Donny Wals](https://www.donnywals.com/high-performance-shadows-for-uiview) — Donny Wals · article catalogue
...
- [Benchmarking - NSHipster](https://nshipster.com/benchmarking) — NSHipster · article catalogue
...
- [AVSpeechSynthesizer - NSHipster](https://nshipster.com/avspeechsynthesizer) — NSHipster · article catalogue
...
- [NSArray Binary Search – Ole Begemann](https://oleb.net/blog/2013/07/nsarray-binary-search) — Ole Begemann · article catalogue
  **Published:** `2013-07-10T19:25:00Z`
...
- [Is a virtual machine for Cocoa programming inevitable? | Cocoa with Love](https://www.cocoawithlove.com/2010/07/is-virtual-machine-for-cocoa.html) — Cocoa with Love · article catalogue
...
- [Assign, retain, copy: pitfalls in Obj-C property accessors | Cocoa with Love](https://www.cocoawithlove.com/2010/06/assign-retain-copy-pitfalls-in-obj-c.html) — Cocoa with Love · article catalogue
...
- [Renewing provisioning profiles](https://useyourloaf.com/blog/renewing-provisioning-profiles) — Use Your Loaf · article catalogue
...
- [A look at how malloc works on the Mac | Cocoa with Love](https://www.cocoawithlove.com/2010/05/look-at-how-malloc-works-on-mac.html) — Cocoa with Love · article catalogue
...
- [Load from NIB or construct views in code: which is faster? | Cocoa with Love](https://www.cocoawithlove.com/2010/03/load-from-nib-or-construct-views-in.html) — Cocoa with Love · article catalogue
...
- [Custom build rules, generated tables and faster floating point | Cocoa with Love](https://www.cocoawithlove.com/2010/02/custom-build-rules-generated-tables-and.html) — Cocoa with Love · article catalogue
...
- [Rules to avoid retain cycles | Cocoa with Love](https://www.cocoawithlove.com/2009/07/rules-to-avoid-retain-cycles.html) — Cocoa with Love · article catalogue
...
- [NSArray or NSSet, NSDictionary or NSMapTable | Cocoa with Love](https://www.cocoawithlove.com/2008/08/nsarray-or-nsset-nsdictionary-or.html) — Cocoa with Love · article catalogue
...
- [mikeash.com: Friday Q&A 2009-02-27: Holistic Optimization](https://www.mikeash.com/pyblog/friday-qa-2009-02-27-holistic-optimization.html) — Mike Ash · article catalogue
...
- [mikeash.com: Algorithmic Optimizations: a Case Study](https://www.mikeash.com/pyblog/algorithmic-optimizations-a-case-study.html) — Mike Ash · article catalogue
...
- [The Anatomy of a Reusable SwiftUI View](https://alexanderweiss.dev/blog/2026-07-12-the-anatomy-of-a-reusable-swiftui-view) — SwiftUI Weekly · SwiftUI Weekly - Issue #238 — Article · Topics: Performance · Swift · SwiftUI
...
- [how to add a site](https://iosdevdirectory.com/contributing) — iOS Dev Weekly · Issue 745 — Article · Topics: Performance
...
- [Static vs Dynamic Dispatch in Swift](https://www.sagarunagar.com/blog/static-vs-dynamic-dispatch-swift) — Those Who Swift · Issue 255 — Article · Topics: Performance · Swift
...
- [🚀 Speed up your launch times with this Open Source tool](https://blog.sentry.io/open-source-tool-speed-up-ios-app-launch) — iOS CI Newsletter · Issue 71 — Article · Topics: Performance
...
- [Sentry announced that they were acquiring Emerge Tools](https://blog.sentry.io/emerge-tools-is-now-a-part-of-sentry) — iOS CI Newsletter · Issue 71 — Article · Topics: Performance
  **Published:** `2025-06-30T00:00:00.000Z`
...
- [Rewriting a 12 Year Old Objective-C iOS App with Claude Code](https://twocentstudios.com/2025/06/22/vinylogue-swift-rewrite) — Those Who Swift · Issue 220 — Article · Topics: Objective-C & Cocoa · Performance · Swift
...
- [Why Your SwiftUI App Is Slower Than You Think](https://medium.com/@wesleymatlock/why-your-swiftui-app-is-slower-than-you-think-c3e9bb46174b) — Those Who Swift · Issue 211 — Article · Topics: Performance · Swift · SwiftUI
...
- [Designing a custom lazy list in SwiftUI with better performance](https://nilcoalescing.com/blog/CustomLazyListInSwiftUI?ref=createwithswift.com) — Create with Swift · Issue 51 — Article · Topics: Performance · Swift · SwiftUI
...
- [How to decide between a Set and Array in Swift?](https://www.donnywals.com/how-to-decide-between-a-set-and-array-in-swift?ref=createwithswift.com) — Create with Swift · Issue 13 — Article · Topics: Performance · Swift
...
- [report](https://www.macrumors.com/2023/11/07/apple-engineers-ios-18-bug-fix-focus) — Fatbobman’s Swift Weekly · Issue 6 — Article · Topics: Performance
...
- [Exploring SwiftUI Redraw Behavior with Instruments](https://holyswift.app/exploring-swiftui-redraw-behavior-with-instruments) — iOS Dev Weekly · Issue 575 — Tutorial · Topics: Performance · Swift · SwiftUI
...
- [plenty](https://rensbr.eu/blog/swiftui-diffing) — iOS Dev Weekly · Issue 575 — Tutorial · Topics: Performance · Swift · SwiftUI
  **Published:** `9th September 2022`
...
- [Why do mobile-first companies choose Instabug over Crashlytics](https://instabug.com/crashlytics-alternative) — iOS Dev Weekly · Issue 453 — Article · Topics: Performance
...
- [Manual Provisioning](http://martiancraft.com/blog/2017/07/manual-provisioning) — iOS Dev Weekly · Issue 310 — Article · Topics: App Distribution & Store Operations · Performance · Xcode
  ...
  **NeKI brief:** Xcode 9 manual signing requires an explicit team, profile, and certificate selection, yet Xcode may still request missing certificates. Treat manual provisioning as a controlled configuration workflow and verify portal assets whenever signing behavior looks automatic.
- [Catching Leaky View Controllers Without Instruments](http://holko.pl/2017/06/26/checking-uiviewcontroller-deallocation) — iOS Dev Weekly · Issue 307 — Article · Topics: Performance
...
- [Regarding Swift build time optimizations](https://medium.com/@RobertGummesson/regarding-swift-build-time-optimizations-fc92cdd91e31) — iOS Dev Weekly · Issue 249 — Article · Topics: Performance · Swift
...
- [Matt Nedrich](https://spin.atomicobject.com/2016/04/26/swift-long-compile-time) — iOS Dev Weekly · Issue 249 — Article · Topics: Performance · Swift
  **Published:** `6th May 2016`
...
- [An iPhone App Startup Performance Technique](http://inessential.com/2012/08/23/an_iphone_app_startup_performance_techni) — iOS Dev Weekly · Issue 57 — Article · Topics: Performance
